...
$evaluation = $arResult['EVALUATION'] ?? [];
			...
			<div class="bx-call-component-call-ai__tab-content-wrapper">
				...
				<div id="TabGrade" class="bx-call-component-call-ai__tab-details --grade">
					...
					if ($evaluation['efficiencyValue'] >= 0)
					{
						...
						$state = $evaluation['efficiencyValue'] > 75 ? '--success' : '--failure';
						$stateShort = match ($evaluation['efficiencyValue'])
						{
						...
						*/
						...
						<div class="bx-call-component-call-ai__grade-stats">
							...
							<div class="bx-call-component-call-ai__grade-value-wrapper" data-efficiency-value="<?= $evaluation['efficiencyValue'] ?>">
								...
								<p class="bx-call-component-call-ai__grade-value">
									<?= $evaluation['efficiencyValue'] ?><span class="bx-call-component-call-ai__grade-value-symbol">%</span>
								</p>
							</div>
						</div>

						<?
						$meetingType = $overview['meetingType']['title'] ?? Loc::getMessage('CALL_MEETING_TYPE_UNDEFINED');
						$recommendation = match ($evaluation['efficiencyValue'])
						{
						...
						<div class="bx-call-component-call-ai__grade-description">
							<div class="bx-call-component-call-ai__resume">
								<div><?= Loc::getMessage('CALL_MEETING_TYPE') ?>: <span class="bx-call-component-call-ai__resume-type"><?= $meetingType ?></span></div>
							...
							<ul class="bx-call-component-call-ai__list">
								...
								foreach ($evaluation as $value)
								{
									...
									$state = $value['value'] ? '--success' : '--failure';
									?>
								...
								<li class="bx-call-component-call-ai__list-item">
									<span class="bx-call-component-call-ai__list-item-icon <?= $state ?>"></span>
									<span><?= Loc::getMessage('CALL_COMPONENT_EFFICIENCY_AGENDA_TIME_EXCEED') ?></span>
								</li>
							</ul>
						</div>
						<?
				...
				<div id="TabAgreements" class="bx-call-component-call-ai__tab-details --agreements">
					...
					<?
					if ($overview['agreements'] || $overview['meetings'] || $overview['actionItems'])
					{
				...
				<div id="TabRecommendations" class="bx-call-component-call-ai__tab-details --insights">
					...
					<?
					$isRecommendationsRendered = false;

					if (
						$insights['speakerEvaluationAvailable'] === true
						&& !empty($insights['speakerAnalysis'])
					)
					{
						$isRecommendationsRendered = true;
						?>
						<div class="bx-call-component-call-ai__insights">
							<div class="bx-call-component-call-ai__insights-graph-table__header">
								<div class="bx-call-component-call-ai__insights-graph-table__header__cell bx-call-component-call-ai__employee__column"><?=Loc::getMessage('CALL_SPEAKER_EVALUATION_EMPLOYEES')?></div>
								<div class="bx-call-component-call-ai__insights-graph-table__header__cell bx-call-component-call-ai__activity__column"><?=Loc::getMessage('CALL_SPEAKER_EVALUATION_COMMUNICATION_TIME_MSGVER_1')?>
									<div class="bx-call-component-call-ai__insights-graph-table__header__wrapper">
										<div class="bx-call-component-call-ai__information-icon"></div>
										<div class="bx-call-component-call-ai__insights-graph-table__header__wrapper__tooltip activity__tooltip">
											<?=Loc::getMessage('CALL_SPEAKER_EVALUATION_COMMUNICATION_TIME_DESCRIPTION')?>
										</div>
									</div>
								</div>
								<div class="bx-call-component-call-ai__insights-graph-table__header__cell bx-call-component-call-ai__efficiency__column"><?=Loc::getMessage('CALL_COMPONENT_EFFICIENCY')?>
									<div class="bx-call-component-call-ai__insights-graph-table__header__wrapper">
										<div class="bx-call-component-call-ai__information-icon"></div>
										<div class="bx-call-component-call-ai__insights-graph-table__header__wrapper__tooltip efficiency__tooltip">
											<?=Loc::getMessage('CALL_SPEAKER_EVALUATION_EFFICIENCY_DESCRIPTION')?>
										</div>
									</div>
								</div>
							</div>
							<div>
								<?
								/** @var array{userId: int, name: string, efficiency: array, efficiencyValue: float, talkPercentage: int} $speaker */
								foreach ($insights['speakerAnalysis'] as $speaker)
								{
									$userId = $speaker['userId'];
									if (!$userId || !isset($arResult['CALL_USERS'][$userId]))
									{
										continue;
									}
									$user = $arResult['CALL_USERS'][$userId];

									?>
									<div class="bx-call-component-call-ai__insights-graph-table__row">
										<div class="bx-call-component-call-ai__employee__column bx-call-component-call-ai__employee__row" data-insights-user-id="<?= $userId ?>" bx-tooltip-user-id="<?= $userId ?>">
											<?
											if ($user['avatar'])
											{
												?><img src="<?= htmlspecialcharsbx($user['avatar']) ?>" class="bx-call-component-call-ai__insights__user-img"><?
											}
											else
											{
												?><div class="bx-call-user-list-component__user-avatar --icon" style="background-color: <?= htmlspecialcharsbx($user['color'] ?? 'rgb(62,153,206)') ?>;"></div><?
											}
											?>
											<?= htmlspecialcharsbx($user['name'] ?? '') ?>
										</div>
										<div class="bx-call-component-call-ai__activity__column bx-call-component-call-ai__activity__row">
											<div class="bx-call-component-call-ai__column-container">
												<call-ai-efficiency-value value="<?= (int)($speaker['talkPercentage'] ?? 0) ?>"></call-ai-efficiency-value><?= ($speaker['duration'] > 0) ? '%&nbsp;('.$speaker['durationFormat'].')' : '' ?>
											</div>
										</div>
										<div class="bx-call-component-call-ai__efficiency__column bx-call-component-call-ai__efficiency__row">
											<div class="bx-call-component-call-ai__column-container">
												<call-ai-efficiency-chart percent="<?= (int)($speaker['efficiencyValue'] ?? 0) ?>" painted="<?= ($speaker['efficiencyValue'] ?? 0) > 0 ? 'true' : 'false' ?>"></call-ai-efficiency-chart>
												<call-ai-efficiency-value value="<?= (int)($speaker['efficiencyValue'] ?? 0) ?>"></call-ai-efficiency-value>
											</div>
										</div>
									</div>
									<?
							...
							<div class="bx-call-component-call-ai__insights__full-report">
								<span class="bx-call-component-call-ai__insights__full-report__title"><?=Loc::getMessage('CALL_SPEAKER_EVALUATION_DETAILED_ANALYSIS_MSGVER_1')?></span>
								<?
								/** @var array{userId: int, name: string, efficiency: array, efficiencyValue: float, talkPercentage: int} $speaker */
								foreach ($insights['speakerAnalysis'] as $speaker)
								{
									...
									if (
										!$userId
										|| !isset($arResult['CALL_USERS'][$userId])
									)
									{
										continue;
									}
									$user = $arResult['CALL_USERS'][$userId];
									$speakerEvaluation = $speaker['evaluationCriteria'];

									?>
									<div class="bx-call-component-call-ai__insights__full-report__info" data-insights-user-id-full="<?= $userId ?>">
										<div class="bx-call-component-call-ai__insights__full-report__info__name" bx-tooltip-user-id="<?= $userId ?>">
											<?
											if ($user['avatar'])
											{
												?><img src="<?= htmlspecialcharsbx($user['avatar']) ?>" class="bx-call-component-call-ai__insights__user-img"><?
											...
											{
												?><div class="bx-call-user-list-component__user-avatar bx-call-component-call-ai__insights__user-img --icon" style="background-color: <?= htmlspecialcharsbx($user['color'] ?? 'rgb(62,153,206)') ?>;"></div><?
											}
											?>
											<?= htmlspecialcharsbx($user['name'] ?? '') ?>
											<div class="activity">
												<div class="bx-call-component-call-ai__timer-icon"></div>
												<call-ai-efficiency-value value="<?= (int)($speaker['talkPercentage'] ?? 0) ?>"></call-ai-efficiency-value><?= ($speaker['duration'] > 0) ? '%&nbsp;('.$speaker['durationFormat'].')' : '' ?>
											</div>
										...
										<div class="bx-call-component-call-ai__insights__full-report__info__metrics">
											<div class="left">
												<?
												$pos = 0;
										...
										<div class="bx-call-component-call-ai__insights__full-report__info__description"><?= $speaker['detailedInsight'] ?></div>
									</div>
									<?
								}
								?>
