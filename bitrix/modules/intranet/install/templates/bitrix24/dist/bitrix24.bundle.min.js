this.BX=this.BX||{};this.BX.Intranet=this.BX.Intranet||{};(function(e,s,t,a,i,l,r,o,n,d,c,b,v,p){"use strict";async function u(e){p.Loc.setMessage(e.messages);await h({...e,titleBar:p.Loc.getMessage("PARTNER_POPUP_TITLE"),sendButtonText:p.Loc.getMessage("PARTNER_POPUP_SEND_BUTTON")})}async function h(e){const s=e.titleBar;const t=e.sendButtonText;const a=e.partnerName;const i=e.partnerUrl;const[{Popup:l},{Button:r,ButtonColor:o}]=await Promise.all([p.Runtime.loadExtension("main.popup"),p.Runtime.loadExtension("ui.buttons")]);const n={className:"bitrix24-partner__popup",autoHide:false,cacheable:false,zIndex:0,offsetLeft:0,offsetTop:0,width:540,height:350,overlay:true,draggable:{restrict:true},closeByEsc:true,titleBar:s,closeIcon:true,content:`\n\t\t\t<div class="bitrix24-partner__popup-content">\n\t\t\t\t<div class="bitrix24-partner__popup-content_title">${p.Loc.getMessage("PARTNER_TITLE_FOR_NAME")}</div>\n\t\t\t\t<div class="bitrix24-partner__popup-content_main">\n\t\t\t\t\t<div class="bitrix24-partner__popup-content_name">${a}</div>\n\t\t\t\t\t<a class="bitrix24-partner__popup-content_link" href="${encodeURI(i)}" target="_blank">${p.Loc.getMessage("PARTNER_LINK_NAME_MORE")}</a>\n\t\t\t\t</div>\n\t\t\t\t<div class="bitrix24-partner__popup-content_desc">${p.Loc.getMessage("PARTNER_POPUP_DESCRIPTION_BOTTOM")}</div>\n\t\t\t</div>\n\t\t`,buttons:[new r({color:o.SUCCESS,text:t,onclick:async e=>{setTimeout((()=>{e.setClocking(true)}),200);await _();e.setClocking(false)}})]};const d=new l(n);d.show()}async function _(){const{PartnerForm:e}=await p.Runtime.loadExtension("ui.feedback.partnerform");const s={id:`intranet-license-partner-form-${parseInt(Math.random()*1e3,10)}`,source:"intranet.bitrix24.partner-connect-form"};e.show(s)}async function P(e){if(p.Type.isObject(e)===false){return}const s={...e,id:`intranet-license-partner-form-${p.Text.getRandom()}`};const{PartnerForm:t}=await p.Runtime.loadExtension("ui.feedback.partnerform");t.show(s)}const f=async()=>{await p.Runtime.loadExtension("helper");const e=p.Reflection.getClass("BX.Helper");e.show("redirect=detail&code=20267044")};class m{static async showConnectForm(e){return u(e)}static showIntegrationOrderForm(e){return P(e)}static async showHelper(){return f()}}var L=babelHelpers.classPrivateFieldLooseKey("handleChatMenuSelect");var F=babelHelpers.classPrivateFieldLooseKey("handleImLayoutChange");var H=babelHelpers.classPrivateFieldLooseKey("handleCounterUpdate");class B{constructor(){Object.defineProperty(this,H,{value:k});Object.defineProperty(this,F,{value:y});Object.defineProperty(this,L,{value:g});d.EventEmitter.subscribe("IM.Layout:onLayoutChange",babelHelpers.classPrivateFieldLooseBase(this,F)[F].bind(this));d.EventEmitter.subscribe("IM.Counters:onUpdate",babelHelpers.classPrivateFieldLooseBase(this,H)[H].bind(this));d.EventEmitter.subscribe("BX.Intranet.Bitrix24.ChatMenu:onSelect",babelHelpers.classPrivateFieldLooseBase(this,L)[L].bind(this))}getChatMenu(){const e=p.Reflection.getClass("BX.Main.interfaceButtonsManager");if(e){return e.getById("chat-menu")||null}return null}getCollaborationMenu(){const e=p.Reflection.getClass("BX.Main.interfaceButtonsManager");if(e){return e.getById("top_menu_id_collaboration")||null}return null}}function g(e){var s;const t=e.getData();const{id:a,entityId:i}=t;let l=(s=t.event)==null?void 0:s.target;if(l){l=l.closest(".main-buttons-item-link, .menu-popup-item")}const r=p.Reflection.getClass("BX.Messenger.Public");r==null?void 0:r.openNavigationItem({id:a,entityId:i,target:l})}function y(e){const s=e.getData();let t=s.from.name.toLowerCase();if(t==="market"&&s.from.entityId){t=`${t}_${s.from.entityId}`}let a=s.to.name.toLowerCase();if(a==="market"&&s.to.entityId){a=`${a}_${s.to.entityId}`}const i=this.getChatMenu();if(i!==null){i.unsetActive(t);i.setActive(a);i.reset()}const l=this.getCollaborationMenu();const r=p.Loc.getMessage("SITE_DIR")||"/";const o=window.location.pathname.toString().startsWith(`${r}online/`);if(l!==null){if(o){l.unsetActive(t);l.setActive(a)}l.reset()}}function k(e){const s=e.getData();const t=[this.getChatMenu(),this.getCollaborationMenu()];for(const e of t){if(e===null){continue}for(const[t,a]of Object.entries(s)){e.updateCounter(t,a)}}}function w(){const e=window.location.pathname;const s=C(["logout","login","back_url_pub","user_lang"]);return e+(s.length>0?`?${s}`:"")}function C(e){const s=window.location.search.slice(1);if(!p.Type.isStringFilled(s)){return""}const t=s.split("&");const a=p.Type.isArray(e)?e:[];let i="";for(const e of t){const s=e.split("=");const t=e.indexOf("=");const l=s[0];const r=p.Type.isStringFilled(s[1])?s[1]:false;if(!a.includes(l)){if(i!==""){i+="&"}i+=l+(t===-1?"":"=")+(r===false?"":r)}}return i}let E=e=>e,O,I,j,x;var K=babelHelpers.classPrivateFieldLooseKey("refs");var T=babelHelpers.classPrivateFieldLooseKey("showLoader");var S=babelHelpers.classPrivateFieldLooseKey("getPageSkeleton");var R=babelHelpers.classPrivateFieldLooseKey("bindEvents");class A{constructor(){Object.defineProperty(this,R,{value:W});Object.defineProperty(this,S,{value:M});Object.defineProperty(this,T,{value:D});Object.defineProperty(this,K,{writable:true,value:new n.MemoryCache});if(this.isEnabled()){babelHelpers.classPrivateFieldLooseBase(this,R)[R]()}}isEnabled(){return!p.Type.isUndefined(window.frameRequestStart)}isReady(){var e,s;return((e=window.BX)==null?void 0:(s=e.frameCache)==null?void 0:s.frameDataInserted)===true||!p.Type.isUndefined(window.frameRequestFail)}showLoader(){const e=window.location.pathname;if(e==="/stream/"||e==="/stream/index.php"||e==="/index.php"){babelHelpers.classPrivateFieldLooseBase(this,T)[T]("stream")}else{setTimeout((()=>{babelHelpers.classPrivateFieldLooseBase(this,T)[T]()}),500)}}getStubContainer(){return document.querySelector("#page-area")}getLoaderContainer(){return babelHelpers.classPrivateFieldLooseBase(this,K)[K].remember("loader",(()=>p.Tag.render(O||(O=E`
			...
			`))))}getLiveFeedSkeleton(){return babelHelpers.classPrivateFieldLooseBase(this,K)[K].remember("feed-skeleton",(()=>p.Tag.render(I||(I=E`
			...
			`),this.getLiveFeedSidebar(),this.getLiveFeedWorkArea())))}getLiveFeedSidebar(){return babelHelpers.classPrivateFieldLooseBase(this,K)[K].remember("feed-sidebar",(()=>p.Tag.render(j||(j=E`
			...
			`))))}getLiveFeedWorkArea(){return babelHelpers.classPrivateFieldLooseBase(this,K)[K].remember("feed-work-area",(()=>p.Tag.render(x||(x=E`
