...
<script>
	BX.message({
		"MENU_ACCOUNT_POPUP_CONNECT": '<?=GetMessageJS("MENU_ACCOUNT_POPUP_CONNECT_MSGVER_2")?>',
		"MENU_ACCOUNT_POPUP_DISCONNECT": '<?=GetMessageJS("MENU_ACCOUNT_POPUP_DISCONNECT_MSGVER_2")?>',
