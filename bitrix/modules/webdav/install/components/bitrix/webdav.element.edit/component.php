...
$arParams["ACTION"] = mb_strtoupper(!empty($arParams["ACTION"])? $arParams["ACTION"] : $_REQUEST["ACTION"]);
...
if (
	...
	&&
	(
		(mb_strtoupper($_REQUEST['edit']) == "Y")
		|| (mb_strtoupper($_REQUEST['EDIT']) == "Y")
		|| (mb_strtoupper($_REQUEST['LOCK']) == "Y")
		|| (mb_strtoupper($_REQUEST['UNLOCK']) == "Y")
	)
)
{
