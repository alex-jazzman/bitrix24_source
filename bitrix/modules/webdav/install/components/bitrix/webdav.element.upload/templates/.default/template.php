...
$Browser = array(
	"isOpera" => (mb_strpos($str, "opera") !== false));
$Browser["isIE"] = (!$Browser["isOpera"] && mb_strpos($str, "msie") !== false);
$Browser["isWinIE"] = ($Browser["isIE"] && mb_strpos($str, "win") !== false);

// User settings
$arUserSettings = array("view_mode" => mb_strtolower($_REQUEST["view_mode"]));
