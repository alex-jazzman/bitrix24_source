...
foreach ($arProps as $code => &$arIBProp)
{
	...
	$arHeaders[] = array(
		...
		"sort" => mb_strtolower("PROPERTY_".$code),
...
EOS;
	...
	{
		$searchVal = (isset($arResult["FILTER_VALUE"]["content"]) && $arResult["FILTER_VALUE"]["content"] <> '' ? htmlspecialcharsbx($arResult["FILTER_VALUE"]["content"]) : '');
