...
<script type="text/javascript">
	...
	BX.addCustomEvent(window, "onImInit", function (BXIM)
	{
		...
		BitrixDisk.init({
			...
			pathToImages : "/bitrix/components/bitrix/webdav.disk/templates/.default/images",
	...
	<div id="disk-wrap" class="wrap">
		...
		<div class="workarea" id="disk-workarea">
			...
			<div class="right_section">
				<div class="sync_mess" id="disk-last-sync" style="display: none;"><?=GetMessage("WD_DISK_LAST_SYNC")?>: <span id="disk-last-sync-date"></span></div>
				<div class="sync_prigress" id="disk-loading" style="display: none;">
					...
					<div class="sync_block_right">
						...
						<span class="progress_text"><span id="disk-current-file-num"></span> <?=GetMessage("WD_DISK_STATUS_OF")?> <span id="disk-number-of-files"></span>. <span id="disk-progress-speed"></span></span>
					</div>
					<div style="clear: both;"></div>
				</div>
