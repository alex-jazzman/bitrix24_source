/**
 * @module tab-presets/preset-manual-settings
 */
jn.define('tab-presets/preset-manual-settings', (require, exports, module) => {
		...
		renderBanner()
		{
			return View(
				...
				CardBanner({
					...
					title: Loc.getMessage('PRESET_MANUAL_SETTINGS_BANNER_TITLE_MSGVER_1'),
					description: Loc.getMessage('PRESET_MANUAL_SETTINGS_BANNER_DESCRIPTION_MSGVER_1'),
					image: Image({
						resizeMode: 'contain',
						style: {
							width: 64,
