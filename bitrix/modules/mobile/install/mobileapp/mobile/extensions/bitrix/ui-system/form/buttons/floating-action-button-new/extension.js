/**
 * @module ui-system/form/buttons/floating-action-button-new
 */
jn.define('ui-system/form/buttons/floating-action-button-new', (require, exports, module) => {
	const { Icon } = require('assets/icons');
	const { FloatingActionButtonType } = require('ui-system/form/buttons/floating-action-button-new/src/type-enum');
