...
$MESS['ERROR_USER_EDIT'] = 'Вы не можете менять данные другого пользователя';
...
$MESS['ERROR_ORDER_CANNOT_COPY_ORDER'] = 'Невозможно скопировать заказ';
...
$MESS['ERROR_USER_PASSWORD_CONFIRM'] = 'Неверное подтверждение пароля';
...
$MESS['USER_TITLE_BLOG'] = 'Профиль блога';
$MESS['USER_TITLE_FORUM'] = 'Профиль форума';
$MESS['USER_TITLE_STUDENT'] = 'Профиль студента';
$MESS['USER_TITLE_USER_PROPERTIES'] = 'Дополнительные поля';

$MESS["USER_ID"] = "ID";
$MESS["USER_TITLE"] = "Обращение";
...
$MESS["USER_PASSWORD_CONFIRM"] = "Подтверждение пароля";
...
$MESS["USER_forum_INFO"] = "Профиль форума";
$MESS["USER_forum_ALIAS"] = "Псевдоним";
$MESS["USER_forum_DESCRIPTION"] = "Пояснение";
$MESS["USER_forum_INTERESTS"] = "Интересы";
$MESS["USER_forum_AVATAR"] = "Аватар";
$MESS["USER_forum_ALLOW_POST"] = "Разрешено писать";
$MESS["USER_forum_SHOW_NAME"] = "Показывать имя";
$MESS["USER_forum_SIGNATURE"] = "Подпись";

$MESS["USER_blog_ALIAS"] = "Псевдоним";
$MESS["USER_blog_DESCRIPTION"] = "Пояснение";
$MESS["USER_blog_INTERESTS"] = "Интересы";
$MESS["USER_blog_AVATAR"] = "Аватар";
$MESS["USER_blog_ALLOW_POST"] = "Разрешено писать";
$MESS["USER_blog_SIGNATURE"] = "Подпись";

$MESS["USER_student_INFO"] = "Профиль студента";
$MESS["USER_student_RESUME"] = "Резюме";
$MESS["USER_student_PUBLIC_PROFILE"] = "Разрешить публичный доступ к профилю студента";



$MESS["QUANTITY_TEXT"] = "Наличие";
$MESS["QUANTITY_VALUE"] = 10;
$MESS["QUANTITY_MIN"] = "много";
$MESS["QUANTITY_MAX"] = "мало";
$MESS["QUANTITY_NO"] = "Нет на складе";
