...
CREATE INDEX IF NOT EXISTS ix_tasks_effective_datetime ON b_tasks_effective (DATETIME);
...
(
	...
	CAN_CHANGE_DEADLINE char(1) NOT NULL DEFAULT 'Y',
	MAX_DEADLINE_CHANGE_DATE timestamp(0) default null,
	MAX_DEADLINE_CHANGES int null,
	REQUIRE_DEADLINE_CHANGE_REASON char(1) NOT NULL DEFAULT 'N',
...
CREATE TABLE b_tasks_checklist_user_option (
	ID int GENERATED BY DEFAULT AS IDENTITY NOT NULL,
	ITEM_ID int NOT NULL,
	USER_ID int NOT NULL,
	OPTION_CODE int NOT NULL
);
CREATE UNIQUE INDEX b_tasks_checklist_user_option_value
	ON b_tasks_checklist_user_option (item_id, user_id, option_code);
CREATE INDEX b_tasks_checklist_user_option_code
	ON b_tasks_checklist_user_option (user_id, option_code);

CREATE TABLE IF NOT EXISTS b_tasks_deadline_change_log (
	ID int not null generated always as identity,
	TASK_ID int not null,
	USER_ID int not null,
	NEW_DEADLINE timestamp(0) default null,
...
CREATE INDEX IF NOT EXISTS idx_task_deadline_change_log ON b_tasks_deadline_change_log (TASK_ID, USER_ID);
