...
`),v(240,18,99),p(),p(),v(80,12,99),o(),o(),v(null,32),v(84,34),v(84,34),v(97,12,99));const o=()=>t.Tag.render(n||(n=l`
	<div class="--row">
		${0}
		<div style="margin: 0 8px 0 41px">${0}</div>
		${0}
	</div>
`),v(100,12,99),p(22),v(130,12,99));const r=()=>t.Tag.render(e||(e=l`
