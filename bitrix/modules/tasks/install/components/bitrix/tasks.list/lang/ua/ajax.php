...
$MESS["TASKS_GANTT_RESULT_REQUIRED"] = "Постановник запросив результат роботи.<br> Залиште коментар до завдання та позначте його як звіт.";
...
$MESS["TASKS_MARK_P_MSGVER_1"] = "Позитивна";
