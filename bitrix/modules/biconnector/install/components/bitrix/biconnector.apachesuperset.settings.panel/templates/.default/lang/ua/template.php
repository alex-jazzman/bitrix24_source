<?php
$MESS["BICONNECTOR_SUPERSET_SETTINGS_CHANGE_DASHBOARD_LANGUAGE"] = "Змінити";
...
$MESS["BICONNECTOR_SUPERSET_SETTINGS_CURRENT_DASHBOARD_LANGUAGE"] = "[div]Поточна мова[/div] #LANGUAGE#";
