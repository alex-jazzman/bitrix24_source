...
$MESS["FLOW_FIELD_CREATOR"] = "Flow creator ID and name";
$MESS["FLOW_FIELD_CREATOR_FULL"] = "The ID and name of the user that created the flow.";
...
$MESS["FLOW_FIELD_FLOW"] = "Flow ID and name";
$MESS["FLOW_FIELD_FLOW_FULL"] = "Flow ID and name.";
...
$MESS["FLOW_FIELD_GROUP_INFO"] = "Project ID and name";
$MESS["FLOW_FIELD_GROUP_INFO_FULL"] = "The ID and name of the project the flow belongs to.";
...
$MESS["FLOW_FIELD_OWNER"] = "Flow admin ID and name";
$MESS["FLOW_FIELD_OWNER_FULL"] = "The ID and name of the user that was assigned as flow administrator.";
