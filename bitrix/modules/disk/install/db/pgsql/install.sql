...
CREATE UNIQUE INDEX ux_b_disk_object_unique_code ON b_disk_object (unique_code);
...
CREATE UNIQUE INDEX ux_b_disk_unified_link_access_object_id ON b_disk_unified_link_access (object_id);