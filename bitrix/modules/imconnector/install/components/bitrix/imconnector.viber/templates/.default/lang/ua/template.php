...
$MESS["IMCONNECTOR_COMPONENT_VIBER_INDEX_LIST_ITEM_4"] = "Питання від клієнтів автоматично розподіляються між менеджерами за правилами черги";
$MESS["IMCONNECTOR_COMPONENT_VIBER_INDEX_SUBTITLE"] = "Відповідайте клієнтам там, де їм зручно й звично. Якщо клієнтові зручніше написати вам у Viber, дайте йому таку можливість. Ось побачите, клієнти це оцінять.";
$MESS["IMCONNECTOR_COMPONENT_VIBER_INDEX_TITLE"] = "Спілкуйтеся з клієнтами у Viber";
