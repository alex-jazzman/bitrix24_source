...
$MESS["IMCONNECTOR_COMPONENT_CONNECTOR_SETTINGS_CONFIGURE_CHANNEL_MSGVER_1"] = "Налаштування відкритої лінії та прав доступу";
...
$MESS["IMCONNECTOR_COMPONENT_CONNECTOR_SETTINGS_OPEN_LINE_TIP"] = "Відкриті лінії збирають повідомлення з усіх каналів і розподіляють їх по черзі між співробітниками.";
$MESS["IMCONNECTOR_COMPONENT_CONNECTOR_SETTINGS_PERMISSIONS"] = "Права доступу";
$MESS["IMCONNECTOR_COMPONENT_CONNECTOR_SETTINGS_PERMISSIONS_TIP"] = "Вибрані налаштування діятимуть для всіх відкритих ліній у всіх каналах.";
