<?php
$MESS['M_CRM_ENTITY_TAB_ADD_ENTITY_TEXT2'] = 'Создание элемента';

$MESS['M_CRM_ENTITY_TAB_ITEM_ACTION_OPEN'] = 'Открыть элемент';
$MESS['M_CRM_ENTITY_TAB_ITEM_ACTION_OPEN_LEAD'] = 'Открыть лид';
...
$MESS['M_CRM_ENTITY_TAB_ITEM_ACTION_EDIT_LEAD'] = 'Редактировать лид';
...
$MESS['M_CRM_ENTITY_TAB_ITEM_ACTION_DELETE_LEAD'] = 'Удалить лид';
...
$MESS['M_CRM_ENTITY_TAB_FORBIDDEN_CREATE_TITLE_LEAD'] = 'Недостаточно прав на создание лида';
...
$MESS['M_CRM_ENTITY_TAB_FORBIDDEN_TEXT'] = 'Обратитесь к администратору вашего Битрикс24';

$MESS['M_CRM_ENTITY_TAB_FORBIDDEN_READ_SECTION2'] = 'Нет доступа к воронке';
$MESS['M_CRM_ENTITY_TAB_FORBIDDEN_READ_SECTION_DESC2'] = 'Выбрана первая доступная воронка: #SECTION_NAME#';

$MESS['M_CRM_ENTITY_TAB_SORT_TOGGLE_TEXT'] = 'Фокусировка внимания';
