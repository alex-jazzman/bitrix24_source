			...
			if (this.props.category && this.props.category.name)
			{
				return (
					BX.message('MCRM_STAGE_TOOLBAR_CATEGORY_NAME2')
						.replace('#CATEGORY_NAME#', this.props.category.name)
				);
			}
