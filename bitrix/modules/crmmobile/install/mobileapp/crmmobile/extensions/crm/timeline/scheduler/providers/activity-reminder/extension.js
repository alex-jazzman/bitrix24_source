		...
		render()
		{
			return View(
				...
				View(
					...
					ATTACH_ALLOWED && this.renderAttachments(),
					this.renderDeadline(),
				),
				// this.renderToolbar(),
			);
			...
			return View(
				...
				View(
					{
						style: {
							width: 82,
							height: 82,
							backgroundImage: currentDomain + '/bitrix/mobileapp/crmmobile/extensions/crm/timeline/scheduler/providers/activity-reminder/icons/plan-activity.png',
				...
				View(
					...
					Text({
						...
						text: Loc.getMessage('M_CRM_TIMELINE_SCHEDULER_ACTIVITY_REMINDER_BANNER_TITLE'),
					}),
					Text({
						style: {
							color: '#959ca4',
						...
						text: Loc.getMessage('M_CRM_TIMELINE_SCHEDULER_ACTIVITY_REMINDER_BANNER_DESCRIPTION'),
					}),
				),
			);
		}
