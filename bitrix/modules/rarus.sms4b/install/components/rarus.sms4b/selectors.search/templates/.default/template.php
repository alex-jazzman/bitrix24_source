...
<div style="float:left">
	...
	<div class="bx-users-selector-filter" id="bx_users_filter_simple"<?=$current_filter == 'adv' ? ' style="display: none;"' : ''?>>
        <?php $arFilterValues = $APPLICATION->IncludeComponent("rarus.sms4b:intranet.structure.selector", "simple", $arParams, $component);?>
	</div>


	<div class="bx-users-selector-filter" id="bx_users_filter_adv"<?=$current_filter == 'adv' ? '' : ' style="display: none;"'?>>
        <?php $arFilterValues = $APPLICATION->IncludeComponent("rarus.sms4b:intranet.structure.selector", "advanced", $arParams, $component);?>
	</div>
</div>
...
<div style = "float:left">
	<div>
        <?php $APPLICATION->IncludeComponent("rarus.sms4b:intranet.structure.selector", 'alphabet', $arParams, $component);?>
	</div>
</div>
...
<?php
$APPLICATION->IncludeComponent("rarus.sms4b:employee.list", '', $arParams, $component, ['HIDE_ICONS' => 'Y']);
?>