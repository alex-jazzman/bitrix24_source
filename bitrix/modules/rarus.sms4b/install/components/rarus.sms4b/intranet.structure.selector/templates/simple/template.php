...
?>
<form name="<?php echo $formName?>" action="<?=$arParams['LIST_URL']?>" class="bx-selector-form filter-form">
...
<tbody>
<tr>
	<td class="bx-filter-caption"><?php echo GetMessage('ISS_TPL_SIMPLE_FILTER_DEPARTMENT')?>: </td>
	<td>
        <?php
$APPLICATION->IncludeComponent(
	...
	<td class="bx-filter-caption"><?php echo GetMessage('ISS_TPL_SIMPLE_FILTER_FIO')?>: </td>
...
<tr>
	<td colspan="2">
		...
		<input type="submit" name="set_filter_<?=$arParams['FILTER_NAME']?>" value="<?php echo GetMessage('ISS_TPL_FILTER_SUBMIT')?>" class="bx-submit-btn" />
		<input type="submit" name="del_filter_<?=$arParams['FILTER_NAME']?>" value="<?php echo GetMessage('ISS_TPL_FILTER_CANCEL')?>" class="bx-reset-btn" />
	</td>
</tr>
</tfoot>
</table>
