...
$MESS ['SHOW_POST_FORM'] = 'При включенной опции форма подписки по почте будет отображаться';
$MESS ['SHOW_SMS_FORM'] = 'При включенной опции форма подписки по SMS будет отображаться';
