...
<div>
	...
	<thead>
		...
		<tr>
			...
			<td><font color="gray" size="2px"><?=declOfNum($arResult["POST_SUBSCRIBERS"], [GetMessage("subscriber"),GetMessage("subscribers"),GetMessage("subscriberss")])?></font></td>
		</tr>
        <?php endif;?>
        <?php if ($arResult["SHOW_RSS_SUB"]):?>
		<tr>
			...
			<td><font color="gray" size="2px"><?=declOfNum($arResult["RSS_SUBSCRIBERS"], [GetMessage("reader"), GetMessage("readerss"), GetMessage("readers")])?></font></td>
		</tr>
        <?php endif;?>
        <?php if ($arResult["SHOW_SMS_SUB"]):?>
		<tr>
			...
			<td><font color="gray" size="2px"><?=declOfNum($arResult["SMS_SUBSCRIBERS"], [GetMessage("reader"), GetMessage("readerss"), GetMessage("readers")])?></font></td>
		</tr>
        <?php endif;?>
	</table>
</div>
