...
$MESS ["SHOW_RUBS_TIP"] = "The specified headings will be accessible to a subscription. If not to specify anything, all headings will be displayed.";
$MESS ["TEMPLATE_ID"] = "Defines the identifier of a post template on which the message with confirmation code will be sent to user.";
$MESS ["SHOW_POST_FORM"] = "To show the form of editing of a post subscription";  
$MESS ["SHOW_SMS_FORM"] = "To show the form of editing of a SMS subscription";
