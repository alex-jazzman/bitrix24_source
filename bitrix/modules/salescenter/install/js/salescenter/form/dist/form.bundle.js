	...
	var Form = /*#__PURE__*/function () {
	  ...
	  babelHelpers.createClass(Form, [{
	    ...
	    value: function renderField(field) {
	      ...
	      var title = '';
	      if (field.title) {
	        title = main_core.Tag.render(_templateObject4 || (_templateObject4 = babelHelpers.taggedTemplateLiteral(["<div class=\"", " ", "\">", "</div>"])), this.classes.get('controlTitle'), field.required ? this.classes.get('controlRequired') : '', main_core.Text.encode(field.title));
	      }
	      var subtextLink = '';
	      if (field.subtextLinkOnClick && field.subtextLinkText) {
	        subtextLink = main_core.Tag.render(_templateObject5 || (_templateObject5 = babelHelpers.taggedTemplateLiteral(["<a onclick=\"", "\" class=\"", "\">", "</a>"])), main_core.Text.encode(field.subtextLinkOnClick), this.classes.get('subtextLink'), main_core.Text.encode(field.subtextLinkText));
	      }
	      var subtext = '';
	      if (field.subtext) {
	        subtext = main_core.Tag.render(_templateObject6 || (_templateObject6 = babelHelpers.taggedTemplateLiteral(["<div class=\"", "\">", " ", "</div>"])), this.classes.get('subtextContainer'), main_core.Text.encode(field.subtext), subtextLink);
	      }
	      if (field.html.indexOf('type="checkbox"') > 0) {
	        label = main_core.Tag.render(_templateObject7 || (_templateObject7 = babelHelpers.taggedTemplateLiteral(["<label class=\"", " ", "\">", "", "", "</label>"])), this.classes.get('controlInner'), this.classes.get('controlCheckbox'), field.input, field.title ? '<div class="' + this.classes.get('controlCheckboxLabel') + '">' + main_core.Text.encode(field.title) + '</div>' : '', hint);
	        ...
	        label = main_core.Tag.render(_templateObject8 || (_templateObject8 = babelHelpers.taggedTemplateLiteral(["\n\t\t\t\t", "\n\t\t\t\t<label class=\"", " ", "\">\n\t\t\t\t", "\n\t\t\t\t", "\n\t\t\t\t</label>\n\t\t\t\t<span></span>\n\t\t\t\t", "\n\t\t\t\t", "\n\t\t\t"])), title, this.classes.get('controlInner'), this.classes.get('controlFile'), field.input, field.label ? '<div class="ui-ctl-label-text">' + main_core.Text.encode(field.label) + '</div>' : '', hiddenFileInput, subtext);
	      } else if (field.type === 'list' || field.html.indexOf('select') > 0) {
	        label = main_core.Tag.render(_templateObject9 || (_templateObject9 = babelHelpers.taggedTemplateLiteral(["\n\t\t\t\t", "\n\t\t\t\t<div class=\"", " ", "\">\n\t\t\t\t\t<div class=\"", "\"></div>\n\t\t\t\t\t", "\n\t\t\t\t</div>\n\t\t\t\t", "\n\t\t\t"])), title, this.classes.get('controlSelect'), this.classes.get('controlInner'), this.classes.get('controlSelectIcon'), field.input, subtext);
	      } else {
	        label = main_core.Tag.render(_templateObject10 || (_templateObject10 = babelHelpers.taggedTemplateLiteral(["\n\t\t\t\t", "\n\t\t\t\t<div class=\"", "", "\">\n\t\t\t\t\t", "", "\n\t\t\t\t</div>\n\t\t\t\t", "\n\t\t\t"])), title, this.classes.get('controlInner'), hint ? ' ' + this.classes.get('controlAfterIcon') : '', field.input, hint, subtext);
	      }
	      result = main_core.Tag.render(_templateObject11 || (_templateObject11 = babelHelpers.taggedTemplateLiteral(["<div class=\"", "\">", "</div>"])), this.classes.get('controlContainer'), label);
	      return result;
	    }
	    /**
	     * @param field
	    ...
	    value: function renderFieldInput(field) {
	      ...
	      if (type === 'text') {
	        ...
	        result = main_core.Tag.render(_templateObject12 || (_templateObject12 = babelHelpers.taggedTemplateLiteral(["<input \n\t\t\t\tonchange=\"", "\" \n\t\t\t\tname=\"", "\"\n\t\t\t\tvalue=\"\"\n\t\t\t\tclass=\"", "\"\n\t\t\t\ttype=\"file\">"])), onFileChange, main_core.Text.encode(field.name), this.classes.get('controlInput'));
	      }
	      return result;
	    }
	    /**
