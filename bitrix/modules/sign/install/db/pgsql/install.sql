...
CREATE TABLE IF NOT EXISTS b_sign_document (
  ...
  COMPANY_ENTITY_ID int8 DEFAULT null,
  ...
  HCMLINK_DATE_SETTING_ID int null default null,
  HCMLINK_EXTERNAL_ID_SETTING_ID int null default null,
  HCMLINK_DOCUMENT_TYPE_SETTING_ID int null default null,
  DATE_SIGN_UNTIL timestamp null DEFAULT null,
...
CREATE INDEX IF NOT EXISTS ix_b_sign_document_created_by_id_date_create ON b_sign_document (created_by_id, date_create);
CREATE INDEX IF NOT EXISTS ix_b_sign_document_template_id_initiated_by_type ON b_sign_document (template_id, initiated_by_type);
...
CREATE TABLE IF NOT EXISTS b_sign_document_template (
	...
	FOLDER_ID int8 DEFAULT null,
	HIDDEN smallint NOT NULL DEFAULT 0
);
CREATE UNIQUE INDEX IF NOT EXISTS uk_b_sign_document_template_uid ON b_sign_document_template (uid);
CREATE INDEX IF NOT EXISTS ix_b_sign_document_template_folder_id ON b_sign_document_template (folder_id);
CREATE INDEX IF NOT EXISTS ix_b_sign_document_template_hidden ON b_sign_document_template (hidden);
CREATE INDEX IF NOT EXISTS ix_b_sign_document_template_title_hidden ON b_sign_document_template (title, hidden);
CREATE INDEX IF NOT EXISTS ix_b_sign_document_template_status_visibility ON b_sign_document_template (status, visibility);
...
(
	...
	DEPTH_LEVEL int8 DEFAULT 0 NOT NULL,
	CREATED_BY_ID int8 NOT NULL,
	PRIMARY KEY (ID)
);
CREATE UNIQUE INDEX IF NOT EXISTS uk_b_sign_document_template_folder_relation ON b_sign_document_template_folder_relation (entity_id, entity_type);
CREATE INDEX IF NOT EXISTS ix_b_sign_document_folder_relation_parent_entity_type ON b_sign_document_template_folder_relation(parent_id, entity_type);
CREATE INDEX IF NOT EXISTS ix_b_sign_document_template_folder_relation_entity_type ON b_sign_document_template_folder_relation(entity_type);
