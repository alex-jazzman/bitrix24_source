...
(
	...
	COMPANY_ENTITY_ID int unsigned null default null,
	...
	EXTERNAL_ID_SOURCE_TYPE smallint default 0,
	EXTERNAL_DATE_CREATE_SOURCE_TYPE smallint default 0,
	HCMLINK_DATE_SETTING_ID int unsigned null default null,
	HCMLINK_EXTERNAL_ID_SETTING_ID int unsigned null default null,
	HCMLINK_DOCUMENT_TYPE_SETTING_ID int unsigned null default null,
	DATE_SIGN_UNTIL datetime null DEFAULT null,
	CONFIGURED_DATE_FORMAT varchar(50) null default null,
	PRIMARY KEY(ID),
	...
	INDEX IX_B_CREATED_BY_ID_DATE_CREATE (CREATED_BY_ID, DATE_CREATE),
	INDEX IX_B_TEMPLATE_ID_INITIATED_BY_TYPE (TEMPLATE_ID, INITIATED_BY_TYPE),
...
(
	...
	INDEX `IX_B_SIGN_DOCUMENT_TEMPLATE_FOLDER_ID` (`FOLDER_ID`),
	INDEX `IX_B_SIGN_DOCUMENT_TEMPLATE_HIDDEN` (`HIDDEN`),
	INDEX `IX_B_SIGN_DOCUMENT_TEMPLATE_TITLE_HIDDEN` (`TITLE`, `HIDDEN`),
	INDEX `IX_B_SIGN_DOCUMENT_TEMPLATE_STATUS_VISIBILITY` (`STATUS`, `VISIBILITY`)
);
...
CREATE TABLE IF NOT EXISTS b_sign_document_template_folder
(
...
CREATE TABLE IF NOT EXISTS b_sign_document_template_folder_relation
(
	ID BIGINT NOT NULL AUTO_INCREMENT,
	ENTITY_ID BIGINT NOT NULL,
	PARENT_ID BIGINT DEFAULT 0 NOT NULL,
	ENTITY_TYPE VARCHAR(255) NOT NULL,
	DEPTH_LEVEL BIGINT DEFAULT 0 NOT NULL,
	CREATED_BY_ID BIGINT NOT NULL,
	PRIMARY KEY (ID),
	UNIQUE INDEX UK_B_SIGN_DOCUMENT_TEMPLATE_FOLDER_RELATION (ENTITY_ID, ENTITY_TYPE),
	INDEX IX_B_SIGN_DOCUMENT_TEMPLATE_FOLDER_RELATION_PARENT_ENTITY_TYPE (PARENT_ID, ENTITY_TYPE),
	INDEX IX_B_SIGN_DOCUMENT_TEMPLATE_FOLDER_RELATION_ENTITY_TYPE (ENTITY_TYPE)
);

CREATE TABLE IF NOT EXISTS `b_sign_signers_list`
(
	`ID` INT UNSIGNED NOT NULL AUTO_INCREMENT,
	`TITLE` VARCHAR(255) NOT NULL,
	`CREATED_BY_ID` BIGINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `b_sign_signers_list_user`
(
