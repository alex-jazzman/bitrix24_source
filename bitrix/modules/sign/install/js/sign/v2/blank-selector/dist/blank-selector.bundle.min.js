this.BX=this.BX||{};this.BX.Sign=this.BX.Sign||{};(function(e,s,t,l,a,i,r,o,n,d,c,b,v){"use strict";let p=e=>e,h,L;var u=babelHelpers.classPrivateFieldLooseKey("layout");var B=babelHelpers.classPrivateFieldLooseKey("props");var P=babelHelpers.classPrivateFieldLooseKey("titleNode");var F=babelHelpers.classPrivateFieldLooseKey("descriptionNode");var g=babelHelpers.classPrivateFieldLooseKey("createListItem");class H{constructor(e){Object.defineProperty(this,g,{value:f});Object.defineProperty(this,u,{writable:true,value:void 0});Object.defineProperty(this,B,{writable:true,value:void 0});Object.defineProperty(this,P,{writable:true,value:void 0});Object.defineProperty(this,F,{writable:true,value:void 0});babelHelpers.classPrivateFieldLooseBase(this,P)[P]=d.Tag.render(h||(h=p`
		...
		`));this.setProps(e);babelHelpers.classPrivateFieldLooseBase(this,u)[u]=babelHelpers.classPrivateFieldLooseBase(this,g)[g]()}getLayout(){return babelHelpers.classPrivateFieldLooseBase(this,u)[u]}setTitle(e=""){babelHelpers.classPrivateFieldLooseBase(this,P)[P].textContent=e;babelHelpers.classPrivateFieldLooseBase(this,P)[P].title=e;this.setProps({...this.getProps(),title:e})}setDescription(e=""){babelHelpers.classPrivateFieldLooseBase(this,F)[F].textContent=e;babelHelpers.classPrivateFieldLooseBase(this,F)[F].title=e;this.setProps({...this.getProps(),description:e})}getProps(){return babelHelpers.classPrivateFieldLooseBase(this,B)[B]}setProps(e){babelHelpers.classPrivateFieldLooseBase(this,B)[B]=e}}function f(){const{title:e,description:s,modifier:t}=this.getProps();this.setTitle(e);this.setDescription(s);return d.Dom.create("div",{attrs:{className:`sign-blank-selector__list_item --${t}`},children:[babelHelpers.classPrivateFieldLooseBase(this,P)[P],babelHelpers.classPrivateFieldLooseBase(this,F)[F]]})}let y=e=>e,m,_,S,E;var k=babelHelpers.classPrivateFieldLooseKey("placeholder");var T=babelHelpers.classPrivateFieldLooseKey("preview");var O=babelHelpers.classPrivateFieldLooseKey("loader");class w extends H{constructor(e){super({...e,modifier:"blank"});Object.defineProperty(this,k,{writable:true,value:void 0});Object.defineProperty(this,T,{writable:true,value:void 0});Object.defineProperty(this,O,{writable:true,value:void 0});babelHelpers.classPrivateFieldLooseBase(this,k)[k]=d.Tag.render(m||(m=y`<div class="sign-blank-selector__list_item-status"></div>`));babelHelpers.classPrivateFieldLooseBase(this,T)[T]=d.Tag.render(_||(_=y`
			<div class="sign-blank-selector__list_item-preview" hidden>
				<img
					onload="${0}"
				/>
			</div>
		`),(()=>{babelHelpers.classPrivateFieldLooseBase(this,T)[T].hidden=false;babelHelpers.classPrivateFieldLooseBase(this,k)[k].hidden=true}));babelHelpers.classPrivateFieldLooseBase(this,O)[O]=new o.Loader({size:30,target:babelHelpers.classPrivateFieldLooseBase(this,k)[k]});const s=this.getLayout();d.Dom.prepend(babelHelpers.classPrivateFieldLooseBase(this,k)[k],s);d.Dom.prepend(babelHelpers.classPrivateFieldLooseBase(this,T)[T],s)}setAvatarWithDescription(e,s){this.setDescription(e);this.setProps({...this.getProps(),userAvatarUrl:s});const t=s?d.Tag.render(S||(S=y`
				<img class="sign-blank-selector__list_item-info-avatar" src="${0}" />
			`),s):d.Tag.render(E||(E=y`
				<span class="sign-blank-selector__list_item-info-avatar ui-icon ui-icon-common-user">
					<i></i>
				</span>
			`));const{lastElementChild:l}=this.getLayout();d.Dom.prepend(t,l)}select(){d.Dom.addClass(this.getLayout(),"--active")}deselect(){d.Dom.removeClass(this.getLayout(),"--active");this.getLayout().blur()}remove(){d.Dom.remove(this.getLayout())}setId(e){this.getLayout().dataset.id=e}setReady(e){if(!e){babelHelpers.classPrivateFieldLooseBase(this,O)[O].show();return}const s=this.getLayout();s.tabIndex="0";babelHelpers.classPrivateFieldLooseBase(this,O)[O].hide();d.Dom.addClass(s,"--loaded")}setPreview(e){if(e){babelHelpers.classPrivateFieldLooseBase(this,T)[T].firstElementChild.src=e}}}let C=e=>e,I;var K=babelHelpers.classPrivateFieldLooseKey("cache");var D=babelHelpers.classPrivateFieldLooseKey("setOptions");var A=babelHelpers.classPrivateFieldLooseKey("getOptions");var N=babelHelpers.classPrivateFieldLooseKey("getApi");var j=babelHelpers.classPrivateFieldLooseKey("getBlankSelector");var R=babelHelpers.classPrivateFieldLooseKey("getTagSelector");var U=babelHelpers.classPrivateFieldLooseKey("resetBlankSelector");class M extends c.EventEmitter{constructor(e){var s;super();Object.defineProperty(this,U,{value:V});Object.defineProperty(this,R,{value:W});Object.defineProperty(this,j,{value:G});Object.defineProperty(this,N,{value:$});Object.defineProperty(this,A,{value:X});Object.defineProperty(this,D,{value:x});Object.defineProperty(this,K,{writable:true,value:new d.Cache.MemoryCache});this.setEventNamespace("BX.Sign.BlankSelector.BlankField");this.subscribeFromOptions(e==null?void 0:e.events);babelHelpers.classPrivateFieldLooseBase(this,D)[D](e);const t=e==null?void 0:(s=e.data)==null?void 0:s.blankId;if(d.Type.isStringFilled(t)||d.Type.isNumber(t)){babelHelpers.classPrivateFieldLooseBase(this,N)[N]().getBlankById(e.data.blankId).then((({id:e,title:s})=>{babelHelpers.classPrivateFieldLooseBase(this,R)[R]().addTag({id:e,title:s,entityId:"blank"})}))}}getLayout(){return babelHelpers.classPrivateFieldLooseBase(this,K)[K].remember("layout",(()=>{const e=d.Tag.render(I||(I=C`
				<div class="sign-blank-selector-field">
				</div>
			`));babelHelpers.classPrivateFieldLooseBase(this,R)[R]().renderTo(e);return e}))}renderTo(e){if(d.Type.isDomNode(e)){d.Dom.append(this.getLayout(),e)}}}function x(e){babelHelpers.classPrivateFieldLooseBase(this,K)[K].set("options",e)}function X(){return babelHelpers.classPrivateFieldLooseBase(this,K)[K].get("options",{})}function $(){return babelHelpers.classPrivateFieldLooseBase(this,K)[K].remember("api",(()=>new b.Api))}function G(){return babelHelpers.classPrivateFieldLooseBase(this,K)[K].remember("blankSelector",(()=>new we({...babelHelpers.classPrivateFieldLooseBase(this,A)[A]().selectorOptions,events:{toggleSelection:e=>{const{id:s,title:t,selected:l}=e.getData();const a=babelHelpers.classPrivateFieldLooseBase(this,R)[R]();if(l){a.addTag({id:s,title:t,entityId:"blank"});a.showAddButton();this.emit("onSelect",e);return}if(a.getTags().length===0){a.showAddButton()}this.emit("onCancel")},onSliderClose:()=>{const e=babelHelpers.classPrivateFieldLooseBase(this,R)[R]();if(e.getTags().length===0){e.showAddButton()}babelHelpers.classPrivateFieldLooseBase(this,U)[U]()}}})))}function W(){return babelHelpers.classPrivateFieldLooseBase(this,K)[K].remember("tagSelector",(()=>new v.TagSelector({id:d.Text.getRandom(),multiple:false,showTextBox:false,addButtonCaption:d.Loc.getMessage("SIGN_BLANK_SELECTOR_FIELD_ADD_BUTTON_LABEL"),tagMaxWidth:500,events:{onAddButtonClick:()=>{babelHelpers.classPrivateFieldLooseBase(this,j)[j]().openInSlider();babelHelpers.classPrivateFieldLooseBase(this,R)[R]().hideTextBox()},onAfterTagRemove:()=>{babelHelpers.classPrivateFieldLooseBase(this,R)[R]().hideTextBox();babelHelpers.classPrivateFieldLooseBase(this,R)[R]().showAddButton();this.emit("onRemove")}}})))}function V(){babelHelpers.classPrivateFieldLooseBase(this,K)[K].delete("blankSelector")}let z=e=>e,Y,q,J,Q,Z,ee;const se={controller:"sign.upload.blankUploadController",acceptedFileTypes:[".jpg",".jpeg",".png",".pdf",".doc",".docx",".rtf",".odt"],multiple:true,autoUpload:false,maxFileSize:50*1024*1024,maxFileCount:100,imageMaxFileSize:10*1024*1024,maxTotalFileSize:50*1024*1024};const te={id:"qwerty",padding:20,offsetLeft:40,offsetTop:-12,angle:true,darkMode:true,width:300,autoHide:true,cacheable:false,bindOptions:{position:"bottom"}};var le=babelHelpers.classPrivateFieldLooseKey("cache");var ae=babelHelpers.classPrivateFieldLooseKey("blanks");var ie=babelHelpers.classPrivateFieldLooseKey("tileWidget");var re=babelHelpers.classPrivateFieldLooseKey("tileWidgetContainer");var oe=babelHelpers.classPrivateFieldLooseKey("uploadButtonsContainer");var ne=babelHelpers.classPrivateFieldLooseKey("relatedTarget");var de=babelHelpers.classPrivateFieldLooseKey("blanksContainer");var ce=babelHelpers.classPrivateFieldLooseKey("page");var be=babelHelpers.classPrivateFieldLooseKey("loadMoreButton");var ve=babelHelpers.classPrivateFieldLooseKey("api");var pe=babelHelpers.classPrivateFieldLooseKey("config");var he=babelHelpers.classPrivateFieldLooseKey("checkForFilesValid");var Le=babelHelpers.classPrivateFieldLooseKey("onFileBeforeAdd");var ue=babelHelpers.classPrivateFieldLooseKey("getImagesLimit");var Be=babelHelpers.classPrivateFieldLooseKey("onFileAdd");var Pe=babelHelpers.classPrivateFieldLooseKey("onFileRemove");var Fe=babelHelpers.classPrivateFieldLooseKey("onUploadStart");var ge=babelHelpers.classPrivateFieldLooseKey("toggleTileVisibility");var He=babelHelpers.classPrivateFieldLooseKey("createUploadButtons");var fe=babelHelpers.classPrivateFieldLooseKey("resumeUploading");var ye=babelHelpers.classPrivateFieldLooseKey("loadBlanks");var me=babelHelpers.classPrivateFieldLooseKey("setupBlank");var _e=babelHelpers.classPrivateFieldLooseKey("normalizeTitle");var Se=babelHelpers.classPrivateFieldLooseKey("addBlank");var Ee=babelHelpers.classPrivateFieldLooseKey("setSaveButtonIntoSlider");var ke=babelHelpers.classPrivateFieldLooseKey("disableSaveButtonIntoSlider");var Te=babelHelpers.classPrivateFieldLooseKey("enableSaveButtonIntoSlider");var Oe=babelHelpers.classPrivateFieldLooseKey("getSaveButtonIntoSlider");class we extends c.EventEmitter{constructor(e){var s;super();Object.defineProperty(this,Oe,{value:ze});Object.defineProperty(this,Te,{value:Ve});Object.defineProperty(this,ke,{value:We});Object.defineProperty(this,Ee,{value:Ge});Object.defineProperty(this,Se,{value:$e});Object.defineProperty(this,_e,{value:Xe});Object.defineProperty(this,me,{value:xe});Object.defineProperty(this,ye,{value:Me});Object.defineProperty(this,fe,{value:Ue});Object.defineProperty(this,He,{value:Re});Object.defineProperty(this,ge,{value:je});Object.defineProperty(this,Fe,{value:Ne});Object.defineProperty(this,Pe,{value:Ae});Object.defineProperty(this,Be,{value:De});Object.defineProperty(this,ue,{value:Ke});Object.defineProperty(this,Le,{value:Ie});Object.defineProperty(this,he,{value:Ce});this.events=Object.freeze({beforeAddFileSuccessfully:"beforeAddFileSuccessfully",toggleSelection:"toggleSelection",addFile:"addFile"});Object.defineProperty(this,le,{writable:true,value:new d.Cache.MemoryCache});Object.defineProperty(this,ae,{writable:true,value:void 0});Object.defineProperty(this,ie,{writable:true,value:void 0});Object.defineProperty(this,re,{writable:true,value:void 0});Object.defineProperty(this,oe,{writable:true,value:void 0});Object.defineProperty(this,ne,{writable:true,value:void 0});Object.defineProperty(this,de,{writable:true,value:void 0});Object.defineProperty(this,ce,{writable:true,value:void 0});Object.defineProperty(this,be,{writable:true,value:void 0});Object.defineProperty(this,ve,{writable:true,value:void 0});Object.defineProperty(this,pe,{writable:true,value:void 0});this.setEventNamespace("BX.Sign.V2.BlankSelector");this.subscribeFromOptions((s=e==null?void 0:e.events)!=null?s:{});babelHelpers.classPrivateFieldLooseBase(this,pe)[pe]=e;this.selectedBlankId=0;babelHelpers.classPrivateFieldLooseBase(this,ae)[ae]=new Map;babelHelpers.classPrivateFieldLooseBase(this,ce)[ce]=0;const t=babelHelpers.classPrivateFieldLooseBase(this,He)[He]();const l=d.Tag.render(Y||(Y=z`
		...
		`),t,l);babelHelpers.classPrivateFieldLooseBase(this,ie)[ie]=new i.TileWidget({...se,...e.uploaderOptions,dropElement:babelHelpers.classPrivateFieldLooseBase(this,oe)[oe],browseElement:[...t,l],events:{[r.UploaderEvent.BEFORE_FILES_ADD]:e=>babelHelpers.classPrivateFieldLooseBase(this,Le)[Le](e),[r.UploaderEvent.FILE_ADD]:e=>babelHelpers.classPrivateFieldLooseBase(this,Be)[Be](e),[r.UploaderEvent.FILE_REMOVE]:e=>babelHelpers.classPrivateFieldLooseBase(this,Pe)[Pe](e),[r.UploaderEvent.UPLOAD_START]:e=>babelHelpers.classPrivateFieldLooseBase(this,Fe)[Fe](e)}},a);babelHelpers.classPrivateFieldLooseBase(this,ne)[ne]=null;d.Event.bind(document,"mousedown",(e=>{babelHelpers.classPrivateFieldLooseBase(this,ne)[ne]=e.target}));babelHelpers.classPrivateFieldLooseBase(this,de)[de]=d.Tag.render(J||(J=z`
			<div
