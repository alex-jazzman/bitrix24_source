...
(function (exports,ui_vue3,main_core_events,main_core,sign_v2_b2e_signSettingsTemplates,ui_vue3_pinia,crm_router,sign_v2_b2e_vueUtil,ui_vue3_components_switcher,ui_switcher,ui_vue3_components_hint) {
	'use strict';
	...
	var DocumentFillingApp = {
	  ...
	  methods: {
	    ...
	    makeDefaultDocumentSettings: function makeDefaultDocumentSettings(doc) {
	      ...
	      var defaultRegistrationNumber = this.getDefaultRegistrationNumber();
	      signingDate.setMonth(signingDate.getMonth() + defaultSigningDateMonth);
	      return {
	        registrationNumber: defaultRegistrationNumber,
	        creationDate: new Date(),
	        signingDate: doc ? new Date(doc.dateSignUntil) : this.getFallbackSignigningDate()
	      };
	    },
...
}((this.BX.Sign.V2.B2e = this.BX.Sign.V2.B2e || {}),BX.Vue3,BX.Event,BX,BX.Sign.V2.B2e,BX.Vue3.Pinia,BX.Crm,BX.Sign.V2.B2e,BX.UI.Vue3.Components,BX.UI,BX.Vue3.Components));
