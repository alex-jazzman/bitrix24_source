...
$MESS["SIGN_DOCUMENT_SEND_DATETIME_LIMIT_SELECTOR_HINT"] = "До цього часу всі учасники мають підписати документ.";
$MESS["SIGN_DOCUMENT_SEND_DEADLINE"] = "Крайній термін: необмежено";
$MESS["SIGN_DOCUMENT_SEND_FIRST_PARTY"] = "Перша сторона";
$MESS["SIGN_DOCUMENT_SEND_FIRST_PARTY_TEMPLATE"] = "Хто підписуватиме від імені компанії";
$MESS["SIGN_DOCUMENT_SEND_HEADER_1"] = "Перевірте дані";
...
$MESS["SIGN_SEND_CLOSE_DESCRIPTION"] = "Надсилання може зайняти тривалий час. Ви можете закрити цю сторінку, надсилання відбудеться у фоновому режимі.";
$MESS["SIGN_SEND_CLOSE_DESCRIPTION_GROUP"] = "Дочекайтеся, поки надсилання документів завершиться, і не закривайте сторінку.";
...
$MESS["SIGN_SEND_SIGNING_VALIDATION_HEAD_REVIEWER_TEMPLATE"] = "Хто погоджуватиме документ";
