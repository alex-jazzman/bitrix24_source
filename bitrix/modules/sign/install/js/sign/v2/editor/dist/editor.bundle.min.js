...
<!--				<div class="sign-document__block-style&#45;&#45;move-control"></div>-->
		...
		`),_.Loc.getMessage("SIGN_EDITOR_EDITING"),_.Loc.getMessage("SIGN_EDITOR_EDITING_HINT_MSGVER_1"));t.Hint.create(o);const r=babelHelpers.classPrivateFieldLooseBase(this,Mr)[Mr]?"hide":"show";const n=babelHelpers.classPrivateFieldLooseBase(this,Wr)[Wr](r);return _.Tag.render(dr||(dr=ir`
		...
		`),o,a,babelHelpers.classPrivateFieldLooseBase(this,Nr)[Nr]||!babelHelpers.classPrivateFieldLooseBase(this,wr)[wr]()?"":n,e,l,(()=>babelHelpers.classPrivateFieldLooseBase(this,$r)[$r]()),l,s,i,(e=>babelHelpers.classPrivateFieldLooseBase(this,Gr)[Gr](e)),i)}async function rn({target:e}){_.Dom.addClass(e,"ui-btn-wait");const t=await babelHelpers.classPrivateFieldLooseBase(this,fr)[fr].save();const l=babelHelpers.classPrivateFieldLooseBase(this,fr)[fr].getDocumentUid();_.Dom.removeClass(e,"ui-btn-wait");if(!t){return}y.EventEmitter.subscribeOnce("SidePanel.Slider:onCloseComplete",(()=>{this.emit("save",{uid:l,blocks:t});if(babelHelpers.classPrivateFieldLooseBase(this,Dr)[Dr]instanceof s.Analytics&&babelHelpers.classPrivateFieldLooseBase(this,Nr)[Nr]){babelHelpers.classPrivateFieldLooseBase(this,Dr)[Dr].send({event:"proceed_step_document_editor",status:"success"})}}));babelHelpers.classPrivateFieldLooseBase(this,Ir)[Ir]=false;babelHelpers.classPrivateFieldLooseBase(this,Lr)[Lr].close();babelHelpers.classPrivateFieldLooseBase(this,Ir)[Ir]=true;babelHelpers.classPrivateFieldLooseBase(this,Yr)[Yr](false)}function nn(){babelHelpers.classPrivateFieldLooseBase(this,Yr)[Yr](true);if(babelHelpers.classPrivateFieldLooseBase(this,Dr)[Dr]instanceof s.Analytics&&babelHelpers.classPrivateFieldLooseBase(this,Nr)[Nr]){babelHelpers.classPrivateFieldLooseBase(this,Dr)[Dr].send({event:"open_document_editor",status:"success"})}}function cn(){const e=babelHelpers.classPrivateFieldLooseBase(this,zr)[zr]();const s=_.Tag.render(br||(br=ir`
		...
		`),babelHelpers.classPrivateFieldLooseBase(this,yr)[yr],e);t.Hint.create(e,{bindOptions:{position:"top"},angle:{position:"bottom"},targetContainer:s});babelHelpers.classPrivateFieldLooseBase(this,fr)[fr].setEditorContent(s);return s}function dn(){const e=babelHelpers.classPrivateFieldLooseBase(this,Vr)[Vr]().filter((({singleBlockSection:e})=>e!==true));const s=e.map((e=>{const s=Object.entries(e.blocks);const t=s.map((([s,t])=>{const{title:l,hint:i}=t;return _.Tag.render(pr||(pr=ir`
					<div
		...
		`),e,_.Loc.getMessage(s),babelHelpers.classPrivateFieldLooseBase(this,Zr)[Zr].bind(this))}async function Ln(e){const s=e.currentTarget;const t=_.Dom.hasClass(s,"show");_.Dom.toggleClass(s,["show","hide"]);const l=t?_.Loc.getMessage("SIGN_EDITOR_SHOW_IN_MASTER"):_.Loc.getMessage("SIGN_EDITOR_HIDE_IN_MASTER");_.Dom.attr(s,{title:l});try{await babelHelpers.classPrivateFieldLooseBase(this,Cr)[Cr].changeEditorStepVisibility(t)}catch(e){console.error(e)}}e.SectionType=gr;e.Editor=en})(this.BX.Sign.V2=this.BX.Sign.V2||{},BX.Sign.V2,BX.Sign.V2,BX.Main,BX.Sign.Tour,BX,BX.UI,BX.UI.Dialogs,BX.UI,BX.Sign,BX,BX,BX.UI.Stamp,BX.Crm.Form.Fields,BX.Crm.Requisite,BX.Sign,BX.Sign.B2e,BX.Sign,BX,BX.Sign,BX,BX.UI.DragAndDrop,BX.Event,BX.Sign.V2);
