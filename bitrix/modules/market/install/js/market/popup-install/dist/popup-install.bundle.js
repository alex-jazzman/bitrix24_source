...
(function (exports,market_installStore,ui_vue3_pinia) {
	...
	const PopupInstall = {
	  ...
	  computed: {
	    ...
	    ...ui_vue3_pinia.mapState(market_installStore.marketInstallState, ['installStep', 'licenseError', 'openAppAfterInstall', 'timer', 'slider', 'versionSlider'])
	  },
	  mounted() {
	...
	exports.PopupInstall = PopupInstall;
