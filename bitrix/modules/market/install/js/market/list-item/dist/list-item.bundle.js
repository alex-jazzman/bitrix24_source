/* eslint-disable */
this.BX = this.BX || {};
(function (exports,market_popupInstall,market_popupUninstall,ui_vue3_pinia,market_installStore,market_uninstallStore,market_ratingStars,ui_iconSet_api_vue,main_popup,market_marketLinks,main_core) {
	'use strict';
	...
	var ListItem = {
	  ...
	  computed: {
	    ...
	    itemDisplayName: function itemDisplayName() {
	      var _Extension$getSetting, _this$item$NAME, _this$item;
	      var copilotName = (_Extension$getSetting = main_core.Extension.getSettings('market.collection-item-ai')) === null || _Extension$getSetting === void 0 ? void 0 : _Extension$getSetting.copilotName;
	      var name = (_this$item$NAME = (_this$item = this.item) === null || _this$item === void 0 ? void 0 : _this$item.NAME) !== null && _this$item$NAME !== void 0 ? _this$item$NAME : '';
	      if (!name || !copilotName) {
	        return name;
	      }
	  ...
	  methods: _objectSpread(_objectSpread({
	    getDetailLink: function getDetailLink() {
	      var params = {
	        from: this.fromParam
	      };
	      return market_marketLinks.MarketLinks.appDetail(this.item, params);
	    },
...
}((this.BX.Market = this.BX.Market || {}),BX.Market,BX.Market,BX.Vue3.Pinia,BX.Market,BX.Market,BX.Market,BX.UI.IconSet,BX.Main,BX.Market,BX));
