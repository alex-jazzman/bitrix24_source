this.BX=this.BX||{};this.BX.UI=this.BX.UI||{};(function(e,t,s,a,o,i,r,n){"use strict";let u=e=>e,c,l;class d{constructor(e){this.cache=new i.Cache.MemoryCache;this.setOptions(e)}setOptions(e){this.cache.set("options",{...e})}getOptions(){return this.cache.get("options",{})}setValue(e){if(i.Type.isString(e)||i.Type.isNumber(e)){this.getValueLayout().textContent=e}}getValueLayout(){return this.cache.remember("valueLayout",(()=>i.Tag.render(c||(c=u`
			...
			`),i.Loc.getMessage("UI_STAMP_UPLOADER_HEADER_TITLE"),this.getValueLayout())))}appendTo(e){if(i.Type.isDomNode(e)){i.Dom.append(this.getLayout(),e)}}prependTo(e){if(i.Type.isDomNode(e)){i.Dom.prepend(this.getLayout(),e)}}renderTo(e){this.appendTo(e)}}let h=e=>e,p;class g{constructor(e){this.cache=new i.Cache.MemoryCache;this.setOptions(e)}setOptions(e){this.cache.set("options",{...e})}getOptions(){return this.cache.get("options",{})}getLayout(){return this.cache.remember("layout",(()=>i.Tag.render(p||(p=h`
