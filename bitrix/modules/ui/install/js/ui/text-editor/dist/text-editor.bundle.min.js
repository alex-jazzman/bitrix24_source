this.BX=this.BX||{};this.BX.UI=this.BX.UI||{};(function(e,t,s,i,r,a,o,l,n,d,c,h,b,u,p,g,v,f,P,m,L,y,F){"use strict";const H=L.createCommand("HIDE_DIALOG_COMMAND");const B=L.createCommand("DIALOG_VISIBILITY_COMMAND");const C=L.createCommand("DRAG_START_COMMAND");const O=L.createCommand("DRAG_END_COMMAND");var T=Object.freeze({HIDE_DIALOG_COMMAND:H,DIALOG_VISIBILITY_COMMAND:B,DRAG_START_COMMAND:C,DRAG_END_COMMAND:O});const E=1;const N={LINE_BREAK:"line-break",PARAGRAPH:"paragraph",MIXED:"mixed"};var _=Object.freeze({UNFORMATTED:E,NewLineMode:N});const M=Object.freeze({"\t":"\\t","\n":"\\n"});const D=new RegExp(Object.keys(M).join("|"),"g");const S=Object.freeze({ancestorHasNextSibling:"|",ancestorIsLastChild:" ",hasNextSibling:"\u251c",isLastChild:"\u2514",selectedChar:"^",selectedLine:">"});const R=[e=>e.hasFormat("bold")&&"Bold",e=>e.hasFormat("code")&&"Code",e=>e.hasFormat("italic")&&"Italic",e=>e.hasFormat("strikethrough")&&"Strikethrough",e=>e.hasFormat("subscript")&&"Subscript",e=>e.hasFormat("superscript")&&"Superscript",e=>e.hasFormat("underline")&&"Underline"];const I=[e=>e.isDirectionless()&&"Directionless",e=>e.isUnmergeable()&&"Unmergeable"];const x=[e=>e.isToken()&&"Token",e=>e.isSegmented()&&"Segmented"];function w(e){const t=e.anchor;const s=e.focus;const i=e.anchor.getNode();const r=e.focus.getNode();if(i===r){return i}const a=e.isBackward();if(a){return d.$isAtNodeEnd(s)?i:r}return d.$isAtNodeEnd(t)?i:r}const A={b:"bold",strong:"bold",i:"italic",em:"italic",s:"strikethrough",del:"strikethrough",u:"underline",sub:"subscript",sup:"superscript"};function $(e){const t=A[e.getName()];if(t===undefined){return{node:null}}return{forChild:e=>{if(L.$isTextNode(e)&&!e.hasFormat(t)){e.toggleFormat(t)}return e},node:null}}function K(e,t,i=true){const r=t.getBBCodeScheme();const a=new s.BBCodeParser({scheme:r});const o=a.parse(e);const l=o.getChildren();let n=[];for(const e of l){const s=j(e,t);if(s!==null){n=[...n,...s]}}return i?U(n):n}function j(e,t,s=new Map,i=null){if(e instanceof n.BBCodeNewLineNode){return[L.$createLineBreakNode()]}if(e instanceof n.BBCodeTabNode){return[L.$createTabNode()]}let r=[];let a=null;const o=Y(e,t);const l=o?o(e):null;let d=null;if(l!==null){d=l.after;const t=l.node;a=Array.isArray(t)?t[t.length-1]:t;if(a!==null){for(const[,e]of s){a=e(a,i);if(!a){break}}if(a){r.push(...Array.isArray(t)?t:[a])}}if(F.Type.isFunction(l.forChild)){s.set(e.getName(),l.forChild)}}const c=e.getChildren();let h=[];for(const e of c){h.push(...j(e,t,new Map(s),a))}if(F.Type.isFunction(d)){h=d(h)}if(l===null){if(e.getType()===n.BBCodeNode.ELEMENT_NODE){const t=e;if(t.isVoid()){h=[L.$createTextNode(t.getOpeningTag()),...h]}else{h=[L.$createTextNode(t.getOpeningTag()),...h,L.$createTextNode(t.getClosingTag())]}}else{h=[L.$createTextNode(e.toString()),...h]}}if(a===null){r=[...r,...h]}else if(L.$isElementNode(a)){a.append(...h)}return r}function k(e){if(L.$isElementNode(e)&&e.isInline()===false){return false}return!(L.$isDecoratorNode(e)&&e.isInline()===false)}function U(e){const t=[];let s=null;let i=0;for(const r of e){if(L.$isLineBreakNode(r)){i++;continue}if(k(r)){if(s===null||i>=2){t.push(...W(i-2));s=L.$createParagraphNode();t.push(s)}else if(i===1){s.append(L.$createLineBreakNode())}s.append(r)}else{if(i>2){t.push(...W(i-2))}t.push(r);s=null}i=0}if(t.length===0){return[L.$createParagraphNode()]}return t}function W(e=1){const t=[];for(let s=0;s<e;s++){t.push(L.$createParagraphNode())}return t}function Y(e,t){const s=e.getName();let i=null;const r=t.getBBCodeImportMap();const a=r.get(s.toLowerCase());if(a!==undefined){for(const t of a){const s=t(e);if(s!==null&&(i===null||i.priority<s.priority)){i=s}}}if(i===null){if(s==="#text"){return z}return null}return i.conversion}function z(e){let t=e.getContent();t=t.replaceAll(/\r?\n|\t/gm," ").replace("\r","");if(t===""){return{node:null}}return{node:L.$createTextNode(t)}}function X(e){if(!L.$isParagraphNode(e)){return false}if(e.isEmpty()){return true}return e.getChildren().every((e=>L.$isLineBreakNode(e)||L.$isTextNode(e)&&/^\s*$/.test(e.getTextContent())))}function G(e){const t=[...e];while(t.length>0&&X(t[0])){t.splice(0,1)}while(t.length>0&&X(t[t.length-1])){t.splice(-1,1)}return t}function V(e,t){const s=t.getBBCodeScheme();const i=s.createRoot();const r=G(e.getChildren());for(const e of r){J(e,i,t)}return i}function J(e,t,s){const{node:i,after:r}=Q(e,s);if(!i){return}const a=s.getBBCodeScheme();const o=a.createFragment();const l=L.$isElementNode(e)?e.getChildren():[];for(const e of l){J(e,o,s)}i.appendChild(o);t.appendChild(i);if(F.Type.isFunction(r)){const t=r.call(e,i);if(t){i.getParent().replaceChild(i,t)}}}const q=["bold","italic","strikethrough","underline"];function Q(e,t){const s=e.getType();const i=t.getBBCodeExportMap();const r=i.get(s);if(F.Type.isFunction(r)){return r(e)}const a=t.getBBCodeScheme();if(L.$isTextNode(e)&&e.getType()==="text"){const t=a.createText({encode:false,content:e.getTextContent()});if(e.getFormat()===0){return{node:t}}let s=t;q.forEach((t=>{const r=i.get(`text:${t}`);if(F.Type.isFunction(r)){s=r(e,s)||s}}));return{node:s}}if(L.$isLineBreakNode(e)){return{node:a.createNewLine()}}if(L.$isTabNode(e)){return{node:a.createTab()}}if(L.$isTextNode(e)||L.$isElementNode(e)){const t=a.createText({encode:false,content:e.getTextContent()});return{node:t}}return{node:null}}function Z(e,t,s){const i=s.getBBCodeScheme();const r=i.createElement({name:t});r.appendChild(e);return r}var ee=babelHelpers.classPrivateFieldLooseKey("textEditor");var te=babelHelpers.classPrivateFieldLooseKey("destroyed");var se=babelHelpers.classPrivateFieldLooseKey("removeListeners");class ie{constructor(e){Object.defineProperty(this,ee,{writable:true,value:null});Object.defineProperty(this,te,{writable:true,value:false});Object.defineProperty(this,se,{writable:true,value:()=>{}});babelHelpers.classPrivateFieldLooseBase(this,ee)[ee]=e}static getName(){throw new Error("getName must be implemented in a child class")}static getNodes(e){return[]}importBBCode(){return null}exportBBCode(){return null}validateScheme(){return null}afterInit(){}getName(){return this.constructor.getName()}getEditor(){return babelHelpers.classPrivateFieldLooseBase(this,ee)[ee]}getLexicalEditor(){return babelHelpers.classPrivateFieldLooseBase(this,ee)[ee].getLexicalEditor()}cleanUpRegister(...e){babelHelpers.classPrivateFieldLooseBase(this,se)[se]=y.mergeRegister(babelHelpers.classPrivateFieldLooseBase(this,se)[se],...e)}isDestroyed(){return babelHelpers.classPrivateFieldLooseBase(this,te)[te]}destroy(){babelHelpers.classPrivateFieldLooseBase(this,te)[te]=true;babelHelpers.classPrivateFieldLooseBase(this,se)[se]();babelHelpers.classPrivateFieldLooseBase(this,se)[se]=null}}class re extends b.EventEmitter{constructor(){super();this.setEventNamespace("BX.UI.TextEditor.ToolbarItem")}getContainer(){throw new Error("You must implement getContainer() method.")}render(){throw new Error("You must implement render() method.")}}let ae=e=>e,oe;var le=babelHelpers.classPrivateFieldLooseKey("format");var ne=babelHelpers.classPrivateFieldLooseKey("blockType");var de=babelHelpers.classPrivateFieldLooseKey("active");var ce=babelHelpers.classPrivateFieldLooseKey("disabled");var he=babelHelpers.classPrivateFieldLooseKey("disableInsideUnformatted");var be=babelHelpers.classPrivateFieldLooseKey("disableCallback");var ue=babelHelpers.classPrivateFieldLooseKey("container");var pe=babelHelpers.classPrivateFieldLooseKey("handleClick");class ge extends re{constructor(...e){super(...e);Object.defineProperty(this,pe,{value:ve});Object.defineProperty(this,le,{writable:true,value:null});Object.defineProperty(this,ne,{writable:true,value:null});Object.defineProperty(this,de,{writable:true,value:false});Object.defineProperty(this,ce,{writable:true,value:false});Object.defineProperty(this,he,{writable:true,value:false});Object.defineProperty(this,be,{writable:true,value:null});Object.defineProperty(this,ue,{writable:true,value:null})}setContent(e){if(F.Type.isString(e)){this.getContainer().innerHTML=e}else if(F.Type.isElementNode(e)){this.getContainer().append(e)}}setFormat(e){babelHelpers.classPrivateFieldLooseBase(this,le)[le]=e}getFormat(){return babelHelpers.classPrivateFieldLooseBase(this,le)[le]}hasFormat(){return babelHelpers.classPrivateFieldLooseBase(this,le)[le]}setBlockType(e){babelHelpers.classPrivateFieldLooseBase(this,ne)[ne]=e}getBlockType(){return babelHelpers.classPrivateFieldLooseBase(this,ne)[ne]}setTooltip(e){if(F.Type.isStringFilled(e)){F.Dom.attr(this.getContainer(),"title",F.Text.encode(e))}else if(e===null){F.Dom.attr(this.getContainer(),"title",null)}}disableInsideUnformatted(){babelHelpers.classPrivateFieldLooseBase(this,he)[he]=true}enableInsideUnformatted(){babelHelpers.classPrivateFieldLooseBase(this,he)[he]=false}shouldDisableInsideUnformatted(){return babelHelpers.classPrivateFieldLooseBase(this,he)[he]}setActive(e=true){if(e===babelHelpers.classPrivateFieldLooseBase(this,de)[de]){return}babelHelpers.classPrivateFieldLooseBase(this,de)[de]=e;if(e){F.Dom.addClass(this.getContainer(),"--active")}else{F.Dom.removeClass(this.getContainer(),"--active")}}isActive(){return babelHelpers.classPrivateFieldLooseBase(this,de)[de]}setDisabled(e=true){if(e===babelHelpers.classPrivateFieldLooseBase(this,ce)[ce]){return}babelHelpers.classPrivateFieldLooseBase(this,ce)[ce]=e;if(e){F.Dom.attr(this.getContainer(),{disabled:true})}else{F.Dom.attr(this.getContainer(),{disabled:null})}}disable(){this.setDisabled(true)}enable(){this.setDisabled(false)}isDisabled(){return babelHelpers.classPrivateFieldLooseBase(this,ce)[ce]}hasOwnDisableCallback(){return babelHelpers.classPrivateFieldLooseBase(this,be)[be]!==null}setDisableCallback(e){if(F.Type.isFunction(e)){babelHelpers.classPrivateFieldLooseBase(this,be)[be]=e}}invokeDisableCallback(){return babelHelpers.classPrivateFieldLooseBase(this,be)[be]()}getContainer(){if(babelHelpers.classPrivateFieldLooseBase(this,ue)[ue]===null){babelHelpers.classPrivateFieldLooseBase(this,ue)[ue]=F.Tag.render(oe||(oe=ae`
			...
			`),F.Loc.getMessage("TEXT_EDITOR_IMAGE_URL"),this.getUrlTextBox(),babelHelpers.classPrivateFieldLooseBase(this,ba)[ba].bind(this),babelHelpers.classPrivateFieldLooseBase(this,pa)[pa].bind(this))))}getUrlTextBox(){return babelHelpers.classPrivateFieldLooseBase(this,ha)[ha].remember("url-textbox",(()=>F.Tag.render(la||(la=aa`
				<input 
					type="text"
			...
			`),F.Loc.getMessage("TEXT_EDITOR_VIDEO_INSERT_TITLE"),this.getUrlTextBox(),babelHelpers.classPrivateFieldLooseBase(this,Wl)[Wl].bind(this),babelHelpers.classPrivateFieldLooseBase(this,Xl)[Xl].bind(this),this.getStatusContainer())))}getUrlTextBox(){return babelHelpers.classPrivateFieldLooseBase(this,Ul)[Ul].remember("url-textbox",(()=>F.Tag.render(Al||(Al=xl`
				<input 
					type="text"
					class="ui-ctl-element"
					placeholder="https://"
			...
			`),F.Loc.getMessage("TEXT_EDITOR_LINK_URL"),this.getLinkTextBox(),babelHelpers.classPrivateFieldLooseBase(this,$d)[$d].bind(this),babelHelpers.classPrivateFieldLooseBase(this,jd)[jd].bind(this),this.getLinkLabel(),babelHelpers.classPrivateFieldLooseBase(this,kd)[kd].bind(this),babelHelpers.classPrivateFieldLooseBase(this,Ud)[Ud].bind(this))))}getLinkTextBox(){return babelHelpers.classPrivateFieldLooseBase(this,Ad)[Ad].remember("link-textbox",(()=>F.Tag.render(Md||(Md=Nd`
				<input 
					type="text"
					class="ui-ctl-element"
					placeholder="https://"
				...
				>
			`),this.getLinkUrl(),babelHelpers.classPrivateFieldLooseBase(this,Kd)[Kd].bind(this))))}getLinkLabel(){return babelHelpers.classPrivateFieldLooseBase(this,Ad)[Ad].remember("link-label",(()=>F.Tag.render(Dd||(Dd=Nd`
				<a href="" target="_blank" class="ui-text-editor-link-label"></a>
			`))))}}function Yd(){const e=this.getLinkTextBox().value.trim();if(e.length>0){this.setLinkUrl(e);this.emit("onSave")}else{this.getLinkTextBox().focus()}}function zd(e){if(e.key==="Enter"){e.preventDefault();babelHelpers.classPrivateFieldLooseBase(this,$d)[$d]()}}function Xd(){this.emit("onCancel")}function Gd(){this.setEditMode(true);this.getLinkTextBox().focus();this.getLinkTextBox().select()}function Vd(){this.emit("onUnlink")}class Jd extends P.LinkNode{constructor(e="",t={},s=null){super(e,t,s)}static getType(){return"custom-link"}static clone(e){return new Jd(e.__url,{rel:e.__rel,target:e.__target,title:e.__title},e.__key)}static importJSON(e){return super.importJSON(e)}exportJSON(){return{...super.exportJSON(),type:"custom-link",version:1}}createDOM(e){const t=super.createDOM(e);t.setAttribute("data-slider-ignore-autobinding","true");return t}}function qd(e="",t={}){return L.$applyNodeReplacement(new Jd(e,t))}function Qd(e,t=true){if(t){return/^(http:|https:|mailto:|tel:|sms:|\/)/i.test(e)}return/^(http:|https:|mailto:|tel:|sms:)/i.test(e)}const Zd=L.createCommand("INSERT_LINK_DIALOG_COMMAND");var ec=babelHelpers.classPrivateFieldLooseKey("linkEditor");var tc=babelHelpers.classPrivateFieldLooseKey("onEditorScroll");var sc=babelHelpers.classPrivateFieldLooseKey("lastSelection");var ic=babelHelpers.classPrivateFieldLooseKey("exportBBCode");var rc=babelHelpers.classPrivateFieldLooseKey("registerListeners");var ac=babelHelpers.classPrivateFieldLooseKey("registerCommands");var oc=babelHelpers.classPrivateFieldLooseKey("registerToggleLinkCommand");var lc=babelHelpers.classPrivateFieldLooseKey("registerInsertLinkCommand");var nc=babelHelpers.classPrivateFieldLooseKey("restoreSelection");var dc=babelHelpers.classPrivateFieldLooseKey("handleDialogDestroy");var cc=babelHelpers.classPrivateFieldLooseKey("handleEditorScroll");var hc=babelHelpers.classPrivateFieldLooseKey("registerKeyModifierCommand");var bc=babelHelpers.classPrivateFieldLooseKey("registerPasteCommand");var uc=babelHelpers.classPrivateFieldLooseKey("insertLink");var pc=babelHelpers.classPrivateFieldLooseKey("isLinkSelected");var gc=babelHelpers.classPrivateFieldLooseKey("convertAutoLinkToLink");var vc=babelHelpers.classPrivateFieldLooseKey("registerComponents");class fc extends ie{constructor(e){super(e);Object.defineProperty(this,vc,{value:_c});Object.defineProperty(this,gc,{value:Nc});Object.defineProperty(this,pc,{value:Ec});Object.defineProperty(this,uc,{value:Tc});Object.defineProperty(this,bc,{value:Oc});Object.defineProperty(this,hc,{value:Cc});Object.defineProperty(this,cc,{value:Bc});Object.defineProperty(this,dc,{value:Hc});Object.defineProperty(this,nc,{value:Fc});Object.defineProperty(this,lc,{value:yc});Object.defineProperty(this,oc,{value:Lc});Object.defineProperty(this,ac,{value:mc});Object.defineProperty(this,rc,{value:Pc});Object.defineProperty(this,ec,{writable:true,value:null});Object.defineProperty(this,tc,{writable:true,value:babelHelpers.classPrivateFieldLooseBase(this,cc)[cc].bind(this)});Object.defineProperty(this,sc,{writable:true,value:null});Object.defineProperty(this,ic,{writable:true,value:e=>{const t=e.getURL();const s=e.getChildren();const i=s.length===1&&L.$isTextNode(s[0])&&s[0].getFormat()===0;const r=this.getEditor().getBBCodeScheme();if(i&&s[0].getTextContent()===t){return{node:r.createElement({name:"url"})}}return{node:r.createElement({name:"url",value:t})}}});babelHelpers.classPrivateFieldLooseBase(this,ac)[ac]();babelHelpers.classPrivateFieldLooseBase(this,rc)[rc]();babelHelpers.classPrivateFieldLooseBase(this,vc)[vc]()}static getName(){return"Link"}static getNodes(e){return[P.LinkNode,Jd,{replace:P.LinkNode,with:e=>qd(e.__url,{rel:e.__rel,target:e.__target,title:e.__title}),withClass:Jd}]}importBBCode(){return{url:()=>({conversion:e=>{let t=e.getValue();if(!Qd(t)){t=e.toPlainText();if(!Qd(t)){return{node:null}}}return{node:P.$createLinkNode(ra(t),{target:"_blank"})}},priority:0})}}exportBBCode(){return{link:babelHelpers.classPrivateFieldLooseBase(this,ic)[ic],"custom-link":babelHelpers.classPrivateFieldLooseBase(this,ic)[ic]}}validateScheme(){return{nodes:[{nodeClass:Jd}],bbcodeMap:{link:"url","custom-link":"url"}}}destroy(){super.destroy();if(babelHelpers.classPrivateFieldLooseBase(this,ec)[ec]!==null){babelHelpers.classPrivateFieldLooseBase(this,ec)[ec].destroy()}}}function Pc(){this.cleanUpRegister(this.getEditor().registerEventListener(P.LinkNode,"click",((e,t)=>{const s=L.$getNodeByKey(t);if(P.$isLinkNode(s)){this.getEditor().dispatchCommand(Zd,s)}})))}function mc(){this.cleanUpRegister(babelHelpers.classPrivateFieldLooseBase(this,oc)[oc](),babelHelpers.classPrivateFieldLooseBase(this,lc)[lc](),babelHelpers.classPrivateFieldLooseBase(this,hc)[hc](),babelHelpers.classPrivateFieldLooseBase(this,bc)[bc]())}function Lc(){return this.getEditor().registerCommand(P.TOGGLE_LINK_COMMAND,(e=>{if(e===null){P.$toggleLink(e);return true}const t=L.$getSelection();if(!L.$isRangeSelection(t)){return false}let s=null;let i=null;let r={};if(F.Type.isStringFilled(e)){s=e}else if(F.Type.isPlainObject(e)){const{target:t,rel:a,title:o}=e;r={rel:a,target:t,title:o};s=e.url;i=e.originalUrl||null}if(F.Type.isStringFilled(s)){if(!F.Type.isStringFilled(r.target)){r.target="_blank"}if(Qd(s)){if(t.isCollapsed()&&!babelHelpers.classPrivateFieldLooseBase(this,pc)[pc](t)){babelHelpers.classPrivateFieldLooseBase(this,uc)[uc](t,s,r,i)}else{P.$toggleLink(s,r)}return true}return false}return false}),L.COMMAND_PRIORITY_LOW)}function yc(){return y.mergeRegister(this.getEditor().registerCommand(Zd,(e=>{const t=L.$getSelection();if(!L.$isRangeSelection(t)||!this.getEditor().isEditable()){return false}babelHelpers.classPrivateFieldLooseBase(this,sc)[sc]=t.clone();if(babelHelpers.classPrivateFieldLooseBase(this,ec)[ec]!==null){babelHelpers.classPrivateFieldLooseBase(this,ec)[ec].destroy()}let s=null;let i=null;if(P.$isLinkNode(e)){s=e;i=s.getURL()}else{const e=y.$findMatchingParent(t.anchor.getNode(),(e=>(e.__flags&E)!==0));if(e){return false}const r=w(t);const a=y.$findMatchingParent(r,P.$isLinkNode);if(a){s=a;i=s.getURL();s.select()}else if(P.$isLinkNode(r)){s=r;i=s.getURL();s.select()}}this.getEditor().dispatchCommand(H);babelHelpers.classPrivateFieldLooseBase(this,ec)[ec]=new Wd({linkUrl:i,autoLinkMode:P.$isAutoLinkNode(s),targetContainer:document.body,events:{onSave:e=>{const t=e.getTarget();let i=t.getLinkUrl();if(!F.Type.isStringFilled(i)){t.hide();return}const r=F.Validation.isEmail(i)?"mailto:":"https://";const a=i;if(!Qd(i)){i=`${r}${i}`;t.setLinkUrl(i)}if(s===null){this.getEditor().update((()=>{babelHelpers.classPrivateFieldLooseBase(this,nc)[nc]();this.getEditor().dispatchCommand(P.TOGGLE_LINK_COMMAND,{url:i,originalUrl:a,rel:null});t.setEditMode(false);const e=L.$getSelection();if(L.$isRangeSelection(e)){babelHelpers.classPrivateFieldLooseBase(this,sc)[sc]=e.clone()}if(!L.$isRangeSelection(e)||e.isCollapsed()){t.hide()}babelHelpers.classPrivateFieldLooseBase(this,gc)[gc](e)}))}else{this.getEditor().update((()=>{s.setURL(i);babelHelpers.classPrivateFieldLooseBase(this,gc)[gc](L.$getSelection());t.setAutoLinkMode(false)}));t.setEditMode(false)}this.getEditor().resetHighlightSelection()},onCancel:e=>{const t=e.getTarget();t.hide()},onUnlink:e=>{if(s===null){this.getEditor().dispatchCommand(P.TOGGLE_LINK_COMMAND,null)}else{this.getEditor().update((()=>{const e=s.getChildren();for(const t of e){s.insertBefore(t)}s.remove()}))}const t=e.getTarget();t.hide()},onShow:()=>{if(ea(babelHelpers.classPrivateFieldLooseBase(this,ec)[ec].getPopup(),this.getEditor())){F.Event.bind(this.getEditor().getScrollerContainer(),"scroll",babelHelpers.classPrivateFieldLooseBase(this,tc)[tc]);this.getEditor().highlightSelection()}},onClose:()=>{babelHelpers.classPrivateFieldLooseBase(this,dc)[dc]()},onDestroy:()=>{babelHelpers.classPrivateFieldLooseBase(this,dc)[dc]()}}});babelHelpers.classPrivateFieldLooseBase(this,ec)[ec].show();return true}),L.COMMAND_PRIORITY_LOW),this.getEditor().registerCommand(H,(()=>{if(babelHelpers.classPrivateFieldLooseBase(this,ec)[ec]!==null){babelHelpers.classPrivateFieldLooseBase(this,ec)[ec].destroy()}return false}),L.COMMAND_PRIORITY_LOW),this.getEditor().registerCommand(B,(()=>babelHelpers.classPrivateFieldLooseBase(this,ec)[ec]!==null&&babelHelpers.classPrivateFieldLooseBase(this,ec)[ec].isShown()),L.COMMAND_PRIORITY_LOW))}function Fc(){const e=L.$getSelection();if(!L.$isRangeSelection(e)&&babelHelpers.classPrivateFieldLooseBase(this,sc)[sc]!==null){L.$setSelection(babelHelpers.classPrivateFieldLooseBase(this,sc)[sc]);babelHelpers.classPrivateFieldLooseBase(this,sc)[sc]=null;return true}return false}function Hc(){babelHelpers.classPrivateFieldLooseBase(this,ec)[ec]=null;F.Event.unbind(this.getEditor().getScrollerContainer(),"scroll",babelHelpers.classPrivateFieldLooseBase(this,tc)[tc]);this.getEditor().resetHighlightSelection();this.getEditor().update((()=>{if(!babelHelpers.classPrivateFieldLooseBase(this,nc)[nc]()){this.getEditor().focus()}}))}function Bc(){this.getEditor().update((()=>{ea(babelHelpers.classPrivateFieldLooseBase(this,ec)[ec].getPopup(),this.getEditor())}))}function Cc(){return this.getEditor().registerCommand(L.KEY_MODIFIER_COMMAND,(e=>{const t=e;const{code:s,ctrlKey:i,metaKey:r}=t;if(s==="KeyK"&&(i||r)){t.preventDefault();this.getEditor().dispatchCommand(Zd);return true}return false}),L.COMMAND_PRIORITY_NORMAL)}function Oc(){return this.getEditor().registerCommand(L.PASTE_COMMAND,(e=>{const t=L.$getSelection();if(!L.$isRangeSelection(t)||t.isCollapsed()||!(e instanceof ClipboardEvent)||e.clipboardData===null){return false}const s=e.clipboardData.getData("text");if(!Qd(s,false)){return false}if(!t.getNodes().some((e=>L.$isElementNode(e)))){P.$toggleLink(s);e.preventDefault();return true}return false}),L.COMMAND_PRIORITY_NORMAL)}function Tc(e,t,s,i){const r=ra(t);const a=P.$createLinkNode(r,s);a.append(L.$createTextNode(F.Type.isStringFilled(i)?i:r));const o=e.anchor;if(o.type==="text"&&o.getNode().isSimpleText()){const e=o.getNode();const t=o.offset;const s=e.splitText(t);if(t===0){s[0].insertBefore(a);a.select()}else{s[0].insertAfter(a);a.select()}}else{L.$insertNodes([a]);if(L.$isRootOrShadowRoot(a.getParentOrThrow())){y.$wrapNodeInElement(a,L.$createParagraphNode).selectEnd()}}}function Ec(e){const t=w(e);const s=t.getParent();return P.$isLinkNode(s)||P.$isLinkNode(t)}function Nc(e){if(L.$isRangeSelection(e)){const t=w(e).getParent();if(P.$isAutoLinkNode(t)){const e=P.$createLinkNode(t.getURL(),{rel:t.getRel(),target:F.Type.isStringFilled(t.getTarget())?t.getTarget():"_blank",title:t.getTitle()});t.replace(e,true);return true}}return false}function _c(){this.getEditor().getComponentRegistry().register("link",(()=>{const e=new ge;e.setContent('<span class="ui-icon-set --link-3"></span>');e.setTooltip(F.Loc.getMessage("TEXT_EDITOR_BTN_LINK"));e.setBlockType("link");e.disableInsideUnformatted();e.setTooltip(F.Loc.getMessage("TEXT_EDITOR_BTN_LINK",{"#keystroke#":F.Browser.isMac()?"\u2318K":"Ctrl+K"}));e.subscribe("onClick",(()=>{if(babelHelpers.classPrivateFieldLooseBase(this,ec)[ec]!==null&&babelHelpers.classPrivateFieldLooseBase(this,ec)[ec].isShown()){return}this.getEditor().focus((()=>{this.getEditor().dispatchCommand(Zd)}))}));return e}))}var Mc=Object.freeze({INSERT_LINK_DIALOG_COMMAND:Zd,LinkPlugin:fc});class Dc extends P.AutoLinkNode{constructor(e="",t={},s=null){super(e,t,s)}static getType(){return"custom-autolink"}static clone(e){return new Dc(e.__url,{isUnlinked:e.__isUnlinked,rel:e.__rel,target:e.__target,title:e.__title},e.__key)}static importJSON(e){return super.importJSON(e)}exportJSON(){return{...super.exportJSON(),type:"custom-autolink",version:1}}createDOM(e){const t=super.createDOM(e);t.setAttribute("data-slider-ignore-autobinding","true");return t}}function Sc(e="",t={}){return L.$applyNodeReplacement(new Dc(e,t))}const Rc=/((https?:\/\/(www\.)?)|(www\.))[\w#%+.:=@~-]{1,256}\.[\d()A-Za-z]{1,6}\b([\w#%&()+./:=?@[\]~-]*)(?<![%()+.:\]-])/;const Ic=/(([^\s"(),.:;<>@[\\\]]+(\.[^\s"(),.:;<>@[\\\]]+)*)|(".+"))@((\[(?:\d{1,3}\.){3}\d{1,3}])|(([\dA-Za-z-]+\.)+[A-Za-z]{2,}))/;const xc=[Kc(Rc,(e=>e.startsWith("http")?e:`https://${e}`)),Kc(Ic,(e=>`mailto:${e}`))];var wc=babelHelpers.classPrivateFieldLooseKey("registerListeners");class Ac extends ie{constructor(e){super(e);Object.defineProperty(this,wc,{value:$c});babelHelpers.classPrivateFieldLooseBase(this,wc)[wc]()}static getName(){return"AutoLink"}static getNodes(e){return[P.AutoLinkNode,Dc,{replace:P.AutoLinkNode,with:e=>Sc(e.__url,{isUnlinked:e.__isUnlinked,rel:e.__rel,target:e.__target,title:e.__title}),withClass:Dc}]}exportBBCode(){return{autolink:()=>{const e=this.getEditor().getBBCodeScheme();return{node:e.createElement({name:"url"})}},"custom-autolink":()=>{const e=this.getEditor().getBBCodeScheme();return{node:e.createElement({name:"url"})}}}}validateScheme(){return{nodes:[{nodeClass:Dc}],bbcodeMap:{autolink:"url","custom-autolink":"url"}}}}function $c(){const e=(e,t)=>{};this.cleanUpRegister(this.getEditor().registerNodeTransform(L.TextNode,(t=>{const s=t.getParentOrThrow();const i=t.getPreviousSibling();if(P.$isAutoLinkNode(s)){qc(s,xc,e)}else if(!P.$isLinkNode(s)){if(t.isSimpleText()&&(Yc(t.getTextContent())||!P.$isAutoLinkNode(i))){Jc(t,xc,e)}Qc(t,xc,e)}})))}function Kc(e,t=e=>e){return s=>{const i=e.exec(s);if(i===null){return null}return{index:i.index,length:i[0].length,text:i[0],url:t(s)}}}function jc(e,t){for(const s of t){const t=s(e);if(t){return t}}return null}const kc=/[\s(),.;[\]]/;function Uc(e){return kc.test(e)}function Wc(e){return Uc(e[e.length-1])}function Yc(e){return Uc(e[0])}function zc(e){return/^\.[\dA-Za-z]+/.test(e)}function Xc(e){let t=e.getPreviousSibling();if(L.$isElementNode(t)){t=t.getLastDescendant()}return t===null||L.$isLineBreakNode(t)||L.$isTextNode(t)&&Wc(t.getTextContent())}function Gc(e){let t=e.getNextSibling();if(L.$isElementNode(t)){t=t.getFirstDescendant()}return t===null||L.$isLineBreakNode(t)||L.$isTextNode(t)&&Yc(t.getTextContent())}function Vc(e,t,s,i){const r=e>0?Uc(s[e-1]):Xc(i);if(!r){return false}return t<s.length?Uc(s[t]):Gc(i)}function Jc(e,t,s){const i=e.getTextContent();let r=i;let a=0;let o=e;let l=jc(r,t);while(l!==null){const n=l.index;const d=l.length;const c=n+d;const h=Vc(a+n,a+c,i,e);if(h){let e=null;if(a+n===0){[e,o]=o.splitText(a+d)}else{[,e,o]=o.splitText(a+n,a+n+d)}const t=F.Type.isPlainObject(l.attributes)?{...l.attributes}:{};if(!F.Type.isStringFilled(t.target)){t.target="_blank"}const i=P.$createAutoLinkNode(l.url,t);const r=L.$createTextNode(l.text);r.setFormat(e.getFormat());r.setDetail(e.getDetail());i.append(r);e.replace(i);s(l.url,null);a=0}else{a+=c}r=r.slice(Math.max(0,c));l=jc(r,t)}}function qc(e,t,s){const i=e.getChildren();const r=i.length;for(let t=0;t<r;t++){const r=i[t];if(!L.$isTextNode(r)||!r.isSimpleText()){Zc(e);s(null,e.getURL());return}}const a=e.getTextContent();const o=jc(a,t);if(o===null||o.text!==a){Zc(e);s(null,e.getURL());return}if(!Xc(e)||!Gc(e)){Zc(e);s(null,e.getURL());return}const l=e.getURL();if(l!==o.url){e.setURL(o.url);s(o.url,l)}if(o.attributes){const t=e.getRel();if(t!==o.attributes.rel){e.setRel(o.attributes.rel||null);s(o.attributes.rel||null,t)}const i=e.getTarget();if(i!==o.attributes.target){e.setTarget(o.attributes.target||null);s(o.attributes.target||null,i)}}}function Qc(e,t,s){const i=e.getPreviousSibling();const r=e.getNextSibling();const a=e.getTextContent();if(P.$isAutoLinkNode(i)&&(!Yc(a)||zc(a))){i.append(e);qc(i,t,s);s(null,i.getURL())}if(P.$isAutoLinkNode(r)&&!Wc(a)){Zc(r);qc(r,t,s);s(null,r.getURL())}}function Zc(e){const t=e.getChildren();const s=t.length;for(let i=s-1;i>=0;i--){e.insertAfter(t[i])}e.remove();return t.map((e=>e.getLatest()))}var eh=Object.freeze({AutoLinkPlugin:Ac});var th=babelHelpers.classPrivateFieldLooseKey("registerListeners");class sh extends ie{constructor(e){super(e);Object.defineProperty(this,th,{value:ih});babelHelpers.classPrivateFieldLooseBase(this,th)[th]()}static getName(){return"TabIndent"}}function ih(){this.cleanUpRegister(this.getEditor().registerCommand(L.KEY_TAB_COMMAND,(e=>{const t=L.$getSelection();if(!L.$isRangeSelection(t)){return false}return this.getEditor().dispatchCommand(e.shiftKey?L.OUTDENT_CONTENT_COMMAND:L.INDENT_CONTENT_COMMAND,{event:e,triggerByTab:true})}),L.COMMAND_PRIORITY_EDITOR),this.getEditor().registerCommand(L.INDENT_CONTENT_COMMAND,(()=>{const e=L.$getSelection();return!rh(e)}),L.COMMAND_PRIORITY_LOW),this.getEditor().registerCommand(L.OUTDENT_CONTENT_COMMAND,(()=>{const e=L.$getSelection();return!rh(e)}),L.COMMAND_PRIORITY_LOW))}function rh(e){if(!L.$isRangeSelection(e)){return false}const t=e.isBackward();const s=t?e.focus:e.anchor;const i=s.getNode();if(f.$isListItemNode(i)&&s.offset===0){return true}const r=y.$findMatchingParent(i,(e=>L.$isElementNode(e)&&!e.isInline()));return f.$isListItemNode(r)&&s.offset===0}var ah=Object.freeze({TabIndentPlugin:sh});var oh=babelHelpers.classPrivateFieldLooseKey("registerListeners");var lh=babelHelpers.classPrivateFieldLooseKey("registerComponents");var nh=babelHelpers.classPrivateFieldLooseKey("isIndentPermitted");var dh=babelHelpers.classPrivateFieldLooseKey("getElementNodesInSelection");class ch extends ie{constructor(e){super(e);Object.defineProperty(this,dh,{value:ph});Object.defineProperty(this,nh,{value:uh});Object.defineProperty(this,lh,{value:bh});Object.defineProperty(this,oh,{value:hh});babelHelpers.classPrivateFieldLooseBase(this,oh)[oh]();babelHelpers.classPrivateFieldLooseBase(this,lh)[lh]()}static getName(){return"List"}static getNodes(e){return[f.ListNode,f.ListItemNode]}importBBCode(){return{list:()=>({conversion:e=>({node:e.getValue()==="1"?f.$createListNode("number",1):f.$createListNode("bullet")}),priority:0}),"*":()=>({conversion:e=>({node:f.$createListItemNode()}),priority:0})}}exportBBCode(){return{list:e=>{const t=this.getEditor().getBBCodeScheme();const s=t.createElement({name:"list"});if(e.getListType()==="number"){s.setValue("1")}return{node:s}},listitem:e=>{const t=this.getEditor().getBBCodeScheme();return{node:t.createElement({name:"*"})}}}}validateScheme(){return{nodes:[{nodeClass:f.ListNode}],bbcodeMap:{list:"list",listitem:"*"}}}}function hh(){this.cleanUpRegister(this.getEditor().registerCommand(f.INSERT_ORDERED_LIST_COMMAND,(()=>{f.insertList(this.getLexicalEditor(),"number");return true}),L.COMMAND_PRIORITY_LOW),this.getEditor().registerCommand(f.INSERT_UNORDERED_LIST_COMMAND,(()=>{f.insertList(this.getLexicalEditor(),"bullet");return true}),L.COMMAND_PRIORITY_LOW),this.getEditor().registerCommand(f.REMOVE_LIST_COMMAND,(()=>{f.removeList(this.getLexicalEditor());return true}),L.COMMAND_PRIORITY_LOW),this.getEditor().registerCommand(L.INSERT_PARAGRAPH_COMMAND,(()=>f.$handleListInsertParagraph()),L.COMMAND_PRIORITY_LOW),this.getEditor().registerCommand(L.INDENT_CONTENT_COMMAND,(()=>!babelHelpers.classPrivateFieldLooseBase(this,nh)[nh](1)),L.COMMAND_PRIORITY_CRITICAL))}function bh(){this.getEditor().getComponentRegistry().register("bulleted-list",(()=>{const e=new ge;e.setContent('<span class="ui-icon-set --bulleted-list"></span>');e.setBlockType("bullet");e.setTooltip(F.Loc.getMessage("TEXT_EDITOR_BTN_BULLETED_LIST"));e.subscribe("onClick",(()=>{this.getEditor().focus();this.getEditor().update((()=>{if(e.isActive()){this.getEditor().dispatchCommand(f.REMOVE_LIST_COMMAND)}else{this.getEditor().dispatchCommand(f.INSERT_UNORDERED_LIST_COMMAND)}}))}));return e}));this.getEditor().getComponentRegistry().register("numbered-list",(()=>{const e=new ge;e.setContent('<span class="ui-icon-set --numbered-list"></span>');e.setTooltip(F.Loc.getMessage("TEXT_EDITOR_BTN_NUMBERED_LIST"));e.setBlockType("number");e.subscribe("onClick",(()=>{this.getEditor().focus();this.getEditor().update((()=>{if(e.isActive()){this.getEditor().dispatchCommand(f.REMOVE_LIST_COMMAND)}else{this.getEditor().dispatchCommand(f.INSERT_ORDERED_LIST_COMMAND)}}))}));return e}))}function uh(e){const t=L.$getSelection();if(!L.$isRangeSelection(t)){return false}const s=babelHelpers.classPrivateFieldLooseBase(this,dh)[dh](t);let i=0;for(const e of s){if(f.$isListNode(e)){i=Math.max(f.$getListDepth(e)+1,i)}else if(f.$isListItemNode(e)){const t=e.getParent();if(!f.$isListNode(t)){throw new Error("TextEditor: A ListItemNode must have a ListNode for a parent.")}i=Math.max(f.$getListDepth(t)+1,i)}}return i<=e}function ph(e){const t=e.getNodes();const s=e=>L.$isElementNode(e)&&!e.isInline();if(t.length===0){return new Set([y.$findMatchingParent(e.anchor.getNode(),s),y.$findMatchingParent(e.focus.getNode(),s)])}return new Set(t.map((e=>L.$isElementNode(e)?e:y.$findMatchingParent(e,s))))}var gh=Object.freeze({ListPlugin:ch});let vh=e=>e,fh,Ph,mh,Lh;var yh=babelHelpers.classPrivateFieldLooseKey("popup");var Fh=babelHelpers.classPrivateFieldLooseKey("targetNode");var Hh=babelHelpers.classPrivateFieldLooseKey("refs");var Bh=babelHelpers.classPrivateFieldLooseKey("lastSelectedBox");var Ch=babelHelpers.classPrivateFieldLooseKey("handleMouseMove");var Oh=babelHelpers.classPrivateFieldLooseKey("handleClick");var Th=babelHelpers.classPrivateFieldLooseKey("highlightBoxes");class Eh extends b.EventEmitter{constructor(e){super();Object.defineProperty(this,Th,{value:Mh});Object.defineProperty(this,Oh,{value:_h});Object.defineProperty(this,Ch,{value:Nh});Object.defineProperty(this,yh,{writable:true,value:null});Object.defineProperty(this,Fh,{writable:true,value:null});Object.defineProperty(this,Hh,{writable:true,value:new g.MemoryCache});Object.defineProperty(this,Bh,{writable:true,value:null});this.setEventNamespace("BX.UI.TextEditor.TableDialog");const t=F.Type.isPlainObject(e)?e:{};this.setTargetNode(t.targetNode);this.subscribeFromOptions(t.events)}show(){this.getPopup().adjustPosition({forceBindPosition:true});this.getPopup().show()}hide(){this.getPopup().close()}isShown(){return babelHelpers.classPrivateFieldLooseBase(this,yh)[yh]!==null&&babelHelpers.classPrivateFieldLooseBase(this,yh)[yh].isShown()}destroy(){this.getPopup().destroy()}setTargetNode(e){if(F.Type.isElementNode(e)){babelHelpers.classPrivateFieldLooseBase(this,Fh)[Fh]=e}}getTargetNode(){return babelHelpers.classPrivateFieldLooseBase(this,Fh)[Fh]}getPopup(){if(babelHelpers.classPrivateFieldLooseBase(this,yh)[yh]===null){const e=this.getTargetNode();const t=e.getBoundingClientRect();const s=t.width;babelHelpers.classPrivateFieldLooseBase(this,yh)[yh]=new p.Popup({autoHide:true,closeByEsc:true,padding:0,content:F.Tag.render(fh||(fh=vh`
					<div class="ui-text-editor-table-dialog" onclick="${0}">
						${0}
						${0}
					</div>
				`),babelHelpers.classPrivateFieldLooseBase(this,Oh)[Oh].bind(this),this.getGridContainer(),this.getCaptionContainer()),bindElement:this.getTargetNode(),events:{onClose:()=>{this.emit("onClose")},onDestroy:()=>{this.emit("onDestroy")},onShow:e=>{const t=e.getTarget();const i=t.getPopupContainer().offsetWidth;const r=s/2-i/2;const a=p.Popup.getOption("angleLeftOffset")-p.Popup.getOption("angleMinTop");t.setAngle({offset:i/2-a});t.setOffset({offsetLeft:r+p.Popup.getOption("angleLeftOffset")});babelHelpers.classPrivateFieldLooseBase(this,Bh)[Bh]=null;babelHelpers.classPrivateFieldLooseBase(this,Th)[Th](1,1)}}})}return babelHelpers.classPrivateFieldLooseBase(this,yh)[yh]}getGridContainer(){return babelHelpers.classPrivateFieldLooseBase(this,Hh)[Hh].remember("grid",(()=>{const e=[];for(let t=0;t<100;t++){const s=Math.floor(t/10);const i=t%10;e.push(F.Tag.render(Ph||(Ph=vh`
					<button
						class="ui-text-editor-table-dialog-box"
						data-column="${0}"
						data-row="${0}"
					></button>
				`),i+1,s+1))}return F.Tag.render(mh||(mh=vh`
				<div 
					class="ui-text-editor-table-dialog-grid" 
					onmousemove="${0}"
				>${0}</div>
			`),babelHelpers.classPrivateFieldLooseBase(this,Ch)[Ch].bind(this),e)}))}getCaptionContainer(){return babelHelpers.classPrivateFieldLooseBase(this,Hh)[Hh].remember("caption",(()=>F.Tag.render(Lh||(Lh=vh`<div class="ui-text-editor-table-dialog-caption"></div>`))))}}function Nh(e){if(babelHelpers.classPrivateFieldLooseBase(this,Bh)[Bh]!==e.target&&F.Dom.hasClass(e.target,"ui-text-editor-table-dialog-box")){const{row:t,column:s}=e.target.dataset;babelHelpers.classPrivateFieldLooseBase(this,Th)[Th](t,s);babelHelpers.classPrivateFieldLooseBase(this,Bh)[Bh]=e.target}}function _h(e){if(babelHelpers.classPrivateFieldLooseBase(this,Bh)[Bh]){const{row:e,column:t}=babelHelpers.classPrivateFieldLooseBase(this,Bh)[Bh].dataset;this.emit("onSelect",{rows:e,columns:t})}}function Mh(e,t){let s=0;for(const i of this.getGridContainer().children){const r=Math.floor(s/10);const a=s%10;const o=r<e&&a<t;if(o){F.Dom.addClass(i,"--selected")}else{F.Dom.removeClass(i,"--selected")}s++}this.getCaptionContainer().textContent=e&&t?`${e} x ${t}`:""}const Dh=L.createCommand("INSERT_TABLE_DIALOG_COMMAND");var Sh=babelHelpers.classPrivateFieldLooseKey("tableDialog");var Rh=babelHelpers.classPrivateFieldLooseKey("registerComponents");var Ih=babelHelpers.classPrivateFieldLooseKey("registerCommands");var xh=babelHelpers.classPrivateFieldLooseKey("registerListeners");class wh extends ie{constructor(e){super(e);Object.defineProperty(this,xh,{value:Kh});Object.defineProperty(this,Ih,{value:$h});Object.defineProperty(this,Rh,{value:Ah});Object.defineProperty(this,Sh,{writable:true,value:null});babelHelpers.classPrivateFieldLooseBase(this,Ih)[Ih]();babelHelpers.classPrivateFieldLooseBase(this,xh)[xh]();babelHelpers.classPrivateFieldLooseBase(this,Rh)[Rh]()}static getName(){return"Table"}static getNodes(e){return[h.TableNode,h.TableCellNode,h.TableRowNode]}importBBCode(){return{table:()=>({conversion:e=>({node:h.$createTableNode()}),priority:0}),tr:()=>({conversion:e=>({node:h.$createTableRowNode()}),priority:0}),td:()=>({conversion:e=>({node:h.$createTableCellNode(),after:e=>U(e)}),priority:0}),th:()=>({conversion:e=>({node:h.$createTableCellNode(h.TableCellHeaderStates.ROW),after:e=>U(e)}),priority:0})}}exportBBCode(){return{table:()=>{const e=this.getEditor().getBBCodeScheme();return{node:e.createElement({name:"table"})}},tablerow:()=>{const e=this.getEditor().getBBCodeScheme();return{node:e.createElement({name:"tr"})}},tablecell:e=>{const t=this.getEditor().getBBCodeScheme();return{node:t.createElement({name:e.hasHeader()?"th":"td"})}}}}validateScheme(){return{nodes:[{nodeClass:h.TableNode,validate:e=>{if(e.getChildrenSize()===0){e.remove();return true}return false}},{nodeClass:h.TableCellNode,validate:e=>{e.getChildren().forEach((e=>{if(k(e)){const t=L.$createParagraphNode();e.replace(t);t.append(e)}}));return false}}],bbcodeMap:{table:"table",tablerow:"tr",tablecell:"td"}}}destroy(){super.destroy();if(babelHelpers.classPrivateFieldLooseBase(this,Sh)[Sh]!==null){babelHelpers.classPrivateFieldLooseBase(this,Sh)[Sh].destroy()}}}function Ah(){this.getEditor().getComponentRegistry().register("table",(()=>{const e=new ge;e.setContent('<span class="ui-icon-set --table-editor"></span>');e.setTooltip(F.Loc.getMessage("TEXT_EDITOR_BTN_TABLE"));e.subscribe("onClick",(()=>{this.getEditor().dispatchCommand(Dh,{targetNode:e.getContainer()})}));return e}))}function $h(){this.cleanUpRegister(this.getEditor().registerCommand(h.INSERT_TABLE_COMMAND,(({columns:e,rows:t})=>{const s=Math.max(1,F.Text.toNumber(t));const i=Math.max(1,F.Text.toNumber(e));const r=h.$createTableNodeWithDimensions(s,i,false);y.$insertNodeToNearestRoot(r);const a=r.getFirstDescendant();if(L.$isTextNode(a)){a.select()}return true}),L.COMMAND_PRIORITY_EDITOR),this.getEditor().registerCommand(Dh,(e=>{if(!F.Type.isPlainObject(e)||!F.Type.isElementNode(e.targetNode)){return false}if(babelHelpers.classPrivateFieldLooseBase(this,Sh)[Sh]!==null){if(babelHelpers.classPrivateFieldLooseBase(this,Sh)[Sh].getTargetNode()===e.targetNode){babelHelpers.classPrivateFieldLooseBase(this,Sh)[Sh].show();return true}babelHelpers.classPrivateFieldLooseBase(this,Sh)[Sh].destroy()}babelHelpers.classPrivateFieldLooseBase(this,Sh)[Sh]=new Eh({targetNode:e.targetNode,events:{onSelect:e=>{this.getEditor().dispatchCommand(h.INSERT_TABLE_COMMAND,e.getData());babelHelpers.classPrivateFieldLooseBase(this,Sh)[Sh].hide()},onDestroy:()=>{babelHelpers.classPrivateFieldLooseBase(this,Sh)[Sh]=null}}});babelHelpers.classPrivateFieldLooseBase(this,Sh)[Sh].show();return true}),L.COMMAND_PRIORITY_LOW),this.getEditor().registerCommand(H,(()=>{if(babelHelpers.classPrivateFieldLooseBase(this,Sh)[Sh]!==null){babelHelpers.classPrivateFieldLooseBase(this,Sh)[Sh].hide()}return false}),L.COMMAND_PRIORITY_LOW),this.getEditor().registerCommand(B,(()=>babelHelpers.classPrivateFieldLooseBase(this,Sh)[Sh]!==null&&babelHelpers.classPrivateFieldLooseBase(this,Sh)[Sh].isShown()),L.COMMAND_PRIORITY_LOW))}function Kh(){const e=new Map;const t=t=>{const s=t.getKey();const i=this.getEditor().getElementByKey(s);if(i&&!e.has(s)){const r=h.applyTableHandlers(t,i,this.getLexicalEditor(),true);e.set(s,r)}};this.cleanUpRegister(this.getEditor().registerMutationListener(h.TableNode,(s=>{for(const[i,r]of s){if(r==="created"){this.getEditor().getEditorState().read((()=>{const e=L.$getNodeByKey(i);if(h.$isTableNode(e)){t(e)}}))}else if(r==="destroyed"){const t=e.get(i);if(t!==undefined){t.removeListeners();e.delete(i)}}}})))}var jh=Object.freeze({INSERT_TABLE_DIALOG_COMMAND:Dh,TablePlugin:wh});class kh extends L.TextNode{static getType(){return"hashtag"}static clone(e){return new kh(e.__text,e.__key)}constructor(e,t){super(e,t)}createDOM(e){var t;const s=super.createDOM(e);if(F.Type.isStringFilled(e==null?void 0:(t=e.theme)==null?void 0:t.hashtag)){F.Dom.addClass(s,e.theme.hashtag)}return s}static importJSON(e){const t=Uh(e.text);t.setFormat(e.format);t.setDetail(e.detail);t.setMode(e.mode);t.setStyle(e.style);return t}exportJSON(){return{...super.exportJSON(),type:"hashtag"}}canInsertTextBefore(){return false}isTextEntity(){return true}}function Uh(e=""){return L.$applyNodeReplacement(new kh(e))}function Wh(e){return e instanceof kh}var Yh=babelHelpers.classPrivateFieldLooseKey("registerListeners");class zh extends ie{constructor(e){super(e);Object.defineProperty(this,Yh,{value:Xh});babelHelpers.classPrivateFieldLooseBase(this,Yh)[Yh]()}static getName(){return"Hashtag"}static getNodes(e){return[kh]}importBBCode(){return null}exportBBCode(){return{hashtag:(e,t)=>{const s=this.getEditor().getBBCodeScheme();return{node:s.createText(e.getTextContent())}}}}validateScheme(){return{bbcodeMap:{hashtag:"#text"}}}}function Xh(){const e=e=>Uh(e.getTextContent());const t=e=>{const t=/(?<=\s+|^)#([^\s,.<>[\]]+)/is.exec(e);if(t===null){return null}const s=t[0].length;const i=t.index;const r=i+s;return{end:r,start:i}};this.cleanUpRegister(...m.registerLexicalTextEntity(this.getLexicalEditor(),t,kh,e))}var Gh=Object.freeze({HashtagNode:kh,$createHashtagNode:Uh,$isHashtagNode:Wh,HashtagPlugin:zh});function Vh(e){if(!F.Type.isStringFilled(e)){return[]}const t=[];const s=e.split(/(\r?\n|\t)/);const i=s.length;for(let e=0;e<i;e++){const i=s[e];if(i==="\n"||i==="\r\n"){t.push(L.$createLineBreakNode())}else if(i==="\t"){t.push(L.$createTabNode())}else{t.push(L.$createTextNode(i))}}return t}let Jh=e=>e,qh;const Qh=L.createCommand("INSERT_COPILOT_DIALOG_COMMAND");const Zh={INIT:"init",LOADING:"loading",LOADED:"loaded"};var eb=babelHelpers.classPrivateFieldLooseKey("copilot");var tb=babelHelpers.classPrivateFieldLooseKey("copilotStatus");var sb=babelHelpers.classPrivateFieldLooseKey("copilotOptions");var ib=babelHelpers.classPrivateFieldLooseKey("targetParagraph");var rb=babelHelpers.classPrivateFieldLooseKey("lastSelection");var ab=babelHelpers.classPrivateFieldLooseKey("onEditorScroll");var ob=babelHelpers.classPrivateFieldLooseKey("triggerBySpace");var lb=babelHelpers.classPrivateFieldLooseKey("registerListeners");var nb=babelHelpers.classPrivateFieldLooseKey("registerParagraphNodeTransform");var db=babelHelpers.classPrivateFieldLooseKey("registerComponents");var cb=babelHelpers.classPrivateFieldLooseKey("show");var hb=babelHelpers.classPrivateFieldLooseKey("hide");var bb=babelHelpers.classPrivateFieldLooseKey("createCopilot");var ub=babelHelpers.classPrivateFieldLooseKey("resetLoader");var pb=babelHelpers.classPrivateFieldLooseKey("adjustDialogPosition");var gb=babelHelpers.classPrivateFieldLooseKey("handleEditorScroll");var vb=babelHelpers.classPrivateFieldLooseKey("restoreSelection");var fb=babelHelpers.classPrivateFieldLooseKey("handleCopilotSave");var Pb=babelHelpers.classPrivateFieldLooseKey("handleCopilotAddBelow");var mb=babelHelpers.classPrivateFieldLooseKey("handleCopilotHide");class Lb extends ie{constructor(e){super(e);Object.defineProperty(this,mb,{value:Sb});Object.defineProperty(this,Pb,{value:Db});Object.defineProperty(this,fb,{value:Mb});Object.defineProperty(this,vb,{value:_b});Object.defineProperty(this,gb,{value:Nb});Object.defineProperty(this,pb,{value:Eb});Object.defineProperty(this,ub,{value:Tb});Object.defineProperty(this,bb,{value:Ob});Object.defineProperty(this,hb,{value:Cb});Object.defineProperty(this,cb,{value:Bb});Object.defineProperty(this,db,{value:Hb});Object.defineProperty(this,nb,{value:Fb});Object.defineProperty(this,lb,{value:yb});Object.defineProperty(this,eb,{writable:true,value:null});Object.defineProperty(this,tb,{writable:true,value:Zh.INIT});Object.defineProperty(this,sb,{writable:true,value:null});Object.defineProperty(this,ib,{writable:true,value:null});Object.defineProperty(this,rb,{writable:true,value:null});Object.defineProperty(this,ab,{writable:true,value:babelHelpers.classPrivateFieldLooseBase(this,gb)[gb].bind(this)});Object.defineProperty(this,ob,{writable:true,value:false});babelHelpers.classPrivateFieldLooseBase(this,sb)[sb]=e.getOption("copilot.copilotOptions");if(F.Type.isPlainObject(babelHelpers.classPrivateFieldLooseBase(this,sb)[sb])){babelHelpers.classPrivateFieldLooseBase(this,lb)[lb]();babelHelpers.classPrivateFieldLooseBase(this,db)[db]()}}static getName(){return"Copilot"}shouldTriggerBySpace(){return babelHelpers.classPrivateFieldLooseBase(this,ob)[ob]}isCopilotLoaded(){return babelHelpers.classPrivateFieldLooseBase(this,tb)[tb]===Zh.LOADED}isCopilotLoading(){return babelHelpers.classPrivateFieldLooseBase(this,tb)[tb]===Zh.LOADING}isCopilotShown(){return babelHelpers.classPrivateFieldLooseBase(this,eb)[eb]!==null&&babelHelpers.classPrivateFieldLooseBase(this,eb)[eb].isShown()}show({onShow:e,onError:t}={}){if(this.isCopilotLoaded()){babelHelpers.classPrivateFieldLooseBase(this,cb)[cb]({onShow:e})}else if(!this.isCopilotLoading()){babelHelpers.classPrivateFieldLooseBase(this,bb)[bb]().then((()=>{babelHelpers.classPrivateFieldLooseBase(this,cb)[cb]({onShow:e})})).catch((()=>{if(F.Type.isFunction(t)){t()}}))}}destroy(){super.destroy();if(babelHelpers.classPrivateFieldLooseBase(this,eb)[eb]!==null){babelHelpers.classPrivateFieldLooseBase(this,eb)[eb].hide();babelHelpers.classPrivateFieldLooseBase(this,eb)[eb]=null}}}function yb(){babelHelpers.classPrivateFieldLooseBase(this,ob)[ob]=this.getEditor().getOption("copilot.triggerBySpace",false);this.cleanUpRegister(this.getEditor().registerCommand(Qh,(e=>{const t=F.Type.isPlainObject(e)?e:{};this.show(t);return true}),L.COMMAND_PRIORITY_EDITOR),this.getEditor().registerCommand(H,(()=>{babelHelpers.classPrivateFieldLooseBase(this,hb)[hb]();return false}),L.COMMAND_PRIORITY_LOW),this.getEditor().registerCommand(B,(()=>this.isCopilotShown()),L.COMMAND_PRIORITY_LOW),babelHelpers.classPrivateFieldLooseBase(this,ob)[ob]?babelHelpers.classPrivateFieldLooseBase(this,nb)[nb]():()=>{})}function Fb(){return this.getEditor().registerNodeTransform(pt,(e=>{if(e.getChildrenSize()!==1||!L.$isRootNode(e.getParent())){return}if(!L.$isTextNode(e.getFirstChild())||e.getFirstChild().getTextContent()!==" "){babelHelpers.classPrivateFieldLooseBase(this,ub)[ub]();return}const t=L.$getSelection();if(!L.$isRangeSelection(t)||!t.isCollapsed()){return}const s=t.anchor.getNode();if(s!==e.getFirstChild()){return}if(!this.isCopilotLoaded()&&!this.isCopilotLoading()){babelHelpers.classPrivateFieldLooseBase(this,ub)[ub]();babelHelpers.classPrivateFieldLooseBase(this,ib)[ib]=this.getEditor().getElementByKey(e.getKey());if(babelHelpers.classPrivateFieldLooseBase(this,ib)[ib]){F.Dom.addClass(babelHelpers.classPrivateFieldLooseBase(this,ib)[ib],"ui-text-editor-loading-ellipsis")}}e.getFirstChild().remove();e.select();this.show({onShow:()=>babelHelpers.classPrivateFieldLooseBase(this,ub)[ub](),onError:()=>babelHelpers.classPrivateFieldLooseBase(this,ub)[ub]()})}))}function Hb(){this.getEditor().getComponentRegistry().register("copilot",(()=>{const e=new ge;const t="--copilot-ai";const s="--refresh-5 ui-text-editor-copilot-loading";const i=F.Tag.render(qh||(qh=Jh`
				<span class="ui-icon-set ${0}" style="--ui-icon-set__icon-color: #8e52ec"></span>
			`),t);e.setContent(i);e.setTooltip(F.Loc.getMessage("TEXT_EDITOR_BTN_COPILOT"));e.subscribe("onClick",(()=>{this.getEditor().focus();if(this.isCopilotLoading()){return}const e=()=>{if(!F.Dom.hasClass(i,t)){F.Dom.removeClass(i,s);F.Dom.addClass(i,t)}};this.getEditor().dispatchCommand(Qh,{onShow:e,onError:e});if(!this.isCopilotLoaded()){setTimeout((()=>{if(!this.isCopilotLoaded()){F.Dom.removeClass(i,t);F.Dom.addClass(i,s)}}),500)}}));return e}))}function Bb({onShow:e}={}){this.getEditor().update((()=>{const t=L.$getSelection();if(!L.$isRangeSelection(t)||!this.getEditor().isEditable()){return}this.getEditor().dispatchCommand(H);const s=t.getTextContent();const i=F.Dom.getPosition(this.getEditor().getScrollerContainer());const r=Math.min(i.width,600);babelHelpers.classPrivateFieldLooseBase(this,rb)[rb]=t.clone();const a=s.trim();if(a.length>0){babelHelpers.classPrivateFieldLooseBase(this,eb)[eb].setSelectedText(a)}else{const e=L.$getRoot().getTextContent().trim();if(e.length>0){babelHelpers.classPrivateFieldLooseBase(this,eb)[eb].setContext(e)}}babelHelpers.classPrivateFieldLooseBase(this,eb)[eb].show({width:r});babelHelpers.classPrivateFieldLooseBase(this,pb)[pb]();F.Event.bind(this.getEditor().getScrollerContainer(),"scroll",babelHelpers.classPrivateFieldLooseBase(this,ab)[ab]);if(!t.isCollapsed()){this.getEditor().highlightSelection()}if(F.Type.isFunction(e)){e()}}))}function Cb(){if(this.isCopilotLoaded()&&babelHelpers.classPrivateFieldLooseBase(this,eb)[eb].isShown()){babelHelpers.classPrivateFieldLooseBase(this,eb)[eb].hide()}}function Ob(){if(this.isDestroyed()){return Promise.reject(new Error("Copilot plugin was destroyed."))}babelHelpers.classPrivateFieldLooseBase(this,tb)[tb]=Zh.LOADING;return new Promise(((e,t)=>{F.Runtime.loadExtension("ai.copilot").then((({Copilot:s,CopilotEvents:i})=>{if(this.isDestroyed()){t(new Error("Copilot plugin was destroyed."));return}babelHelpers.classPrivateFieldLooseBase(this,eb)[eb]=new s({showResultInCopilot:true,...babelHelpers.classPrivateFieldLooseBase(this,sb)[sb],autoHide:true});babelHelpers.classPrivateFieldLooseBase(this,eb)[eb].subscribe(i.FINISH_INIT,(()=>{if(this.isDestroyed()){t(new Error("Copilot plugin was destroyed."));return}babelHelpers.classPrivateFieldLooseBase(this,tb)[tb]=Zh.LOADED;e()}));babelHelpers.classPrivateFieldLooseBase(this,eb)[eb].subscribe(i.TEXT_SAVE,babelHelpers.classPrivateFieldLooseBase(this,fb)[fb].bind(this));babelHelpers.classPrivateFieldLooseBase(this,eb)[eb].subscribe(i.TEXT_PLACE_BELOW,babelHelpers.classPrivateFieldLooseBase(this,Pb)[Pb].bind(this));babelHelpers.classPrivateFieldLooseBase(this,eb)[eb].subscribe(i.HIDE,babelHelpers.classPrivateFieldLooseBase(this,mb)[mb].bind(this));babelHelpers.classPrivateFieldLooseBase(this,eb)[eb].init()})).catch((()=>{t()}))}))}function Tb(){if(babelHelpers.classPrivateFieldLooseBase(this,ib)[ib]){F.Dom.removeClass(babelHelpers.classPrivateFieldLooseBase(this,ib)[ib],"ui-text-editor-loading-ellipsis")}}function Eb(){this.getEditor().update((()=>{babelHelpers.classPrivateFieldLooseBase(this,vb)[vb]();const e=Gr(this.getEditor(),L.$getSelection(),document.body);if(e===null){return}const{top:t,left:s,bottom:i}=e;const r=F.Dom.getPosition(this.getEditor().getScrollerContainer());const a=Math.min(r.width,600);let o=a/2;if(s-o<r.left){const e=r.left-(s-o);o-=e+16}else if(r.right<s+a-o){o+=s+a-o-r.right+16}if(i<r.top||t>r.bottom){babelHelpers.classPrivateFieldLooseBase(this,eb)[eb].adjust({hide:true})}else{babelHelpers.classPrivateFieldLooseBase(this,eb)[eb].adjust({hide:false,position:{left:s-o,top:i}})}}))}function Nb(){babelHelpers.classPrivateFieldLooseBase(this,pb)[pb]()}function _b(){const e=L.$getSelection();if(!L.$isRangeSelection(e)&&babelHelpers.classPrivateFieldLooseBase(this,rb)[rb]!==null){L.$setSelection(babelHelpers.classPrivateFieldLooseBase(this,rb)[rb]);babelHelpers.classPrivateFieldLooseBase(this,rb)[rb]=null;return true}return false}function Mb(e){const{result:t}=e.getData();this.getEditor().update((()=>{babelHelpers.classPrivateFieldLooseBase(this,vb)[vb]();const e=L.$getSelection();if(L.$isRangeSelection(e)){e.insertRawText(t)}babelHelpers.classPrivateFieldLooseBase(this,hb)[hb]()}))}function Db(e){const{result:t}=e.getData();this.getEditor().update((()=>{babelHelpers.classPrivateFieldLooseBase(this,vb)[vb]();const e=L.$getSelection();if(L.$isRangeSelection(e)){const s=e.focus;const i=s.getNode();if(!e.isCollapsed()){i.selectEnd()}const r=i.getParent();if(L.$isParagraphNode(r)){const e=L.$createParagraphNode();e.append(...Vh(t));r.insertAfter(e)}else{e.insertLineBreak();e.insertRawText(t)}}babelHelpers.classPrivateFieldLooseBase(this,hb)[hb]()}))}function Sb(){F.Event.unbind(this.getEditor().getScrollerContainer(),"scroll",babelHelpers.classPrivateFieldLooseBase(this,ab)[ab]);this.getEditor().resetHighlightSelection();this.getEditor().update((()=>{if(!babelHelpers.classPrivateFieldLooseBase(this,vb)[vb]()){this.getEditor().focus()}}))}var Rb=babelHelpers.classPrivateFieldLooseKey("registerComponents");class Ib extends ie{constructor(e){super(e);Object.defineProperty(this,Rb,{value:xb});const t=u.createEmptyHistoryState();this.cleanUpRegister(u.registerHistory(e.getLexicalEditor(),t,1e3));babelHelpers.classPrivateFieldLooseBase(this,Rb)[Rb]()}static getName(){return"History"}}function xb(){let e=false;this.getEditor().getComponentRegistry().register("undo",(()=>{const t=new ge;t.setContent('<span class="ui-icon-set --undo"></span>');t.setDisabled(!e);t.setTooltip(F.Loc.getMessage("TEXT_EDITOR_BTN_UNDO",{"#keystroke#":F.Browser.isMac()?"\u2318Z":"Ctrl+Z"}));t.subscribe("onClick",(()=>{this.getEditor().dispatchCommand(L.UNDO_COMMAND)}));t.setDisableCallback((()=>!e||!this.getEditor().isEditable()));this.getEditor().registerCommand(L.CAN_UNDO_COMMAND,(s=>{e=s;t.setDisabled(!e);return false}),L.COMMAND_PRIORITY_CRITICAL);return t}));let t=false;this.getEditor().getComponentRegistry().register("redo",(()=>{const e=new ge;e.setContent('<span class="ui-icon-set --redo"></span>');e.setDisabled(!t);e.setTooltip(F.Loc.getMessage("TEXT_EDITOR_BTN_REDO",{"#keystroke#":F.Browser.isMac()?"\u2318\u21e7Z":"Ctrl+Y"}));e.subscribe("onClick",(()=>{this.getEditor().dispatchCommand(L.REDO_COMMAND)}));e.setDisableCallback((()=>!t||!this.getEditor().isEditable()));this.getEditor().registerCommand(L.CAN_REDO_COMMAND,(s=>{t=s;e.setDisabled(!t);return false}),L.COMMAND_PRIORITY_CRITICAL);return e}))}var wb=Object.freeze({HistoryPlugin:Ib});let Ab=e=>e,$b,Kb;const jb={DOWNWARD:1,UPWARD:-1,INDETERMINATE:0};const kb="application/x-ui-text-editor-drag-block";var Ub=babelHelpers.classPrivateFieldLooseKey("draggableBlockElement");var Wb=babelHelpers.classPrivateFieldLooseKey("lastBlockElementIndex");var Yb=babelHelpers.classPrivateFieldLooseKey("lastTargetElement");var zb=babelHelpers.classPrivateFieldLooseKey("container");var Xb=babelHelpers.classPrivateFieldLooseKey("dropLine");var Gb=babelHelpers.classPrivateFieldLooseKey("isDragging");var Vb=babelHelpers.classPrivateFieldLooseKey("bodyDragDropHandler");var Jb=babelHelpers.classPrivateFieldLooseKey("bodyDragOverHandler");var qb=babelHelpers.classPrivateFieldLooseKey("registerEvents");var Qb=babelHelpers.classPrivateFieldLooseKey("registerListeners");var Zb=babelHelpers.classPrivateFieldLooseKey("handleMouseMove");var eu=babelHelpers.classPrivateFieldLooseKey("handleMouseLeave");var tu=babelHelpers.classPrivateFieldLooseKey("findBlockElement");var su=babelHelpers.classPrivateFieldLooseKey("getCurrentIndex");var iu=babelHelpers.classPrivateFieldLooseKey("updatePosition");var ru=babelHelpers.classPrivateFieldLooseKey("setDraggableBlockElement");var au=babelHelpers.classPrivateFieldLooseKey("handleDragStart");var ou=babelHelpers.classPrivateFieldLooseKey("handleDragEnd");var lu=babelHelpers.classPrivateFieldLooseKey("handleDragOver");var nu=babelHelpers.classPrivateFieldLooseKey("handleDragDrop");var du=babelHelpers.classPrivateFieldLooseKey("showDropLine");var cu=babelHelpers.classPrivateFieldLooseKey("hideDropLine");class hu extends ie{constructor(e){super(e);Object.defineProperty(this,cu,{value:Cu});Object.defineProperty(this,du,{value:Bu});Object.defineProperty(this,nu,{value:Hu});Object.defineProperty(this,lu,{value:Fu});Object.defineProperty(this,ou,{value:yu});Object.defineProperty(this,au,{value:Lu});Object.defineProperty(this,ru,{value:mu});Object.defineProperty(this,iu,{value:Pu});Object.defineProperty(this,su,{value:fu});Object.defineProperty(this,tu,{value:vu});Object.defineProperty(this,eu,{value:gu});Object.defineProperty(this,Zb,{value:pu});Object.defineProperty(this,Qb,{value:uu});Object.defineProperty(this,qb,{value:bu});Object.defineProperty(this,Ub,{writable:true,value:null});Object.defineProperty(this,Wb,{writable:true,value:Infinity});Object.defineProperty(this,Yb,{writable:true,value:null});Object.defineProperty(this,zb,{writable:true,value:null});Object.defineProperty(this,Xb,{writable:true,value:null});Object.defineProperty(this,Gb,{writable:true,value:false});Object.defineProperty(this,Vb,{writable:true,value:null});Object.defineProperty(this,Jb,{writable:true,value:null});this.cleanUpRegister(babelHelpers.classPrivateFieldLooseBase(this,qb)[qb](),babelHelpers.classPrivateFieldLooseBase(this,Qb)[Qb]());babelHelpers.classPrivateFieldLooseBase(this,Vb)[Vb]=e=>{this.getEditor().dispatchCommand(L.DROP_COMMAND,e)};babelHelpers.classPrivateFieldLooseBase(this,Jb)[Jb]=e=>{e.preventDefault()};F.Dom.append(this.getContainer(),this.getEditor().getScrollerContainer());F.Dom.append(this.getDropLine(),this.getEditor().getScrollerContainer())}static getName(){return"BlockToolbar"}getContainer(){if(babelHelpers.classPrivateFieldLooseBase(this,zb)[zb]===null){babelHelpers.classPrivateFieldLooseBase(this,zb)[zb]=F.Tag.render($b||($b=Ab`
			...
			`),babelHelpers.classPrivateFieldLooseBase(this,au)[au].bind(this),babelHelpers.classPrivateFieldLooseBase(this,ou)[ou].bind(this))}return babelHelpers.classPrivateFieldLooseBase(this,zb)[zb]}getDropLine(){if(babelHelpers.classPrivateFieldLooseBase(this,Xb)[Xb]===null){babelHelpers.classPrivateFieldLooseBase(this,Xb)[Xb]=F.Tag.render(Kb||(Kb=Ab`
				<div class="ui-text-editor-block-drop-line"></div>
			`))}return babelHelpers.classPrivateFieldLooseBase(this,Xb)[Xb]}destroy(){super.destroy();F.Dom.remove(this.getContainer());F.Dom.remove(this.getDropLine())}}function bu(){const e=this.getEditor().getScrollerContainer();const t=babelHelpers.classPrivateFieldLooseBase(this,Zb)[Zb].bind(this);const s=babelHelpers.classPrivateFieldLooseBase(this,eu)[eu].bind(this);F.Event.bind(e,"mousemove",t);F.Event.bind(e,"mouseleave",s);return()=>{F.Event.unbind(e,"mousemove",t);F.Event.unbind(e,"mouseleave",s)}}function uu(){return y.mergeRegister(this.getEditor().registerCommand(L.DRAGOVER_COMMAND,babelHelpers.classPrivateFieldLooseBase(this,lu)[lu].bind(this),L.COMMAND_PRIORITY_LOW),this.getEditor().registerCommand(L.DROP_COMMAND,babelHelpers.classPrivateFieldLooseBase(this,nu)[nu].bind(this),L.COMMAND_PRIORITY_HIGH),this.getEditor().registerTextContentListener((()=>{babelHelpers.classPrivateFieldLooseBase(this,ru)[ru](null);babelHelpers.classPrivateFieldLooseBase(this,iu)[iu]()})))}function pu(e){if(!this.getEditor().isEditable()){return}const t=e.target;if(!(t instanceof HTMLElement)){babelHelpers.classPrivateFieldLooseBase(this,ru)[ru](null);return}if(t.closest(".ui-text-editor-block-toolbar")!==null){return}const s=babelHelpers.classPrivateFieldLooseBase(this,tu)[tu](e);babelHelpers.classPrivateFieldLooseBase(this,ru)[ru](s)}function gu(){babelHelpers.classPrivateFieldLooseBase(this,ru)[ru](null)}function vu(e){const t=this.getEditor().getScrollerContainer();const s=t.getBoundingClientRect();let i=null;this.getEditor().getEditorState().read((()=>{const t=L.$getRoot();const r=t.getChildrenKeys();let a=babelHelpers.classPrivateFieldLooseBase(this,su)[su](r.length);let o=jb.INDETERMINATE;while(a>=0&&a<r.length){const t=r[a];const l=this.getEditor().getElementByKey(t);if(l===null){break}const n=l.getBoundingClientRect();const{marginLeft:d,marginRight:c,marginTop:h,marginBottom:b}=window.getComputedStyle(l);const u=new DOMRect(s.left+parseFloat(d),n.y-parseFloat(h),n.width+parseFloat(c),n.height+parseFloat(b));const{x:p,y:g}=e;const v=g<u.top;const f=g>u.bottom;const P=p<u.left;const m=p>u.right;const L=!v&&!f&&!P&&!m;if(L){i=l;babelHelpers.classPrivateFieldLooseBase(this,Wb)[Wb]=a;break}if(o===jb.INDETERMINATE){if(v){o=jb.UPWARD}else if(f){o=jb.DOWNWARD}else{o=Infinity}}a+=o}}));return i}function fu(e){if(e===0){return Infinity}if(babelHelpers.classPrivateFieldLooseBase(this,Wb)[Wb]>=0&&babelHelpers.classPrivateFieldLooseBase(this,Wb)[Wb]<e){return babelHelpers.classPrivateFieldLooseBase(this,Wb)[Wb]}return Math.floor(e/2)}function Pu(){if(babelHelpers.classPrivateFieldLooseBase(this,Ub)[Ub]===null){F.Dom.style(this.getContainer(),{opacity:0,transform:"translateY(-10000px)"})}else{const e=F.Text.toNumber(F.Dom.style(babelHelpers.classPrivateFieldLooseBase(this,Ub)[Ub],"margin-top"));const t=babelHelpers.classPrivateFieldLooseBase(this,Ub)[Ub].offsetTop+e;F.Dom.style(this.getContainer(),{opacity:1,transform:`translateY(${t}px)`})}}function mu(e){const t=babelHelpers.classPrivateFieldLooseBase(this,Ub)[Ub]!==e;babelHelpers.classPrivateFieldLooseBase(this,Ub)[Ub]=e;if(t){babelHelpers.classPrivateFieldLooseBase(this,iu)[iu]()}}function Lu(e){const t=e.dataTransfer;if(!t||babelHelpers.classPrivateFieldLooseBase(this,Ub)[Ub]===null){return}this.getEditor().dispatchCommand(H);t.setDragImage(babelHelpers.classPrivateFieldLooseBase(this,Ub)[Ub],0,0);let s="";this.getEditor().update((()=>{const e=L.$getNearestNodeFromDOMNode(babelHelpers.classPrivateFieldLooseBase(this,Ub)[Ub]);if(e){s=e.getKey()}}));t.setData(kb,s);babelHelpers.classPrivateFieldLooseBase(this,Gb)[Gb]=true;F.Event.bind(document.body,"drop",babelHelpers.classPrivateFieldLooseBase(this,Vb)[Vb]);F.Event.bind(document.body,"dragover",babelHelpers.classPrivateFieldLooseBase(this,Jb)[Jb])}function yu(e){babelHelpers.classPrivateFieldLooseBase(this,Gb)[Gb]=false;babelHelpers.classPrivateFieldLooseBase(this,cu)[cu]();F.Event.unbind(document.body,"drop",babelHelpers.classPrivateFieldLooseBase(this,Vb)[Vb]);F.Event.unbind(document.body,"dragover",babelHelpers.classPrivateFieldLooseBase(this,Jb)[Jb])}function Fu(e){if(babelHelpers.classPrivateFieldLooseBase(this,Gb)[Gb]===false){return false}const t=e.dataTransfer.types.includes("Files");if(t||!(e.target instanceof HTMLElement)){return false}const s=babelHelpers.classPrivateFieldLooseBase(this,tu)[tu](e);if(s===null){return false}babelHelpers.classPrivateFieldLooseBase(this,Yb)[Yb]=s;babelHelpers.classPrivateFieldLooseBase(this,du)[du](s,e);e.preventDefault();return true}function Hu(e){var t;if(babelHelpers.classPrivateFieldLooseBase(this,Gb)[Gb]===false){return false}const s=e.dataTransfer.types.includes("Files");const i=((t=e.dataTransfer)==null?void 0:t.getData(kb))||"";if(s||!(e.target instanceof HTMLElement)||!F.Type.isStringFilled(i)){return false}const r=L.$getNodeByKey(i);if(!r||!(e.target instanceof HTMLElement)){return false}const a=babelHelpers.classPrivateFieldLooseBase(this,tu)[tu](e)||babelHelpers.classPrivateFieldLooseBase(this,Yb)[Yb];if(!a){return false}const o=L.$getNearestNodeFromDOMNode(a);if(!o){return false}F.Event.unbind(document.body,"drop",babelHelpers.classPrivateFieldLooseBase(this,Vb)[Vb]);F.Event.unbind(document.body,"dragover",babelHelpers.classPrivateFieldLooseBase(this,Jb)[Jb]);if(o===r){return true}const{top:l,height:n}=a.getBoundingClientRect();const d=e.clientY-l>n/2;if(d){o.insertAfter(r)}else{o.insertBefore(r)}babelHelpers.classPrivateFieldLooseBase(this,ru)[ru](null);return true}function Bu(e,t){const{top:s,height:i}=e.getBoundingClientRect();const r=window.getComputedStyle(e);const a=F.Dom.getRelativePosition(e,e.offsetParent);let o=a.top;const l=t.clientY-s>i/2;if(l){o+=i+parseFloat(r.marginBottom)*1.5}else{o+=parseFloat(r.marginTop)/2}const n=2;const d=16;const c=o-n;F.Dom.style(this.getDropLine(),{opacity:.4,left:`${d}px`,right:`${d}px`,transform:`translateY(${c}px)`})}function Cu(){F.Dom.style(this.getDropLine(),{opacity:0,transform:"translate(-10000px, -10000px)"})}var Ou=Object.freeze({BlockToolbarPlugin:hu});let Tu=e=>e,Eu;var Nu=babelHelpers.classPrivateFieldLooseKey("container");class _u extends re{constructor(...e){super(...e);Object.defineProperty(this,Nu,{writable:true,value:null})}getContainer(){if(babelHelpers.classPrivateFieldLooseBase(this,Nu)[Nu]===null){babelHelpers.classPrivateFieldLooseBase(this,Nu)[Nu]=F.Tag.render(Eu||(Eu=Tu`<span class="ui-text-editor-toolbar-separator"></span>`))}return babelHelpers.classPrivateFieldLooseBase(this,Nu)[Nu]}render(){return this.getContainer()}}let Mu=e=>e,Du,Su,Ru;var Iu=babelHelpers.classPrivateFieldLooseKey("textEditor");var xu=babelHelpers.classPrivateFieldLooseKey("items");var wu=babelHelpers.classPrivateFieldLooseKey("rendered");var Au=babelHelpers.classPrivateFieldLooseKey("moreBtn");var $u=babelHelpers.classPrivateFieldLooseKey("refs");var Ku=babelHelpers.classPrivateFieldLooseKey("resizeObserver");var ju=babelHelpers.classPrivateFieldLooseKey("timeoutId");var ku=babelHelpers.classPrivateFieldLooseKey("removeListeners");var Uu=babelHelpers.classPrivateFieldLooseKey("registerListeners");var Wu=babelHelpers.classPrivateFieldLooseKey("fillFromOptions");var Yu=babelHelpers.classPrivateFieldLooseKey("handleResize");var zu=babelHelpers.classPrivateFieldLooseKey("getSelectionBlockTypes");var Xu=babelHelpers.classPrivateFieldLooseKey("getBlockType");class Gu{constructor(e,t){Object.defineProperty(this,Xu,{value:Zu});Object.defineProperty(this,zu,{value:Qu});Object.defineProperty(this,Yu,{value:qu});Object.defineProperty(this,Wu,{value:Ju});Object.defineProperty(this,Uu,{value:Vu});Object.defineProperty(this,Iu,{writable:true,value:null});Object.defineProperty(this,xu,{writable:true,value:[]});Object.defineProperty(this,wu,{writable:true,value:false});Object.defineProperty(this,Au,{writable:true,value:null});Object.defineProperty(this,$u,{writable:true,value:new g.MemoryCache});Object.defineProperty(this,Ku,{writable:true,value:null});Object.defineProperty(this,ju,{writable:true,value:null});Object.defineProperty(this,ku,{writable:true,value:null});babelHelpers.classPrivateFieldLooseBase(this,Iu)[Iu]=e;const s=F.Type.isArray(t)?t:[];babelHelpers.classPrivateFieldLooseBase(this,Wu)[Wu](s);if(babelHelpers.classPrivateFieldLooseBase(this,xu)[xu].length>0){babelHelpers.classPrivateFieldLooseBase(this,ku)[ku]=babelHelpers.classPrivateFieldLooseBase(this,Uu)[Uu]();babelHelpers.classPrivateFieldLooseBase(this,Ku)[Ku]=new ResizeObserver(babelHelpers.classPrivateFieldLooseBase(this,Yu)[Yu].bind(this))}}renderTo(e){if(this.isRendered()){return}if(F.Type.isElementNode(e)){babelHelpers.classPrivateFieldLooseBase(this,xu)[xu].forEach((e=>{F.Dom.append(e.render(),this.getItemsContainer())}));F.Dom.append(this.getContainer(),e);if(babelHelpers.classPrivateFieldLooseBase(this,Ku)[Ku]!==null){babelHelpers.classPrivateFieldLooseBase(this,Ku)[Ku].observe(this.getContainer())}babelHelpers.classPrivateFieldLooseBase(this,wu)[wu]=true}}isEmpty(){return babelHelpers.classPrivateFieldLooseBase(this,xu)[xu].length===0}getContainer(){return babelHelpers.classPrivateFieldLooseBase(this,$u)[$u].remember("container",(()=>F.Tag.render(Du||(Du=Mu`
				<div class="ui-text-editor-toolbar-container">
					${0}
					${0}
				</div>
			`),this.getItemsContainer(),this.getMoreBtnContainer())))}getItemsContainer(){return babelHelpers.classPrivateFieldLooseBase(this,$u)[$u].remember("items-container",(()=>F.Tag.render(Su||(Su=Mu`
				<div class="ui-text-editor-toolbar-items"></div>
			`))))}getMoreBtnContainer(){return babelHelpers.classPrivateFieldLooseBase(this,$u)[$u].remember("more-btn-container",(()=>F.Tag.render(Ru||(Ru=Mu`
				<div class="ui-text-editor-toolbar-more-btn">
				${0}
				</div>
			`),this.getMoreBtn().render())))}getMoreBtn(){if(babelHelpers.classPrivateFieldLooseBase(this,Au)[Au]===null){const e=()=>{F.Event.unbind(this.getItemsContainer(),"transitionend",e);F.Dom.style(this.getItemsContainer(),{height:null});F.Dom.removeClass(this.getItemsContainer(),"--animating")};babelHelpers.classPrivateFieldLooseBase(this,Au)[Au]=new ge;babelHelpers.classPrivateFieldLooseBase(this,Au)[Au].setContent('<span class="ui-text-editor-toolbar-more-btn-icon"></span>');babelHelpers.classPrivateFieldLooseBase(this,Au)[Au].subscribe("onClick",(()=>{F.Event.unbind(this.getItemsContainer(),"transitionend",e);if(F.Dom.hasClass(this.getContainer(),"--expanded")){F.Dom.style(this.getItemsContainer(),{height:`${this.getItemsContainer().scrollHeight}px`});requestAnimationFrame((()=>{F.Dom.removeClass(this.getContainer(),"--expanded");F.Dom.addClass(this.getItemsContainer(),"--animating");F.Dom.style(this.getItemsContainer(),{height:null})}))}else{F.Dom.addClass(this.getItemsContainer(),"--animating");F.Dom.style(this.getItemsContainer(),{height:`${this.getItemsContainer().scrollHeight}px`});F.Dom.addClass(this.getContainer(),"--expanded")}F.Event.bind(this.getItemsContainer(),"transitionend",e)}))}return babelHelpers.classPrivateFieldLooseBase(this,Au)[Au]}getItems(){return babelHelpers.classPrivateFieldLooseBase(this,xu)[xu]}isRendered(){return babelHelpers.classPrivateFieldLooseBase(this,wu)[wu]}destroy(){if(babelHelpers.classPrivateFieldLooseBase(this,ku)[ku]!==null){babelHelpers.classPrivateFieldLooseBase(this,ku)[ku]()}if(babelHelpers.classPrivateFieldLooseBase(this,Ku)[Ku]!==null){babelHelpers.classPrivateFieldLooseBase(this,Ku)[Ku].disconnect();babelHelpers.classPrivateFieldLooseBase(this,Ku)[Ku]=null}if(this.isRendered()){F.Dom.remove(this.getContainer())}if(babelHelpers.classPrivateFieldLooseBase(this,ju)[ju]){clearTimeout(babelHelpers.classPrivateFieldLooseBase(this,ju)[ju])}babelHelpers.classPrivateFieldLooseBase(this,xu)[xu]=null;babelHelpers.classPrivateFieldLooseBase(this,$u)[$u]=null}update(){babelHelpers.classPrivateFieldLooseBase(this,Iu)[Iu].getEditorState().read((()=>{let e=L.$getSelection();if(!L.$isRangeSelection(e)){e=null}let t=null;if(e!==null){t=y.$findMatchingParent(e.anchor.getNode(),(e=>(e.__flags&E)!==0))}const s=e===null?new Set:babelHelpers.classPrivateFieldLooseBase(this,zu)[zu](e);const i=!babelHelpers.classPrivateFieldLooseBase(this,Iu)[Iu].isEditable();babelHelpers.classPrivateFieldLooseBase(this,xu)[xu].forEach((r=>{if(!(r instanceof ge)){return}if(r.hasOwnDisableCallback()){r.setDisabled(r.invokeDisableCallback())}else if(i){r.disable()}else if(t!==null&&r.shouldDisableInsideUnformatted()){r.disable()}else{r.enable()}if(r.isDisabled()){r.setActive(false)}else if(r.hasFormat()){const t=r.getFormat();r.setActive(e===null?false:e.hasFormat(t))}else if(r.getBlockType()!==null){r.setActive(s.has(r.getBlockType()))}}))}))}reset(){babelHelpers.classPrivateFieldLooseBase(this,xu)[xu].forEach((e=>{if(e instanceof ge){e.setActive(false)}}))}}function Vu(){return y.mergeRegister(babelHelpers.classPrivateFieldLooseBase(this,Iu)[Iu].registerCommand(L.SELECTION_CHANGE_COMMAND,(()=>{this.update();return false}),L.COMMAND_PRIORITY_CRITICAL),babelHelpers.classPrivateFieldLooseBase(this,Iu)[Iu].registerCommand(L.FOCUS_COMMAND,(()=>{if(babelHelpers.classPrivateFieldLooseBase(this,ju)[ju]){clearTimeout(babelHelpers.classPrivateFieldLooseBase(this,ju)[ju]);babelHelpers.classPrivateFieldLooseBase(this,ju)[ju]=null}return false}),L.COMMAND_PRIORITY_CRITICAL),babelHelpers.classPrivateFieldLooseBase(this,Iu)[Iu].registerCommand(L.BLUR_COMMAND,(()=>{if(babelHelpers.classPrivateFieldLooseBase(this,ju)[ju]){clearTimeout(babelHelpers.classPrivateFieldLooseBase(this,ju)[ju])}babelHelpers.classPrivateFieldLooseBase(this,ju)[ju]=setTimeout((()=>{const e=document.activeElement;const t=babelHelpers.classPrivateFieldLooseBase(this,Iu)[Iu].getScrollerContainer();if(e===null||!t.contains(e)){this.reset()}}),400);return false}),L.COMMAND_PRIORITY_CRITICAL),babelHelpers.classPrivateFieldLooseBase(this,Iu)[Iu].registerUpdateListener((()=>{this.update()})),babelHelpers.classPrivateFieldLooseBase(this,Iu)[Iu].registerEditableListener((()=>{this.update()})))}function Ju(e){e.forEach((e=>{if(e==="|"){babelHelpers.classPrivateFieldLooseBase(this,xu)[xu].push(new _u)}else{const t=babelHelpers.classPrivateFieldLooseBase(this,Iu)[Iu].getComponentRegistry().create(e);if(t===null){console.warn(`TextEditor Toolbar: "${e}" component doesn't exist.`)}else{babelHelpers.classPrivateFieldLooseBase(this,xu)[xu].push(t)}}}))}function qu(e){if(this.getContainer().offsetWidth===0||F.Dom.hasClass(this.getItemsContainer(),"--animating")){return}const t=babelHelpers.classPrivateFieldLooseBase(this,xu)[xu].at(-1);if(!t||t.getContainer().offsetTop>=t.getContainer().offsetHeight){F.Dom.addClass(this.getContainer(),"--overflowed")}else{F.Dom.removeClass(this.getContainer(),["--overflowed","--expanded"])}}function Qu(e){const t=e.anchor.getNode();const s=new Set;let i=t;while(i!==L.$getRoot()&&i!==null){const e=babelHelpers.classPrivateFieldLooseBase(this,Xu)[Xu](i);s.add(e);i=i.getParent()}return s}function Zu(e){if(f.$isListNode(e)){const t=e;const s=y.$getNearestNodeOfType(t,f.ListNode);return s?s.getListType():t.getListType()}if(P.$isLinkNode(e)||P.$isAutoLinkNode(e)){return"link"}if(It(e)){return"code"}return e.getType()}let ep=e=>e,tp;var sp=babelHelpers.classPrivateFieldLooseKey("popup");var ip=babelHelpers.classPrivateFieldLooseKey("toolbar");var rp=babelHelpers.classPrivateFieldLooseKey("showDebounced");var ap=babelHelpers.classPrivateFieldLooseKey("onEditorScroll");var op=babelHelpers.classPrivateFieldLooseKey("registerListeners");var lp=babelHelpers.classPrivateFieldLooseKey("show");var np=babelHelpers.classPrivateFieldLooseKey("adjustDialogPosition");var dp=babelHelpers.classPrivateFieldLooseKey("initDialogPosition");var cp=babelHelpers.classPrivateFieldLooseKey("handleEditorScroll");var hp=babelHelpers.classPrivateFieldLooseKey("shouldShowDialog");class bp extends ie{constructor(e){super(e);Object.defineProperty(this,hp,{value:Pp});Object.defineProperty(this,cp,{value:fp});Object.defineProperty(this,dp,{value:vp});Object.defineProperty(this,np,{value:gp});Object.defineProperty(this,lp,{value:pp});Object.defineProperty(this,op,{value:up});Object.defineProperty(this,sp,{writable:true,value:null});Object.defineProperty(this,ip,{writable:true,value:null});Object.defineProperty(this,rp,{writable:true,value:null});Object.defineProperty(this,ap,{writable:true,value:babelHelpers.classPrivateFieldLooseBase(this,cp)[cp].bind(this)});babelHelpers.classPrivateFieldLooseBase(this,rp)[rp]=F.Runtime.debounce((()=>{this.getEditor().update((()=>{if(babelHelpers.classPrivateFieldLooseBase(this,hp)[hp]()){babelHelpers.classPrivateFieldLooseBase(this,lp)[lp]()}}))}),700)}static getName(){return"FloatingToolbar"}afterInit(){const e=this.getEditor().getOption("floatingToolbar",[]);babelHelpers.classPrivateFieldLooseBase(this,ip)[ip]=new Gu(this.getEditor(),e);if(!babelHelpers.classPrivateFieldLooseBase(this,ip)[ip].isEmpty()){this.cleanUpRegister(babelHelpers.classPrivateFieldLooseBase(this,op)[op]())}}update(){if(babelHelpers.classPrivateFieldLooseBase(this,hp)[hp]()){if(this.getPopup().isShown()){babelHelpers.classPrivateFieldLooseBase(this,lp)[lp]()}else{babelHelpers.classPrivateFieldLooseBase(this,rp)[rp]()}}else{this.getPopup().close()}}getPopup(){if(babelHelpers.classPrivateFieldLooseBase(this,sp)[sp]===null){const e=F.Tag.render(tp||(tp=ep`<div class="ui-text-editor-floating-toolbar"></div>`));babelHelpers.classPrivateFieldLooseBase(this,sp)[sp]=new p.Popup({closeByEsc:true,targetContainer:document.body,autoHide:true,content:e,autoHideHandler:e=>{let t=true;const s=window.getSelection();if(s.isCollapsed){return true}this.getEditor().update((()=>{const e=L.$getSelection();t=e===null||e.isCollapsed()}));return t},events:{onShow:()=>{if(babelHelpers.classPrivateFieldLooseBase(this,np)[np]()){F.Event.bind(this.getEditor().getScrollerContainer(),"scroll",babelHelpers.classPrivateFieldLooseBase(this,ap)[ap])}},onClose:()=>{F.Event.unbind(this.getEditor().getScrollerContainer(),"scroll",babelHelpers.classPrivateFieldLooseBase(this,ap)[ap]);ta(this.getPopup())}}});babelHelpers.classPrivateFieldLooseBase(this,ip)[ip].renderTo(e)}return babelHelpers.classPrivateFieldLooseBase(this,sp)[sp]}hide(){if(babelHelpers.classPrivateFieldLooseBase(this,sp)[sp]===null){return}this.getPopup().close()}destroy(){super.destroy();if(babelHelpers.classPrivateFieldLooseBase(this,sp)[sp]!==null){babelHelpers.classPrivateFieldLooseBase(this,sp)[sp].destroy();babelHelpers.classPrivateFieldLooseBase(this,sp)[sp]=null}babelHelpers.classPrivateFieldLooseBase(this,ip)[ip].destroy();babelHelpers.classPrivateFieldLooseBase(this,ip)[ip]=null}}function up(){return y.mergeRegister(this.getEditor().registerCommand(L.SELECTION_CHANGE_COMMAND,(()=>{this.update();return false}),L.COMMAND_PRIORITY_CRITICAL),this.getEditor().registerUpdateListener((({editorState:e})=>{e.read((()=>{this.update()}))})),this.getEditor().registerCommand(H,(()=>{this.hide();return false}),L.COMMAND_PRIORITY_LOW))}function pp(){this.getPopup().show();ta(this.getPopup());babelHelpers.classPrivateFieldLooseBase(this,np)[np]()}function gp(){return ea(this.getPopup(),this.getEditor(),babelHelpers.classPrivateFieldLooseBase(this,dp)[dp])}function vp(e){const{isBackward:t,isMultiline:s}=e;return t||!s?"top":"bottom"}function fp(){this.getEditor().update((()=>{babelHelpers.classPrivateFieldLooseBase(this,np)[np]()}))}function Pp(){if(this.getEditor().isComposing()||!this.getEditor().isEditable()){return false}const e=L.$getSelection();if(!L.$isRangeSelection(e)||e.isCollapsed()){return false}const t=window.getSelection();if(t===null||t.isCollapsed){return false}const s=this.getEditor().getScrollerContainer();if(!s.contains(t.anchorNode)){return false}const i=y.$findMatchingParent(e.anchor.getNode(),(e=>(e.__flags&E)!==0));if(i||e.getTextContent()===""){return false}const r=e.getTextContent().replaceAll("\n","");if(!e.isCollapsed()&&r===""){return false}const a=this.getEditor().dispatchCommand(B);if(a){return false}const o=w(e);return L.$isTextNode(o)}var mp=Object.freeze({FloatingToolbarPlugin:bp});const Lp=L.createCommand("TOGGLE_TOOLBAR_COMMAND");const yp=L.createCommand("SHOW_TOOLBAR_COMMAND");const Fp=L.createCommand("HIDE_TOOLBAR_COMMAND");var Hp=babelHelpers.classPrivateFieldLooseKey("toolbar");var Bp=babelHelpers.classPrivateFieldLooseKey("registerCommands");class Cp extends ie{constructor(...e){super(...e);Object.defineProperty(this,Bp,{value:Op});Object.defineProperty(this,Hp,{writable:true,value:null})}static getName(){return"Toolbar"}getToolbar(){return babelHelpers.classPrivateFieldLooseBase(this,Hp)[Hp]}isRendered(){return babelHelpers.classPrivateFieldLooseBase(this,Hp)[Hp]!==null&&babelHelpers.classPrivateFieldLooseBase(this,Hp)[Hp].isRendered()}show(){if(this.isRendered()){F.Dom.removeClass(this.getEditor().getToolbarContainer(),"--hidden")}}hide(){if(this.isRendered()){F.Dom.addClass(this.getEditor().getToolbarContainer(),"--hidden")}}isShown(){return this.isRendered()&&!F.Dom.hasClass(this.getEditor().getToolbarContainer(),"--hidden")}toggle(){if(this.isShown()){this.hide()}else{this.show()}}afterInit(){babelHelpers.classPrivateFieldLooseBase(this,Hp)[Hp]=new Gu(this.getEditor(),this.getEditor().getOption("toolbar"));if(!babelHelpers.classPrivateFieldLooseBase(this,Hp)[Hp].isEmpty()){babelHelpers.classPrivateFieldLooseBase(this,Bp)[Bp]();babelHelpers.classPrivateFieldLooseBase(this,Hp)[Hp].renderTo(this.getEditor().getToolbarContainer());const e=this.getEditor().getOption("hideToolbar",false);if(e){this.hide()}}}destroy(){super.destroy();babelHelpers.classPrivateFieldLooseBase(this,Hp)[Hp].destroy()}}function Op(){this.cleanUpRegister(this.getEditor().registerCommand(Lp,(()=>{this.toggle();return true}),L.COMMAND_PRIORITY_LOW),this.getEditor().registerCommand(yp,(()=>{this.show();return true}),L.COMMAND_PRIORITY_LOW),this.getEditor().registerCommand(Fp,(()=>{this.hide();return true}),L.COMMAND_PRIORITY_LOW))}var Tp=Object.freeze({TOGGLE_TOOLBAR_COMMAND:Lp,SHOW_TOOLBAR_COMMAND:yp,HIDE_TOOLBAR_COMMAND:Fp,ToolbarPlugin:Cp});let Ep=e=>e,Np;var _p=babelHelpers.classPrivateFieldLooseKey("placeholder");var Mp=babelHelpers.classPrivateFieldLooseKey("placeholderNode");var Dp=babelHelpers.classPrivateFieldLooseKey("paragraphPlaceholder");var Sp=babelHelpers.classPrivateFieldLooseKey("registerPlaceholderListeners");var Rp=babelHelpers.classPrivateFieldLooseKey("togglePlaceholder");var Ip=babelHelpers.classPrivateFieldLooseKey("hasFocus");var xp=babelHelpers.classPrivateFieldLooseKey("hidePlaceholder");var wp=babelHelpers.classPrivateFieldLooseKey("registerParagraphListeners");class Ap extends ie{constructor(...e){super(...e);Object.defineProperty(this,wp,{value:Up});Object.defineProperty(this,xp,{value:kp});Object.defineProperty(this,Ip,{value:jp});Object.defineProperty(this,Rp,{value:Kp});Object.defineProperty(this,Sp,{value:$p});Object.defineProperty(this,_p,{writable:true,value:null});Object.defineProperty(this,Mp,{writable:true,value:null});Object.defineProperty(this,Dp,{writable:true,value:null})}afterInit(){const e=this.getEditor().getOption("placeholder");if(F.Type.isStringFilled(e)){babelHelpers.classPrivateFieldLooseBase(this,_p)[_p]=e;babelHelpers.classPrivateFieldLooseBase(this,Mp)[Mp]=F.Tag.render(Np||(Np=Ep`
				<div class="ui-text-editor-placeholder">${0}</div>
			`),F.Text.encode(babelHelpers.classPrivateFieldLooseBase(this,_p)[_p]));F.Dom.append(babelHelpers.classPrivateFieldLooseBase(this,Mp)[Mp],this.getEditor().getScrollerContainer());babelHelpers.classPrivateFieldLooseBase(this,Sp)[Sp]()}let t=this.getEditor().getOption("paragraphPlaceholder");if(F.Type.isStringFilled(t)){if(t==="auto"){const e=this.getEditor().getPlugin("Copilot");const s=e!==null&&e.shouldTriggerBySpace();const i=this.getEditor().getPlugin("Mention");const r=i!==null&&i.shouldTriggerByAtSign();if(s&&r){t=F.Loc.getMessage("TEXT_EDITOR_PLACEHOLDER_MENTION_COPILOT")}else if(s){t=F.Loc.getMessage("TEXT_EDITOR_PLACEHOLDER_COPILOT")}else if(r){t=F.Loc.getMessage("TEXT_EDITOR_PLACEHOLDER_MENTION")}}if(t!=="auto"){babelHelpers.classPrivateFieldLooseBase(this,Dp)[Dp]=t;babelHelpers.classPrivateFieldLooseBase(this,wp)[wp]()}}}static getName(){return"Placeholder"}}function $p(){this.cleanUpRegister(this.getEditor().registerUpdateListener((()=>{this.getEditor().getEditorState().read((()=>{babelHelpers.classPrivateFieldLooseBase(this,Rp)[Rp]()}))})))}function Kp(){if(babelHelpers.classPrivateFieldLooseBase(this,_p)[_p]===null){return}let e=m.$canShowPlaceholder(this.getLexicalEditor().isComposing());if(e&&babelHelpers.classPrivateFieldLooseBase(this,Dp)[Dp]!==null&&babelHelpers.classPrivateFieldLooseBase(this,Ip)[Ip]()){e=false}if(e){F.Dom.addClass(babelHelpers.classPrivateFieldLooseBase(this,Mp)[Mp],"--shown")}else{F.Dom.removeClass(babelHelpers.classPrivateFieldLooseBase(this,Mp)[Mp],"--shown")}}function jp(){const e=document.activeElement;const t=this.getEditor().getRootElement();return t!==null&&e!==null&&t.contains(e)}function kp(){if(babelHelpers.classPrivateFieldLooseBase(this,Mp)[Mp]!==null){F.Dom.removeClass(babelHelpers.classPrivateFieldLooseBase(this,Mp)[Mp],"--shown")}}function Up(){let e=null;const t=()=>{if(e){const t=this.getEditor().getElementByKey(e.getKey());if(t){delete t.dataset.placeholder}}};this.cleanUpRegister(this.getEditor().registerCommand(L.SELECTION_CHANGE_COMMAND,(()=>{if(!this.getEditor().isEditable()){return false}const s=L.$getSelection();let i=null;if(L.$isRangeSelection(s)&&s.isCollapsed()){const e=s.anchor.getNode();if(L.$isParagraphNode(e)&&L.$isRootNode(e.getParent())&&e.isEmpty()){const t=this.getEditor().getElementByKey(e.getKey());if(t&&babelHelpers.classPrivateFieldLooseBase(this,Ip)[Ip]()){t.dataset.placeholder=babelHelpers.classPrivateFieldLooseBase(this,Dp)[Dp];i=e;babelHelpers.classPrivateFieldLooseBase(this,xp)[xp]()}}}if(e&&e!==i){t()}e=i;return false}),L.COMMAND_PRIORITY_CRITICAL),this.getEditor().registerCommand(L.PASTE_COMMAND,(()=>{t();return false}),L.COMMAND_PRIORITY_CRITICAL),this.getEditor().registerCommand(L.BLUR_COMMAND,(()=>{t();babelHelpers.classPrivateFieldLooseBase(this,Rp)[Rp]();return false}),L.COMMAND_PRIORITY_CRITICAL))}let Wp=e=>e,Yp,zp,Xp,Gp,Vp,Jp,qp,Qp,Zp,eg;const tg={COLLAPSED:"collapsed",COLLAPSING:"collapsing",EXPANDED:"expanded",EXPANDING:"expanding"};var sg=babelHelpers.classPrivateFieldLooseKey("lexicalEditor");var ig=babelHelpers.classPrivateFieldLooseKey("componentRegistry");var rg=babelHelpers.classPrivateFieldLooseKey("refs");var ag=babelHelpers.classPrivateFieldLooseKey("options");var og=babelHelpers.classPrivateFieldLooseKey("plugins");var lg=babelHelpers.classPrivateFieldLooseKey("newLineMode");var ng=babelHelpers.classPrivateFieldLooseKey("bbcodeScheme");var dg=babelHelpers.classPrivateFieldLooseKey("schemeValidation");var cg=babelHelpers.classPrivateFieldLooseKey("bbcodeImportMap");var hg=babelHelpers.classPrivateFieldLooseKey("bbcodeExportMap");var bg=babelHelpers.classPrivateFieldLooseKey("themeClasses");var ug=babelHelpers.classPrivateFieldLooseKey("decoratorNodes");var pg=babelHelpers.classPrivateFieldLooseKey("decoratorComponents");var gg=babelHelpers.classPrivateFieldLooseKey("removeListeners");var vg=babelHelpers.classPrivateFieldLooseKey("highlightContainer");var fg=babelHelpers.classPrivateFieldLooseKey("autoFocus");var Pg=babelHelpers.classPrivateFieldLooseKey("minHeight");var mg=babelHelpers.classPrivateFieldLooseKey("maxHeight");var Lg=babelHelpers.classPrivateFieldLooseKey("collapsingMode");var yg=babelHelpers.classPrivateFieldLooseKey("collapsingState");var Fg=babelHelpers.classPrivateFieldLooseKey("collapsingTransitionEnd");var Hg=babelHelpers.classPrivateFieldLooseKey("paragraphHeight");var Bg=babelHelpers.classPrivateFieldLooseKey("resizeObserver");var Cg=babelHelpers.classPrivateFieldLooseKey("destroying");var Og=babelHelpers.classPrivateFieldLooseKey("rendered");var Tg=babelHelpers.classPrivateFieldLooseKey("prevEmptyStatus");var Eg=babelHelpers.classPrivateFieldLooseKey("initEditorState");var Ng=babelHelpers.classPrivateFieldLooseKey("initDecorateNodes");var _g=babelHelpers.classPrivateFieldLooseKey("registerCommands");var Mg=babelHelpers.classPrivateFieldLooseKey("createNamespace");var Dg=babelHelpers.classPrivateFieldLooseKey("initBBCodeImportMap");var Sg=babelHelpers.classPrivateFieldLooseKey("initBBCodeExportMap");var Rg=babelHelpers.classPrivateFieldLooseKey("initBBCodeScheme");var Ig=babelHelpers.classPrivateFieldLooseKey("initCollapsingMode");var xg=babelHelpers.classPrivateFieldLooseKey("collapse");var wg=babelHelpers.classPrivateFieldLooseKey("handleCollapsingTransition");class Ag extends b.EventEmitter{constructor(e){super();Object.defineProperty(this,wg,{value:Gg});Object.defineProperty(this,xg,{value:Xg});Object.defineProperty(this,Ig,{value:zg});Object.defineProperty(this,Rg,{value:Yg});Object.defineProperty(this,Sg,{value:Wg});Object.defineProperty(this,Dg,{value:Ug});Object.defineProperty(this,Mg,{value:kg});Object.defineProperty(this,_g,{value:jg});Object.defineProperty(this,Ng,{value:Kg});Object.defineProperty(this,Eg,{value:$g});Object.defineProperty(this,sg,{writable:true,value:null});Object.defineProperty(this,ig,{writable:true,value:new Yn});Object.defineProperty(this,rg,{writable:true,value:new F.Cache.MemoryCache});Object.defineProperty(this,ag,{writable:true,value:null});Object.defineProperty(this,og,{writable:true,value:null});Object.defineProperty(this,lg,{writable:true,value:N.MIXED});Object.defineProperty(this,ng,{writable:true,value:null});Object.defineProperty(this,dg,{writable:true,value:null});Object.defineProperty(this,cg,{writable:true,value:void 0});Object.defineProperty(this,hg,{writable:true,value:void 0});Object.defineProperty(this,bg,{writable:true,value:{}});Object.defineProperty(this,ug,{writable:true,value:new Set});Object.defineProperty(this,pg,{writable:true,value:new Map});Object.defineProperty(this,gg,{writable:true,value:null});Object.defineProperty(this,vg,{writable:true,value:F.Tag.render(Yp||(Yp=Wp`<div class="ui-text-editor-selection-highlighting"></div>`))});Object.defineProperty(this,fg,{writable:true,value:false});Object.defineProperty(this,Pg,{writable:true,value:null});Object.defineProperty(this,mg,{writable:true,value:null});Object.defineProperty(this,Lg,{writable:true,value:false});Object.defineProperty(this,yg,{writable:true,value:tg.EXPANDED});Object.defineProperty(this,Fg,{writable:true,value:babelHelpers.classPrivateFieldLooseBase(this,wg)[wg].bind(this)});Object.defineProperty(this,Hg,{writable:true,value:null});Object.defineProperty(this,Bg,{writable:true,value:null});Object.defineProperty(this,Cg,{writable:true,value:false});Object.defineProperty(this,Og,{writable:true,value:false});Object.defineProperty(this,Tg,{writable:true,value:true});this.setEventNamespace("BX.UI.TextEditor.Editor");const t=this.constructor.getDefaultOptions();const s=F.Type.isPlainObject(e)?e:{};babelHelpers.classPrivateFieldLooseBase(this,ag)[ag]=new l.SettingsCollection({...t,...s});const i=[...this.constructor.getBuiltinPlugins()];const r=babelHelpers.classPrivateFieldLooseBase(this,ag)[ag].get("plugins",i);const a=babelHelpers.classPrivateFieldLooseBase(this,ag)[ag].get("extraPlugins",[]);const o=babelHelpers.classPrivateFieldLooseBase(this,ag)[ag].get("removePlugins",[]);const n=babelHelpers.classPrivateFieldLooseBase(this,ag)[ag].get("newLineMode");if([N.LINE_BREAK,N.PARAGRAPH].includes(n)){babelHelpers.classPrivateFieldLooseBase(this,lg)[lg]=n}babelHelpers.classPrivateFieldLooseBase(this,bg)[bg]=wn;babelHelpers.classPrivateFieldLooseBase(this,og)[og]=new kn(i,[...r,...a],o);const d=babelHelpers.classPrivateFieldLooseBase(this,og)[og].getConstructors();const c=d.map((e=>e.getNodes(this)));babelHelpers.classPrivateFieldLooseBase(this,sg)[sg]=L.createEditor({namespace:F.Type.isStringFilled(s.namespace)?s.namespace:babelHelpers.classPrivateFieldLooseBase(this,Mg)[Mg](d),nodes:c.flat(),onError:e=>{console.error(e)},theme:babelHelpers.classPrivateFieldLooseBase(this,bg)[bg],editable:babelHelpers.classPrivateFieldLooseBase(this,ag)[ag].get("editable")!==false});this.setMinHeight(s.minHeight);this.setMaxHeight(s.maxHeight);this.setAutoFocus(s.autoFocus);this.setVisualOptions(s.visualOptions);babelHelpers.classPrivateFieldLooseBase(this,gg)[gg]=y.mergeRegister(babelHelpers.classPrivateFieldLooseBase(this,_g)[_g](),babelHelpers.classPrivateFieldLooseBase(this,Ng)[Ng](c.flat()));babelHelpers.classPrivateFieldLooseBase(this,og)[og].init(this);babelHelpers.classPrivateFieldLooseBase(this,cg)[cg]=babelHelpers.classPrivateFieldLooseBase(this,Dg)[Dg]();babelHelpers.classPrivateFieldLooseBase(this,hg)[hg]=babelHelpers.classPrivateFieldLooseBase(this,Sg)[Sg]();babelHelpers.classPrivateFieldLooseBase(this,ng)[ng]=babelHelpers.classPrivateFieldLooseBase(this,Rg)[Rg]();babelHelpers.classPrivateFieldLooseBase(this,dg)[dg]=new Qn(this);this.subscribeFromOptions(s.events)}static getBuiltinPlugins(){return[td,Ht,rd,od,Ld,cd,gd,Od,sh,os,_e,ch,Eo,fc,Ac,Na,hn,hl,Ve,wh,zh,Lb,Ib,hu,bp,Cp,Ap,Fr]}static getDefaultOptions(){return{}}getComponentRegistry(){return babelHelpers.classPrivateFieldLooseBase(this,ig)[ig]}getOptions(){return babelHelpers.classPrivateFieldLooseBase(this,ag)[ag]}getOption(e,t=null){return babelHelpers.classPrivateFieldLooseBase(this,ag)[ag].get(e,t)}getThemeClasses(){return babelHelpers.classPrivateFieldLooseBase(this,bg)[bg]}getThemeClass(e){const t=babelHelpers.classPrivateFieldLooseBase(this,bg)[bg][e];if(t!==undefined){return t}return""}getNewLineMode(){return babelHelpers.classPrivateFieldLooseBase(this,lg)[lg]}getBBCodeScheme(){return babelHelpers.classPrivateFieldLooseBase(this,ng)[ng]}getSchemeValidation(){return babelHelpers.classPrivateFieldLooseBase(this,dg)[dg]}setText(e,t){if(F.Type.isString(e)){const s={discrete:F.Type.isPlainObject(t)&&t.discrete===true};babelHelpers.classPrivateFieldLooseBase(this,sg)[sg].update((()=>{const t=K(e,this);const s=L.$getRoot();s.clear();s.append(...t);L.$setSelection(null)}),s)}}clear(e){const t={discrete:F.Type.isPlainObject(e)&&e.discrete===true};babelHelpers.classPrivateFieldLooseBase(this,sg)[sg].update((()=>{const e=L.$getRoot();const t=L.$createParagraphNode();e.clear();e.append(t);L.$setSelection(null)}),t)}clearHistory(){this.dispatchCommand(L.CLEAR_HISTORY_COMMAND)}getText(){return babelHelpers.classPrivateFieldLooseBase(this,sg)[sg].getEditorState().read((()=>{const e=V(L.$getRoot(),this);return e.toString()}))}isEmpty(e=true){return babelHelpers.classPrivateFieldLooseBase(this,sg)[sg].getEditorState().read((()=>xn(e)))}setAutoFocus(e){if(F.Type.isBoolean(e)){babelHelpers.classPrivateFieldLooseBase(this,fg)[fg]=e}}hasAutoFocus(){return babelHelpers.classPrivateFieldLooseBase(this,fg)[fg]}setMinHeight(e){if(F.Type.isNumber(e)&&e>0||e===null){const t=babelHelpers.classPrivateFieldLooseBase(this,Pg)[Pg]!==e;babelHelpers.classPrivateFieldLooseBase(this,Pg)[Pg]=e;if(t){F.Dom.style(this.getScrollerContainer(),"--ui-text-editor-min-height",e>0?`${e}px`:null)}}}getMinHeight(){return babelHelpers.classPrivateFieldLooseBase(this,Pg)[Pg]}setMaxHeight(e){if(F.Type.isNumber(e)&&e>0||e===null){const t=babelHelpers.classPrivateFieldLooseBase(this,mg)[mg]!==e;babelHelpers.classPrivateFieldLooseBase(this,mg)[mg]=e;if(t){F.Dom.style(this.getScrollerContainer(),"--ui-text-editor-max-height",e>0?`${e}px`:null)}}}getMaxHeight(){return babelHelpers.classPrivateFieldLooseBase(this,mg)[mg]}setVisualOptions(e){if(!F.Type.isPlainObject(e)){return}for(const[t,s]of Object.entries(e)){const e=F.Text.toKebabCase(t);F.Dom.style(this.getRootContainer(),`--ui-text-editor-${e}`,s)}}isCollapsingModeEnabled(){return babelHelpers.classPrivateFieldLooseBase(this,Lg)[Lg]}isCollapsed(){return babelHelpers.classPrivateFieldLooseBase(this,yg)[yg]===tg.COLLAPSED}collapse(e=true){babelHelpers.classPrivateFieldLooseBase(this,xg)[xg]("hide",e)}expand(e=true){babelHelpers.classPrivateFieldLooseBase(this,xg)[xg]("show",e)}toggle(e=true){babelHelpers.classPrivateFieldLooseBase(this,xg)[xg]("toggle",e)}getParagraphHeight(){if(babelHelpers.classPrivateFieldLooseBase(this,Hg)[Hg]!==null){return babelHelpers.classPrivateFieldLooseBase(this,Hg)[Hg]}const e=this.getThemeClasses().paragraph||"";const t=F.Tag.render(zp||(zp=Wp`<p class="${0}"><br /></p>`),e);F.Dom.style(t,{position:"absolute",transform:"translateY(-1000px)"});F.Dom.append(t,this.getScrollerContainer());babelHelpers.classPrivateFieldLooseBase(this,Hg)[Hg]=t.offsetHeight+F.Text.toNumber(F.Dom.style(t,"margin-top"))+F.Text.toNumber(F.Dom.style(t,"margin-bottom"));F.Dom.remove(t);return babelHelpers.classPrivateFieldLooseBase(this,Hg)[Hg]}getLexicalEditor(){return babelHelpers.classPrivateFieldLooseBase(this,sg)[sg]}setRootElement(e){if(F.Type.isElementNode(e)||e===null){babelHelpers.classPrivateFieldLooseBase(this,sg)[sg].setRootElement(e)}}getBBCodeExportMap(){return babelHelpers.classPrivateFieldLooseBase(this,hg)[hg]}getBBCodeImportMap(){return babelHelpers.classPrivateFieldLooseBase(this,cg)[cg]}getEditorState(){return babelHelpers.classPrivateFieldLooseBase(this,sg)[sg].getEditorState()}getPlugins(){return babelHelpers.classPrivateFieldLooseBase(this,og)[og]}getPlugin(e){return babelHelpers.classPrivateFieldLooseBase(this,og)[og].get(e)}getElementByKey(e){return babelHelpers.classPrivateFieldLooseBase(this,sg)[sg].getElementByKey(e)}setEditorState(e,t){babelHelpers.classPrivateFieldLooseBase(this,sg)[sg].setEditorState(e,t)}setEditable(e){if(F.Type.isBoolean(e)){this.dispatchCommand(H);if(!e){this.blur()}babelHelpers.classPrivateFieldLooseBase(this,sg)[sg].setEditable(e)}}isEditable(){return babelHelpers.classPrivateFieldLooseBase(this,sg)[sg].isEditable()}registerUpdateListener(e){return babelHelpers.classPrivateFieldLooseBase(this,sg)[sg].registerUpdateListener(e)}registerEditableListener(e){return babelHelpers.classPrivateFieldLooseBase(this,sg)[sg].registerEditableListener(e)}registerCommand(e,t,s){return babelHelpers.classPrivateFieldLooseBase(this,sg)[sg].registerCommand(e,t,s)}dispatchCommand(e,t){return babelHelpers.classPrivateFieldLooseBase(this,sg)[sg].dispatchCommand(e,t)}registerMutationListener(e,t){return babelHelpers.classPrivateFieldLooseBase(this,sg)[sg].registerMutationListener(e,t)}registerNodeTransform(e,t){return babelHelpers.classPrivateFieldLooseBase(this,sg)[sg].registerNodeTransform(e,t)}registerTextContentListener(e){return babelHelpers.classPrivateFieldLooseBase(this,sg)[sg].registerTextContentListener(e)}registerDecoratorListener(e){return babelHelpers.classPrivateFieldLooseBase(this,sg)[sg].registerDecoratorListener(e)}registerRootListener(e){return babelHelpers.classPrivateFieldLooseBase(this,sg)[sg].registerRootListener(e)}registerEventListener(e,t,s){const i=["mouseenter","mouseleave"].includes(t);const r=t=>{this.update((()=>{const r=L.$getNearestNodeFromDOMNode(t.target);if(r!==null){const a=i?r instanceof e?r:null:y.$findMatchingParent(r,(t=>t instanceof e));if(a!==null){s(t,a.getKey())}}}))};return this.registerRootListener(((e,s)=>{if(e){F.Event.bind(e,t,r,i)}if(s){F.Event.unbind(s,t,r,i)}}))}update(e,t){babelHelpers.classPrivateFieldLooseBase(this,sg)[sg].update(e,t)}focus(e,t){if(!document.hasFocus()){window.focus()}babelHelpers.classPrivateFieldLooseBase(this,sg)[sg].focus(F.Type.isFunction(e)?e:null,F.Type.isPlainObject(t)?t:{defaultSelection:"rootStart"})}hasFocus(){return this.getRootElement().contains(document.activeElement)}blur(){babelHelpers.classPrivateFieldLooseBase(this,sg)[sg].blur()}isComposing(){return babelHelpers.classPrivateFieldLooseBase(this,sg)[sg].isComposing()}getRootElement(){return babelHelpers.classPrivateFieldLooseBase(this,sg)[sg].getRootElement()}hasNodes(e){return babelHelpers.classPrivateFieldLooseBase(this,sg)[sg].hasNodes(e)}getRootContainer(){return babelHelpers.classPrivateFieldLooseBase(this,rg)[rg].remember("root",(()=>{const e=[this.isEditable()?"--editable":"--read-only"];return F.Tag.render(Xp||(Xp=Wp`
				<div class="ui-text-editor ${0}">
					${0}
				</div>
			`),e.join(" "),this.getInnerContainer())}))}getInnerContainer(){return babelHelpers.classPrivateFieldLooseBase(this,rg)[rg].remember("inner",(()=>F.Tag.render(Gp||(Gp=Wp`
			...
			`),this.getHeaderContainer(),this.getToolbarContainer(),this.getScrollerContainer(),this.getFooterContainer())))}getToolbarContainer(){return babelHelpers.classPrivateFieldLooseBase(this,rg)[rg].remember("toolbar",(()=>F.Tag.render(Vp||(Vp=Wp`
				<div class="ui-text-editor-toolbar" tabindex="-1"></div>
			`))))}getScrollerContainer(){return babelHelpers.classPrivateFieldLooseBase(this,rg)[rg].remember("scroller",(()=>F.Tag.render(Jp||(Jp=Wp`
				<div class="ui-text-editor-scroller">
					${0}
				</div>
			`),this.getEditableContainer())))}getEditableContainer(){return babelHelpers.classPrivateFieldLooseBase(this,rg)[rg].remember("editable",(()=>F.Tag.render(qp||(qp=Wp`
				<div 
					class="ui-text-editor-editable" 
					contenteditable="${0}" 
					spellcheck="true"
				></div>
			`),this.isEditable()?"true":"false")))}getFooterContainer(){return babelHelpers.classPrivateFieldLooseBase(this,rg)[rg].remember("footer",(()=>F.Tag.render(Qp||(Qp=Wp`
				<div class="ui-text-editor-slot ui-text-editor-footer" tabindex="-1"></div>
			`))))}getHeaderContainer(){return babelHelpers.classPrivateFieldLooseBase(this,rg)[rg].remember("header",(()=>F.Tag.render(Zp||(Zp=Wp`
				<div class="ui-text-editor-slot ui-text-editor-header" tabindex="-1"></div>
			`))))}renderTo(e,t=false){if(!F.Type.isElementNode(e)){return}if(!this.isRendered()){if(F.Type.isStringFilled(babelHelpers.classPrivateFieldLooseBase(this,ag)[ag].get("content"))){this.setText(babelHelpers.classPrivateFieldLooseBase(this,ag)[ag].get("content"))}else{babelHelpers.classPrivateFieldLooseBase(this,Eg)[Eg](babelHelpers.classPrivateFieldLooseBase(this,ag)[ag].get("editorState"))}}if(t){F.Dom.replace(e,this.getRootContainer())}else{F.Dom.append(this.getRootContainer(),e)}babelHelpers.classPrivateFieldLooseBase(this,sg)[sg].setRootElement(this.getEditableContainer());if(this.hasAutoFocus()){this.focus(null,{defaultSelection:"rootStart"})}if(!babelHelpers.classPrivateFieldLooseBase(this,Og)[Og]){babelHelpers.classPrivateFieldLooseBase(this,Bg)[Bg]=new ResizeObserver((()=>{this.emit("onResize");this.dispatchCommand(H,{context:"resize"})}));babelHelpers.classPrivateFieldLooseBase(this,Bg)[Bg].observe(this.getScrollerContainer())}babelHelpers.classPrivateFieldLooseBase(this,Og)[Og]=true}isRendered(){return babelHelpers.classPrivateFieldLooseBase(this,Og)[Og]}highlightSelection(){this.getEditorState().read((()=>{const e=L.$getSelection();if(!L.$isRangeSelection(e)||e.isCollapsed()){return}const t=e.anchor;const s=e.focus;const i=d.createDOMRange(babelHelpers.classPrivateFieldLooseBase(this,sg)[sg],t.getNode(),t.offset,s.getNode(),s.offset);if(i!==null){const e=this.getScrollerContainer();const t=e.getBoundingClientRect();const s=d.createRectsFromDOMRange(babelHelpers.classPrivateFieldLooseBase(this,sg)[sg],i);const r=s.length;babelHelpers.classPrivateFieldLooseBase(this,vg)[vg].innerHTML="";for(let i=0;i<r;i++){const r=s[i];const a=F.Tag.render(eg||(eg=Wp`<span class="ui-text-editor-selection-part"></span>`));const o=r.top-t.top+e.scrollTop;const l=r.left-t.left+e.scrollLeft;F.Dom.style(a,{top:`${o}px`,left:`${l}px`,height:`${r.height}px`,width:`${r.width}px`});F.Dom.append(a,babelHelpers.classPrivateFieldLooseBase(this,vg)[vg])}F.Dom.append(babelHelpers.classPrivateFieldLooseBase(this,vg)[vg],this.getScrollerContainer())}}))}resetHighlightSelection(){F.Dom.remove(babelHelpers.classPrivateFieldLooseBase(this,vg)[vg])}destroy(){if(babelHelpers.classPrivateFieldLooseBase(this,Cg)[Cg]){return}babelHelpers.classPrivateFieldLooseBase(this,Cg)[Cg]=true;this.emit("onDestroy");for(const[,e]of babelHelpers.classPrivateFieldLooseBase(this,og)[og]){e.destroy()}babelHelpers.classPrivateFieldLooseBase(this,gg)[gg]();if(this.isRendered()){babelHelpers.classPrivateFieldLooseBase(this,Bg)[Bg].disconnect();this.setRootElement(null);F.Dom.remove(this.getRootContainer())}babelHelpers.classPrivateFieldLooseBase(this,Bg)[Bg]=null;babelHelpers.classPrivateFieldLooseBase(this,og)[og]=null;babelHelpers.classPrivateFieldLooseBase(this,sg)[sg]=null;this.$refs=null;babelHelpers.classPrivateFieldLooseBase(this,dg)[dg]=null;babelHelpers.classPrivateFieldLooseBase(this,cg)[cg]=null;babelHelpers.classPrivateFieldLooseBase(this,hg)[hg]=null;babelHelpers.classPrivateFieldLooseBase(this,ug)[ug]=null;babelHelpers.classPrivateFieldLooseBase(this,pg)[pg]=null;Object.setPrototypeOf(this,null)}}function $g(e,t){if(F.Type.isNil(e)){babelHelpers.classPrivateFieldLooseBase(this,sg)[sg].update((()=>{const e=L.$getRoot();if(e.isEmpty()){const t=L.$createParagraphNode();e.append(t)}}),t)}else if(F.Type.isPlainObject(e)||F.Type.isStringFilled(e)){const t=babelHelpers.classPrivateFieldLooseBase(this,sg)[sg].parseEditorState(e);babelHelpers.classPrivateFieldLooseBase(this,sg)[sg].setEditorState(t)}else if(F.Type.isFunction(e)){babelHelpers.classPrivateFieldLooseBase(this,sg)[sg].update((()=>{const t=L.$getRoot();if(t.isEmpty()){e(babelHelpers.classPrivateFieldLooseBase(this,sg)[sg])}}),t)}}function Kg(e){const t=[];e.forEach((e=>{if(e.useDecoratorComponent){const s=this.registerMutationListener(e,((e,t)=>{for(const[t,s]of e){if(s==="destroyed"){const e=babelHelpers.classPrivateFieldLooseBase(this,pg)[pg].get(t);if(e){e.destroy()}babelHelpers.classPrivateFieldLooseBase(this,pg)[pg].delete(t)}else{babelHelpers.classPrivateFieldLooseBase(this,ug)[ug].add(t)}}}));t.push(s)}}));const s=babelHelpers.classPrivateFieldLooseBase(this,sg)[sg].registerDecoratorListener((e=>{babelHelpers.classPrivateFieldLooseBase(this,ug)[ug].forEach((t=>{const s=e[t];const{componentClass:i,options:r}=s;const a=babelHelpers.classPrivateFieldLooseBase(this,pg)[pg].get(t);const o=babelHelpers.classPrivateFieldLooseBase(this,sg)[sg].getElementByKey(t);if(o!=null&&o.innerHTML&&a){a.update(r)}else if(o){babelHelpers.classPrivateFieldLooseBase(this,pg)[pg].set(t,new i({textEditor:this,target:o,nodeKey:t,options:r}))}}));babelHelpers.classPrivateFieldLooseBase(this,ug)[ug].clear()}));t.push(s);return y.mergeRegister(...t)}function jg(){return y.mergeRegister(this.registerCommand(L.FOCUS_COMMAND,(()=>{if(this.isCollapsingModeEnabled()&&babelHelpers.classPrivateFieldLooseBase(this,yg)[yg]===tg.COLLAPSED&&this.isEmpty(false)){this.expand();return true}this.emit("onFocus");return false}),L.COMMAND_PRIORITY_CRITICAL),this.registerCommand(L.BLUR_COMMAND,(e=>{if(this.isCollapsingModeEnabled()&&(babelHelpers.classPrivateFieldLooseBase(this,yg)[yg]===tg.COLLAPSING||babelHelpers.classPrivateFieldLooseBase(this,yg)[yg]===tg.EXPANDING)){return true}this.emit("onBlur");return false}),L.COMMAND_PRIORITY_CRITICAL),this.registerUpdateListener((({dirtyElements:e,dirtyLeaves:t,prevEditorState:s,tags:i})=>{const r=this.isComposing();const a=t.size>0||e.size>0;if(r||!a){return}const o=s.isEmpty();if(babelHelpers.classPrivateFieldLooseBase(this,ag)[ag].get("collapsingMode")===true){if(o){babelHelpers.classPrivateFieldLooseBase(this,Ig)[Ig]()}else if(this.isCollapsed()&&!this.isEmpty()){this.expand(false)}}if(!o&&i.has("history-merge")){return}this.emit("onChange",{isInitialChange:o,tags:i});const l=this.isEmpty();if(babelHelpers.classPrivateFieldLooseBase(this,Tg)[Tg]!==l){babelHelpers.classPrivateFieldLooseBase(this,Tg)[Tg]=l;this.emit("onEmptyContentToggle",{isEmpty:l,isInitialChange:o})}})),this.registerCommand(L.KEY_ENTER_COMMAND,(e=>{const{code:t,ctrlKey:s,metaKey:i}=e;if(F.Browser.isMac()&&i||s){this.emit("onMetaEnter");return true}if(t==="Escape"){this.emit("onEscape");return true}return false}),L.COMMAND_PRIORITY_LOW),this.registerEditableListener((e=>{this.getEditableContainer().contentEditable=e;if(e){F.Dom.removeClass(this.getRootContainer(),"--read-only");F.Dom.addClass(this.getRootContainer(),"--editable")}else{F.Dom.removeClass(this.getRootContainer(),"--editable");F.Dom.addClass(this.getRootContainer(),"--read-only")}this.emit("onEditable",{isEditable:e})})))}function kg(e){const t=In(e.map((e=>e.getName())).sort().join("-"));return String(t)}function Ug(){const e=new Map;for(const[,t]of babelHelpers.classPrivateFieldLooseBase(this,og)[og]){const s=t.importBBCode();if(s!==null){Object.keys(s).forEach((t=>{let i=e.get(t);if(i===undefined){i=[];e.set(t,i)}i.push(s[t])}))}}return e}function Wg(){const e=new Map;for(const[,t]of babelHelpers.classPrivateFieldLooseBase(this,og)[og]){const s=t.exportBBCode();if(s!==null){Object.keys(s).forEach((t=>{if(F.Type.isFunction(s[t])){e.set(t,s[t])}}))}}return e}function Yg(){const e=this.getPlugin("File");const t=e!=null&&e.isEnabled()?e.getMode():"none";return new n.DefaultBBCodeScheme({fileTag:t})}function zg(){babelHelpers.classPrivateFieldLooseBase(this,Lg)[Lg]=true;if(this.isEmpty()){babelHelpers.classPrivateFieldLooseBase(this,xg)[xg]("hide",false,true)}else{this.expand(false)}}function Xg(e="hide",t=true,s=false){if(!this.isCollapsingModeEnabled()){return}const i=babelHelpers.classPrivateFieldLooseBase(this,yg)[yg]===tg.COLLAPSED||babelHelpers.classPrivateFieldLooseBase(this,yg)[yg]===tg.COLLAPSING;const r=babelHelpers.classPrivateFieldLooseBase(this,yg)[yg]===tg.EXPANDED||babelHelpers.classPrivateFieldLooseBase(this,yg)[yg]===tg.EXPANDING;if(e==="hide"&&i||e==="show"&&r){return}if(t===false){if(i){babelHelpers.classPrivateFieldLooseBase(this,yg)[yg]=tg.EXPANDED;F.Dom.removeClass(this.getRootContainer(),"--collapsed");this.emit("onCollapsingToggle",{isOpen:true});this.focus()}else{babelHelpers.classPrivateFieldLooseBase(this,yg)[yg]=tg.COLLAPSED;F.Dom.addClass(this.getRootContainer(),"--collapsed");this.emit("onCollapsingToggle",{isOpen:false});this.clear();this.clearHistory();if(!s){this.blur()}}return}F.Event.unbind(this.getRootContainer(),"transitionend",babelHelpers.classPrivateFieldLooseBase(this,Fg)[Fg]);if(i){babelHelpers.classPrivateFieldLooseBase(this,yg)[yg]=tg.EXPANDING;this.blur();const e=this.getRootContainer().offsetHeight;F.Dom.removeClass(this.getRootContainer(),["--collapsed","--collapsing"]);F.Dom.style(this.getRootContainer(),{height:`${e}px`,overflow:"hidden"});F.Dom.style(this.getInnerContainer(),{opacity:0});requestAnimationFrame((()=>{F.Dom.addClass(this.getRootContainer(),"--expanding");F.Dom.style(this.getRootContainer(),{height:`${this.getRootContainer().scrollHeight}px`});F.Dom.style(this.getInnerContainer(),{opacity:1});this.emit("onCollapsingToggle",{isOpen:true})}))}else{babelHelpers.classPrivateFieldLooseBase(this,yg)[yg]=tg.COLLAPSING;const e=this.getRootContainer().offsetHeight;F.Dom.removeClass(this.getRootContainer(),["--expanding"]);F.Dom.style(this.getRootContainer(),{height:`${e}px`,overflow:"hidden"});F.Dom.style(this.getInnerContainer(),{opacity:1});this.blur();const t=this.getParagraphHeight();requestAnimationFrame((()=>{F.Dom.addClass(this.getRootContainer(),"--collapsing");F.Dom.style(this.getRootContainer(),{height:`${t}px`});F.Dom.style(this.getInnerContainer(),{opacity:0});this.emit("onCollapsingToggle",{isOpen:false})}))}F.Event.bind(this.getRootContainer(),"transitionend",babelHelpers.classPrivateFieldLooseBase(this,Fg)[Fg])}function Gg(){F.Event.unbind(this.getRootContainer(),"transitionend",babelHelpers.classPrivateFieldLooseBase(this,Fg)[Fg]);F.Dom.style(this.getRootContainer(),{height:null,overflow:null});F.Dom.style(this.getInnerContainer(),{opacity:null});F.Dom.removeClass(this.getRootContainer(),["--expanding","--collapsing"]);if(babelHelpers.classPrivateFieldLooseBase(this,yg)[yg]===tg.COLLAPSING){F.Dom.addClass(this.getRootContainer(),"--collapsed");babelHelpers.classPrivateFieldLooseBase(this,yg)[yg]=tg.COLLAPSED;this.clear();this.clearHistory();this.blur()}else{this.focus();babelHelpers.classPrivateFieldLooseBase(this,yg)[yg]=tg.EXPANDED}}const Vg={name:"TextEditorComponent",props:{editorOptions:{type:Object},editorInstance:{type:Ag,default:null},events:{type:Object,default:{}},editable:{type:Boolean,default:null}},setup(){return{editorClass:Ag}},provide(){return{editor:this.editor}},beforeCreate(){if(this.editorInstance===null){this.hasOwnEditor=true;const e=this.editorClass;this.editor=new e(this.editorOptions)}else{this.hasOwnEditor=false;this.editor=this.editorInstance}if(F.Type.isPlainObject(this.events)){for(const[e,t]of Object.entries(this.events)){this.editor.subscribe(e,t)}}},computed:{headerContainer(){return this.editor.getHeaderContainer()},footerContainer(){return this.editor.getFooterContainer()}},watch:{editable(e){this.editor.setEditable(e)}},mounted(){this.editor.renderTo(this.$refs.container,true)},unmounted(){if(this.hasOwnEditor){this.editor.destroy();this.editor=null}},template:`\n\t\t<div ref="container"></div>\n\t\t<Teleport :to="headerContainer">\n\t\t\t<slot name="header"></slot>\n\t\t</Teleport>\n\t\t<Teleport :to="footerContainer">\n\t\t\t<slot name="footer"></slot>\n\t\t</Teleport>\n\t`};class Jg extends Ag{static getDefaultOptions(){return{plugins:["RichText","Paragraph","Clipboard","Bold","Underline","Italic","Strikethrough","TabIndent","List","Mention","Link","AutoLink","Image","Copilot","History","BlockToolbar","FloatingToolbar","Toolbar","Placeholder","File"],toolbar:["bold","italic","underline","strikethrough","|","numbered-list","bulleted-list","|","link","copilot"],newLineMode:N.MIXED}}}const qg={name:"BasicEditorComponent",extends:Vg,setup(){return{editorClass:Jg}}};const Qg={Paragraph:Mt,AutoLink:eh,BlockToolbar:Ou,Bold:nd,Code:Fs,FloatingToolbar:mp,History:wb,Image:Ia,Italic:bd,Link:Mc,List:gh,Mention:qo,Quote:Se,Strikethrough:Pd,TabIndent:ah,Toolbar:Tp,Underline:Fd,Video:fn,Spoiler:ut,Smiley:gl,Table:jh,Hashtag:Gh,File:Br};const Zg={...T};const ev={..._};const tv={generateContent:Dn};e.TextEditor=Ag;e.BasicEditor=Jg;e.TextEditorComponent=Vg;e.BasicEditorComponent=qg;e.BasePlugin=ie;e.Button=ge;e.Plugins=Qg;e.Commands=Zg;e.Constants=ev;e.Debug=tv})(this.BX.UI.TextEditor=this.BX.UI.TextEditor||{},BX.UI.CodeParser,BX.UI.BBCode,BX.UI.TextEditor,BX.UI.Lexical.Clipboard,BX.UI.Smiley,BX.UI.VideoService,BX.Collections,BX.UI.BBCode,BX.UI.Lexical.Selection,BX.UI.Lexical.RichText,BX.UI.Lexical.Table,BX.Event,BX.UI.Lexical.History,BX.Main,BX.Cache,BX,BX.UI.Lexical.List,BX.UI.Lexical.Link,BX.UI.Lexical.Text,BX.UI.Lexical.Core,BX.UI.Lexical.Utils,BX);
