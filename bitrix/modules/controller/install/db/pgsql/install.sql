...
CREATE INDEX ix_b_controller_member_counters_updated ON b_controller_member(COUNTERS_UPDATED);
CREATE INDEX ix_b_controller_member_counter_last_auth ON b_controller_member(COUNTER_LAST_AUTH);
CREATE INDEX ix_b_controller_member_name ON b_controller_member(NAME);
CREATE INDEX ix_b_controller_member_url ON b_controller_member(URL);
