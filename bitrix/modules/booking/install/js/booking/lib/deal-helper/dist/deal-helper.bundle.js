...
(function (exports,main_core,main_sidepanel,booking_core,booking_const,booking_provider_service_bookingService) {
	...
	class DealHelper {
	  ...
	  openDeal() {
	    SidePanel.Instance.open(`/crm/deal/details/${babelHelpers.classPrivateFieldLooseBase(this, _deal)[_deal].value}/`, {
	      events: {
	        onClose: () => {
	  ...
	  createDeal() {
	    ...
	    ((_babelHelpers$classPr2 = (_babelHelpers$classPr3 = babelHelpers.classPrivateFieldLooseBase(this, _booking)[_booking]) == null ? void 0 : _babelHelpers$classPr3.clients) != null ? _babelHelpers$classPr2 : []).forEach(client => {
	      const paramName = {
	    ...
	    SidePanel.Instance.open(createDealUrl.toString(), {
	      events: {
	        ...
	        onClose: () => {
	          ...
	          if ((_babelHelpers$classPr4 = babelHelpers.classPrivateFieldLooseBase(this, _deal)[_deal]) != null && _babelHelpers$classPr4.value) {
	...
	function _get_deal() {
	  ...
	  return (_babelHelpers$classPr5 = (_babelHelpers$classPr6 = babelHelpers.classPrivateFieldLooseBase(this, _booking)[_booking]) == null ? void 0 : (_babelHelpers$classPr7 = _babelHelpers$classPr6.externalData) == null ? void 0 : _babelHelpers$classPr7.find(data => data.entityTypeId === booking_const.CrmEntity.Deal)) != null ? _babelHelpers$classPr5 : null;
	}
...
}((this.BX.Booking.Lib = this.BX.Booking.Lib || {}),BX,BX.SidePanel,BX.Booking,BX.Booking.Const,BX.Booking.Provider.Service));
