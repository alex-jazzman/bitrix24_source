...
$removeButton = new \Bitrix\UI\Buttons\Button(array(
    "text" => Loc::getMessage("HMS_CLINIC_BUTTON_DELETE"),
    "className" => "ui-btn-light-border",
    "click" => new \Bitrix\UI\Buttons\JsCode(
        'BX.MyWebstor.HMS.Clinic.Details.Instance.delete();'
    )
));

$docgenButton = new \Bitrix\UI\Buttons\Button(array(
    "text" => Loc::getMessage('HMS_CLINIC_BUTTON_COMMON_DOCUMENT'),
...
<script>
    BX.ready(function() {
        var clinicDetails = BX.MyWebstor.HMS.Clinic.Details.getInstance(
