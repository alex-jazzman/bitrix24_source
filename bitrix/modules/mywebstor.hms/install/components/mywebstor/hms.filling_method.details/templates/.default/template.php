...
$saveButton = new \Bitrix\UI\Buttons\Button(array(
    "text" => Loc::getMessage("HMS_FILLING_METHOD_BUTTON_SAVE"),
    "className" => "ui-btn-success",
    "click" => new \Bitrix\UI\Buttons\JsCode(
        'BX.MyWebstor.HMS.FillingMethod.save();'
    )
));
$deleteButton = new \Bitrix\UI\Buttons\Button(array(
    "text" => Loc::getMessage("HMS_FILLING_METHOD_BUTTON_DELETE"),
    "className" => "ui-btn-danger",
    "click" => new \Bitrix\UI\Buttons\JsCode(
        'BX.MyWebstor.HMS.FillingMethod.delete();'
    )
));
...
?>
<div id="filling-method-app"></div>
<script>
    addEventListener("load", () => {
        let fillingMethod = BX.MyWebstor.HMS.FillingMethod.create();
    });
</script>
