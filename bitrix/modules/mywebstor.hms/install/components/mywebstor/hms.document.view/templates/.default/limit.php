...
<div class="pagetitle-wrap">
	<div class="pagetitle-inner-container">
		<div class="pagetitle">
			<span id="pagetitle" class="pagetitle-item"><?=\Bitrix\Main\Localization\Loc::getMessage('HMS_DOCUMENT_LIMIT_TITLE');?></span>
		</div>
	</div>
</div>
<?}
...
{
	$APPLICATION->SetTitle(\Bitrix\Main\Localization\Loc::getMessage('HMS_DOCUMENT_LIMIT_TITLE'));
}?>
	...
	<div class="document-limit-inner">
		<div class="document-limit-desc">
			...
			<div class="document-limit-desc-text">
				<?=\Bitrix\Main\Localization\Loc::getMessage('HMS_DOCUMENT_LIMIT_TEXT_EXTENDED', ['#MAX#' => \Bitrix\DocumentGenerator\Integration\Bitrix24Manager::getDocumentsLimit()]);?>
			</div>
		</div>
