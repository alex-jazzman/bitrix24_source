 ...
 * @var \CUser $USER
 * @var \CDatabase $DB
 * @var \HmsVhiServiceTypeListComponent $component
...
$addButton = new \Bitrix\UI\Buttons\AddButton(array(
    "click" => new \Bitrix\UI\Buttons\JsCode(
        'BX.SidePanel.Instance.open("/hms/config/vhi/service_type/details/0/");'
    )
));
...
<script>
    BX.ready(function() {
        var vhiList = BX.MyWebstor.HMS.Vhi.ServiceType.List.getInstance(
            <?=
