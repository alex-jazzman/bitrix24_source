...
(function (exports,ui_designTokens,ui_notification,catalog_storeSelector,catalog_productCalculator,main_popup,main_core_events,catalog_storeUse,currency_currencyCore,catalog_productSelector,catalog_productModel,pull_client,main_core,spotlight,ui_tour) {
	'use strict';
	...
	var Row = /*#__PURE__*/function () {
	  function Row(_id, fields, settings, editor) {
	    ...
	    this.setModel(fields, settings, editor);
	  ...
	  babelHelpers.createClass(Row, [{
	    ...
	    value: function setModel() {
	      ...
	      if (selectorId) {
	        ...
	        if (model) {
              model.setOption("editor", this.getEditor());
	          this.model = model;
	        }
	      }
	      if (!this.model) {
	    ...
	    key: "setIsVhi",
	    value: function setIsVhi(value) {
	      this.setField('IS_VHI', value);
	      this.addActionProductChange();
	    }
	  }, {
	    key: "setTeeth",
	    value: function setTeeth(value) {
          if (typeof value !== "string") return;

	      this.setField('TEETH', value.split(",").map((toothNumber) => toothNumber.trim()).filter((toothNumber) => toothNumber));
	      this.addActionProductChange();
	    }
	  }, {
	    key: "setTaxIncluded",
	...
	var Editor = /*#__PURE__*/function () {
	  function Editor(id) {
	    ...
	    babelHelpers.defineProperty(this, "isVisibleGrid", true);
	    babelHelpers.defineProperty(this, "cache", new main_core.Cache.MemoryCache());
	...
	function _getAjaxFields() {
	  return ['ID', 'PRODUCT_ID', 'PRODUCT_NAME', 'IS_VHI', 'TEETH', 'QUANTITY', 'TAX_RATE', 'TAX_INCLUDED', 'PRICE_EXCLUSIVE', 'PRICE_NETTO', 'PRICE_BRUTTO', 'PRICE', 'CUSTOMIZED', 'BASE_PRICE', 'DISCOUNT_ROW', 'DISCOUNT_SUM', 'DISCOUNT_TYPE_ID', 'DISCOUNT_RATE', 'CURRENCY', 'STORE_ID', 'INPUT_RESERVE_QUANTITY', 'RESERVE_QUANTITY', 'DATE_RESERVE_END', 'SORT', 'MEASURE_CODE', 'MEASURE_NAME', 'TYPE'];
	}

	exports.Editor = Editor;
	exports.PageEventsManager = PageEventsManager;

}((this.BX.Crm.Entity.ProductList = this.BX.Crm.Entity.ProductList || {}),BX,BX,BX.Catalog,BX.Catalog,BX.Main,BX.Event,BX.Catalog.StoreUse,BX.Currency,BX.MyWebstor,BX.Catalog,BX,BX,BX,BX.UI.Tour));
