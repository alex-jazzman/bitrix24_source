 ...
 * @var \CUser $USER
 * @var \CDatabase $DB
 * @var \HmsClinicListComponent $component
...
$addButton = new \Bitrix\UI\Buttons\AddButton(array(
    "click" => new \Bitrix\UI\Buttons\JsCode(
        'BX.SidePanel.Instance.open("/hms/config/clinic/details/0/");'
    )
));
...
<script>
    BX.ready(function() {
        var clinicList = BX.MyWebstor.HMS.Clinic.List.getInstance("<?= $arResult["GRID_ID"] ?>");
    });
</script>
