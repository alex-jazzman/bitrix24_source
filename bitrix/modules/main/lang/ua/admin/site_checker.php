...
$MESS["SC_ERR_CONNECT_MAIL001"] = "Не вдалося підключитися до сервера mail-us.bitrix24.com";
$MESS["SC_ERR_DNS"] = "Не вдалося отримати MX запис для домену #DOMAIN#";
$MESS["SC_ERR_DNS_WRONG"] = "DNS налаштовано неправильно, повинен бути один MX запис: mail-us.bitrix24.com (налаштоване: #DOMAIN#).";
