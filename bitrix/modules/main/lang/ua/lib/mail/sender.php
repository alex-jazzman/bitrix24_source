...
$MESS["MAIN_SENDER_EMPTY_SMTP_PORT"] = "Уведіть порт SMTP-сервера.";
$MESS["MAIN_SENDER_EMPTY_SMTP_SERVER"] = "Уведіть адресу SMTP-сервера.";
$MESS["MAIN_SENDER_INVALID_SMTP_PASSWORD"] = "Пароль не може починатися із символу \"^\".";
$MESS["MAIN_SENDER_INVALID_SMTP_PORT"] = "Неприпустимий порт SMTP-сервера.";
$MESS["MAIN_SENDER_INVALID_SMTP_SERVER"] = "Неприпустима адреса SMTP-сервера.";
