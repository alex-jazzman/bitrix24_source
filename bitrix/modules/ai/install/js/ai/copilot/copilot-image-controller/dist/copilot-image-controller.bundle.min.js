this.BX=this.BX||{};(function(e,s,a,l,t,i,o,r,n){"use strict";class b{constructor(e){this.copilotImageController=e.copilotImageController}execute(){throw new Error("You must implement this method!")}}var c=babelHelpers.classPrivateFieldLooseKey("inputField");var d=babelHelpers.classPrivateFieldLooseKey("copilotContainer");class p extends b{constructor(e){super(e);Object.defineProperty(this,c,{writable:true,value:void 0});Object.defineProperty(this,d,{writable:true,value:void 0});babelHelpers.classPrivateFieldLooseBase(this,d)[d]=e.copilotContainer;babelHelpers.classPrivateFieldLooseBase(this,c)[c]=e.inputField}execute(){this.copilotImageController.emit("cancel");this.copilotImageController.destroyAllMenus();this.copilotImageController.showImageConfigurator();babelHelpers.classPrivateFieldLooseBase(this,c)[c].clearErrors();babelHelpers.classPrivateFieldLooseBase(this,c)[c].clear();babelHelpers.classPrivateFieldLooseBase(this,c)[c].enable();r.Dom.removeClass(babelHelpers.classPrivateFieldLooseBase(this,d)[d],"--error");babelHelpers.classPrivateFieldLooseBase(this,c)[c].focus();this.copilotImageController.getAnalytics().sendEventCancel()}}class v extends b{execute(){this.copilotImageController.emit("place-under")}}class u extends b{execute(){this.copilotImageController.emit("place-above")}}class P extends b{execute(){this.copilotImageController.emit("save",new i.BaseEvent({data:{imageUrl:this.copilotImageController.getResultImageUrl()}}));this.copilotImageController.getAnalytics().sendEventSave()}}class h extends b{execute(){this.copilotImageController.completions()}}class L{static getMenuItems(e){const s=e.copilotImageController;const a=e.inputField;const l=e.copilotContainer;return[{code:"repeat",text:r.Loc.getMessage("AI_COPILOT_COMMAND_REPEAT"),icon:"left-semicircular-anticlockwise-arrow-1",notHighlight:true,command:new h({copilotImageController:s})},{code:"cancel",text:r.Loc.getMessage("AI_COPILOT_COMMAND_CANCEL"),icon:"cross-45",notHighlight:true,command:new p({copilotImageController:s,inputField:a,copilotContainer:l})}]}}class F{static getMenuItems(e){const s=e==null?void 0:e.copilotImageController;const a=e.inputField;const l=e.useInsertAboveAndUnderMenuItems;return[{code:"save",text:r.Loc.getMessage("AI_COPILOT_IMAGE_RESULT_MENU_SAVE"),icon:n.Main.CHECK,notHighlight:true,command:new P({copilotImageController:s})},l?{code:"place_above",text:r.Loc.getMessage("AI_COPILOT_IMAGE_RESULT_MENU_PLACE_ABOVE_TEXT"),icon:n.Actions.ARROW_TOP,notHighlight:true,command:new u({copilotImageController:s})}:null,l?{code:"place_under",text:r.Loc.getMessage("AI_COPILOT_IMAGE_RESULT_MENU_PLACE_UNDER_TEXT"),icon:n.Actions.ARROW_DOWN,notHighlight:true,command:new v({copilotImageController:s})}:null,{code:"repeat",text:r.Loc.getMessage("AI_COPILOT_IMAGE_RESULT_MENU_REPEAT"),icon:n.Actions.LEFT_SEMICIRCULAR_ANTICLOCKWISE_ARROW_1,notHighlight:true,command:new h({copilotImageController:s})},{separator:true},{code:"cancel",text:r.Loc.getMessage("AI_COPILOT_IMAGE_RESULT_MENU_CANCEL"),icon:n.Actions.CROSS_45,notHighlight:true,command:new p({copilotImageController:s,inputField:a})}].filter((e=>Boolean(e)))}}let H=e=>e,g,B,m,f,y,_;const I=Object.freeze({select:"select"});var O=babelHelpers.classPrivateFieldLooseKey("mainStylesCount");var E=babelHelpers.classPrivateFieldLooseKey("currentMainStylesCount");var C=babelHelpers.classPrivateFieldLooseKey("selectedStyle");var w=babelHelpers.classPrivateFieldLooseKey("isExpanded");var A=babelHelpers.classPrivateFieldLooseKey("styleList");var T=babelHelpers.classPrivateFieldLooseKey("container");var j=babelHelpers.classPrivateFieldLooseKey("styles");var M=babelHelpers.classPrivateFieldLooseKey("renderHeader");var K=babelHelpers.classPrivateFieldLooseKey("isShowExpandBtn");var S=babelHelpers.classPrivateFieldLooseKey("renderExpandListBtn");var x=babelHelpers.classPrivateFieldLooseKey("renderStylesList");var R=babelHelpers.classPrivateFieldLooseKey("renderStyleItems");var N=babelHelpers.classPrivateFieldLooseKey("renderStyleItem");class $ extends i.EventEmitter{constructor(e){super(e);Object.defineProperty(this,N,{value:X});Object.defineProperty(this,R,{value:V});Object.defineProperty(this,x,{value:k});Object.defineProperty(this,S,{value:U});Object.defineProperty(this,K,{value:G});Object.defineProperty(this,M,{value:D});Object.defineProperty(this,O,{writable:true,value:0});Object.defineProperty(this,E,{writable:true,value:9});Object.defineProperty(this,C,{writable:true,value:null});Object.defineProperty(this,w,{writable:true,value:false});Object.defineProperty(this,A,{writable:true,value:null});Object.defineProperty(this,T,{writable:true,value:null});Object.defineProperty(this,j,{writable:true,value:void 0});babelHelpers.classPrivateFieldLooseBase(this,j)[j]=e.styles;babelHelpers.classPrivateFieldLooseBase(this,O)[O]=babelHelpers.classPrivateFieldLooseBase(this,j)[j].length;babelHelpers.classPrivateFieldLooseBase(this,C)[C]=babelHelpers.classPrivateFieldLooseBase(this,j)[j][0].code;this.setEventNamespace("AI.Copilot.ImageConfiguratorStyles")}getSelectedStyle(){return babelHelpers.classPrivateFieldLooseBase(this,C)[C]}render(){babelHelpers.classPrivateFieldLooseBase(this,T)[T]=r.Tag.render(g||(g=H`
		...
		`),r.Loc.getMessage("AI_COPILOT_IMAGE_POPULAR_STYLES"),r.Loc.getMessage("AI_COPILOT_IMAGE_POPULAR_STYLES"),e)}function G(){return babelHelpers.classPrivateFieldLooseBase(this,O)[O]>babelHelpers.classPrivateFieldLooseBase(this,E)[E]}function U(){const e=r.Tag.render(m||(m=H`
			<div
		...
		`),r.Loc.getMessage("AI_COPILOT_IMAGE_ALL_STYLES"),r.Loc.getMessage("AI_COPILOT_IMAGE_ALL_STYLES"));r.Event.bind(e,"click",(()=>{babelHelpers.classPrivateFieldLooseBase(this,w)[w]=!babelHelpers.classPrivateFieldLooseBase(this,w)[w];if(babelHelpers.classPrivateFieldLooseBase(this,w)[w]){r.Dom.addClass(babelHelpers.classPrivateFieldLooseBase(this,A)[A],"--expanded");babelHelpers.classPrivateFieldLooseBase(this,E)[E]=Object.values(babelHelpers.classPrivateFieldLooseBase(this,j)[j]).length;babelHelpers.classPrivateFieldLooseBase(this,A)[A].innerHTML="";babelHelpers.classPrivateFieldLooseBase(this,A)[A].append(...babelHelpers.classPrivateFieldLooseBase(this,R)[R]())}else{r.Dom.removeClass(babelHelpers.classPrivateFieldLooseBase(this,A)[A],"--expanded")}}));return e}function k(){babelHelpers.classPrivateFieldLooseBase(this,A)[A]=r.Tag.render(f||(f=H`
			<div class="ai__image-configurator-styles_list">
				${0}
			</div>
		`),babelHelpers.classPrivateFieldLooseBase(this,R)[R]());return babelHelpers.classPrivateFieldLooseBase(this,A)[A]}function V(){return babelHelpers.classPrivateFieldLooseBase(this,j)[j].slice(0,babelHelpers.classPrivateFieldLooseBase(this,E)[E]).map((e=>babelHelpers.classPrivateFieldLooseBase(this,N)[N](e)))}function X(e){const s=r.Tag.render(y||(y=H`
			<input
				${0}
				id="${0}"
		...
		`),babelHelpers.classPrivateFieldLooseBase(this,Ee)[Ee](),babelHelpers.classPrivateFieldLooseBase(this,Ce)[Ce]());return babelHelpers.classPrivateFieldLooseBase(this,_e)[_e]}}function Ae(){return babelHelpers.classPrivateFieldLooseBase(this,Ie)[Ie].render()}function Te(){return babelHelpers.classPrivateFieldLooseBase(this,Oe)[Oe].render()}let je=e=>e,Me,Ke,Se;const xe=Object.freeze({completions:"completions",back:"back",selectEngine:"selectEngine"});var Re=babelHelpers.classPrivateFieldLooseKey("bindElement");var Ne=babelHelpers.classPrivateFieldLooseKey("popup");var $e=babelHelpers.classPrivateFieldLooseKey("popupOffset");var De=babelHelpers.classPrivateFieldLooseKey("popupId");var Ge=babelHelpers.classPrivateFieldLooseKey("imageConfigurator");var Ue=babelHelpers.classPrivateFieldLooseKey("withoutBackBtn");var ke=babelHelpers.classPrivateFieldLooseKey("submitButton");var Ve=babelHelpers.classPrivateFieldLooseKey("loader");var Xe=babelHelpers.classPrivateFieldLooseKey("loaderOverlay");var We=babelHelpers.classPrivateFieldLooseKey("createPopup");var Ye=babelHelpers.classPrivateFieldLooseKey("renderPopupContent");var ze=babelHelpers.classPrivateFieldLooseKey("renderBackBtnIfNeeded");var qe=babelHelpers.classPrivateFieldLooseKey("initSubmitButton");class Je extends i.EventEmitter{constructor(e){super(e);Object.defineProperty(this,qe,{value:ss});Object.defineProperty(this,ze,{value:es});Object.defineProperty(this,Ye,{value:Ze});Object.defineProperty(this,We,{value:Qe});Object.defineProperty(this,Re,{writable:true,value:null});Object.defineProperty(this,Ne,{writable:true,value:null});Object.defineProperty(this,$e,{writable:true,value:void 0});Object.defineProperty(this,De,{writable:true,value:void 0});Object.defineProperty(this,Ge,{writable:true,value:void 0});Object.defineProperty(this,Ue,{writable:true,value:void 0});Object.defineProperty(this,ke,{writable:true,value:void 0});Object.defineProperty(this,Ve,{writable:true,value:void 0});Object.defineProperty(this,Xe,{writable:true,value:void 0});babelHelpers.classPrivateFieldLooseBase(this,De)[De]=e.popupId||String(Math.random());babelHelpers.classPrivateFieldLooseBase(this,Re)[Re]=e.bindElement;babelHelpers.classPrivateFieldLooseBase(this,$e)[$e]=e.popupOffset;babelHelpers.classPrivateFieldLooseBase(this,Ue)[Ue]=e.withoutBackBtn===true;babelHelpers.classPrivateFieldLooseBase(this,Ge)[Ge]=new we({formats:e.imageConfiguratorOptions.formats,styles:e.imageConfiguratorOptions.styles,engines:e.imageConfiguratorOptions.engines});babelHelpers.classPrivateFieldLooseBase(this,Ge)[Ge].subscribe("change-parameter",(e=>{const s=e.getData();if(s.parameter==="engine"){this.emit(xe.selectEngine,s.value)}}));babelHelpers.classPrivateFieldLooseBase(this,qe)[qe]();this.setEventNamespace("AI.Copilot:ImagePopup")}getPopupId(){return babelHelpers.classPrivateFieldLooseBase(this,De)[De]}getPopup(){return babelHelpers.classPrivateFieldLooseBase(this,Ne)[Ne]}show(){if(babelHelpers.classPrivateFieldLooseBase(this,Ne)[Ne]===null){babelHelpers.classPrivateFieldLooseBase(this,We)[We]()}babelHelpers.classPrivateFieldLooseBase(this,Ne)[Ne].show()}hide(){var e;(e=babelHelpers.classPrivateFieldLooseBase(this,Ne)[Ne])==null?void 0:e.close()}destroy(){var e;(e=babelHelpers.classPrivateFieldLooseBase(this,Ne)[Ne])==null?void 0:e.destroy();babelHelpers.classPrivateFieldLooseBase(this,Ne)[Ne]=null}isShown(){return babelHelpers.classPrivateFieldLooseBase(this,Ne)[Ne].isShown()}isContainsTarget(e){var s,a,l;return((s=babelHelpers.classPrivateFieldLooseBase(this,Ne)[Ne])==null?void 0:(a=s.getPopupContainer())==null?void 0:a.contains(e))||((l=babelHelpers.classPrivateFieldLooseBase(this,Ge)[Ge])==null?void 0:l.isContainsTarget(e))}adjustPosition(){var e;(e=babelHelpers.classPrivateFieldLooseBase(this,Ne)[Ne])==null?void 0:e.adjustPosition({forceBindPosition:true})}getImageConfiguration(){return babelHelpers.classPrivateFieldLooseBase(this,Ge)[Ge].getParams()}setFormats(e){babelHelpers.classPrivateFieldLooseBase(this,Ge)[Ge].setFormats(e)}setSelectedEngine(e){babelHelpers.classPrivateFieldLooseBase(this,Ge)[Ge].setSelectedEngine(e)}disableSubmitButton(){babelHelpers.classPrivateFieldLooseBase(this,ke)[ke].setDisabled(true)}enableSubmitButton(){babelHelpers.classPrivateFieldLooseBase(this,ke)[ke].setDisabled(false)}showLoader(){var e;babelHelpers.classPrivateFieldLooseBase(this,Xe)[Xe]=r.Tag.render(Me||(Me=je`
			<div class="ai__copilot-image-configurator-popup-loader-overlay"></div>
		`));r.Dom.append(babelHelpers.classPrivateFieldLooseBase(this,Xe)[Xe],(e=babelHelpers.classPrivateFieldLooseBase(this,Ne)[Ne])==null?void 0:e.getPopupContainer());babelHelpers.classPrivateFieldLooseBase(this,Ve)[Ve]=new l.Loader({size:110,color:getComputedStyle(document.body).getPropertyValue("--ui-color-copilot-primary"),target:babelHelpers.classPrivateFieldLooseBase(this,Xe)[Xe]});babelHelpers.classPrivateFieldLooseBase(this,Ve)[Ve].show(babelHelpers.classPrivateFieldLooseBase(this,Xe)[Xe])}hideLoader(){babelHelpers.classPrivateFieldLooseBase(this,Ve)[Ve].destroy();r.Dom.remove(babelHelpers.classPrivateFieldLooseBase(this,Xe)[Xe]);babelHelpers.classPrivateFieldLooseBase(this,Ve)[Ve]=null;babelHelpers.classPrivateFieldLooseBase(this,Xe)[Xe]=null}}function Qe(){var e,s;babelHelpers.classPrivateFieldLooseBase(this,Ne)[Ne]=new o.Popup({id:babelHelpers.classPrivateFieldLooseBase(this,De)[De],bindElement:babelHelpers.classPrivateFieldLooseBase(this,Re)[Re],cacheable:true,width:278,padding:0,content:babelHelpers.classPrivateFieldLooseBase(this,Ye)[Ye]()});babelHelpers.classPrivateFieldLooseBase(this,Ne)[Ne].setOffset({offsetTop:(e=babelHelpers.classPrivateFieldLooseBase(this,$e)[$e])==null?void 0:e.top,offsetLeft:(s=babelHelpers.classPrivateFieldLooseBase(this,$e)[$e])==null?void 0:s.left})}function Ze(){return r.Tag.render(Ke||(Ke=je`
