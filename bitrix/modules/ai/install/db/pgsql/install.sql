...
CREATE INDEX IF NOT EXISTS IX_B_CHAT_CODE ON b_ai_chatbot_chatbot (code);
...
CREATE UNIQUE INDEX IF NOT EXISTS IX_B_CHATBOT_ID_MESSAGE_ID ON b_ai_chatbot_chat (chatbot_id, code);
...
CREATE INDEX IF NOT EXISTS IX_B_CHATBOT_MESSAGE_CHAT_ID ON b_ai_chatbot_message (chat_id);
...
CREATE INDEX IF NOT EXISTS IX_B_CHATBOT_CHAT_ID_MESSAGE_ID ON b_ai_chatbot_message_unread (chat_id, message_id);
...
CREATE INDEX IF NOT EXISTS IX_B_AI_BITRIX_ENGINE_CLASS ON b_ai_bitrix_engine (CLASS);
