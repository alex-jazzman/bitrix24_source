...
(function (exports,main_core_events,ui_label,main_popup,main_loader,main_core,ui_analytics) {
	'use strict';

	var _templateObject, _templateObject2;
	var PopupCategoriesRenderer = /*#__PURE__*/function () {
	  function PopupCategoriesRenderer() {
	    babelHelpers.classCallCheck(this, PopupCategoriesRenderer);
	  }
	  babelHelpers.createClass(PopupCategoriesRenderer, [{
	    key: "render",
	    value: function render(list) {
	      var listElements = list.map(function (item) {
	        var label = new ui_label.Label({
	          text: item.name,
	          fill: true,
	          color: ui_label.Label.Color.LIGHT
	        });
	        return main_core.Tag.render(_templateObject || (_templateObject = babelHelpers.taggedTemplateLiteral(["<li>", "</li>"])), label.render());
	      });
	      return main_core.Tag.render(_templateObject2 || (_templateObject2 = babelHelpers.taggedTemplateLiteral(["<ul class=\"ai__categories-popup_list\">", "</ul>"])), listElements);
	    }
	  }]);
	  return PopupCategoriesRenderer;
	}();
	...
	function wrapTextToHtmlWithWordBreak(text) {
	  return main_core.Tag.render(_templateObject$1 || (_templateObject$1 = babelHelpers.taggedTemplateLiteral(["<span style=\"word-break: break-word;\">", "</span>"])), text);
	}
	...
	var SharesListRenderer = /*#__PURE__*/function (_ListRenderer) {
	  ...
	  babelHelpers.createClass(SharesListRenderer, [{
	    ...
	    value: function render(sharesList, searchValue) {
	      ...
	      return main_core.Tag.render(_templateObject2$1 || (_templateObject2$1 = babelHelpers.taggedTemplateLiteral(["<ul class=\"ai__prompt-library-grid-shares-popup_shares-list\">", "</ul>"])), itemsElements);
	    }
	  }]);
	...
	function _renderShareItemInitials2(title) {
	  ...
	  return main_core.Tag.render(_templateObject4 || (_templateObject4 = babelHelpers.taggedTemplateLiteral(["<span class=\"ai__prompt-library-grid-shares-popup_shares-list-item-initials\">", "</span>"])), initials);
	}
	...
	var Controller = /*#__PURE__*/function () {
	  ...
	  babelHelpers.createClass(Controller, null, [{
	    key: "fetchPromptCategories",
	    /**
	     * @var BX.Main.Grid
	     */
	    value: function () {
	      var _fetchPromptCategories = babelHelpers.asyncToGenerator( /*#__PURE__*/_regeneratorRuntime$1().mark(function _callee(promptCode) {
	        var data, res;
	        return _regeneratorRuntime$1().wrap(function _callee$(_context) {
	          while (1) switch (_context.prev = _context.next) {
	            case 0:
	              ...
	              _context.next = 4;
	              return main_core.ajax.runAction('ai.prompt.getCategoriesForPrompt', {
	                data: data
	              });
	            case 4:
	              res = _context.sent;
	      ...
	      function fetchPromptCategories(_x) {
	        return _fetchPromptCategories.apply(this, arguments);
	      }
	      return fetchPromptCategories;
	    }()
	  }, {
	    ...
	    key: "handleClickOnActivatePromptMenuItem",
	    value: function handleClickOnActivatePromptMenuItem(event, promptCode, promptName) {
	      event.preventDefault();
	      ...
	      _classStaticPrivateMethodGet(this, Controller, _sendRowAction).call(this, 'toggle-active', {
	        ...
	        showNotification(wrapTextToHtmlWithWordBreak(main_core.Loc.getMessage('PROMPT_LIBRARY_GRID_NOTIFICATION_ACTIVATE', {
	          '#NAME#': "<b>".concat(main_core.Text.encode(promptName), "</b>")
	        })));
	      });
	    }
	  }, {
	    key: "handleClickOnDeactivatePromptMenuItem",
	    value: function handleClickOnDeactivatePromptMenuItem(event, promptCode, promptName) {
	      event.preventDefault();
	      event.stopImmediatePropagation();
	      _classStaticPrivateMethodGet(this, Controller, _sendRowAction).call(this, 'toggle-active', {
	        promptCode: promptCode,
	    ...
	    value: function () {
	      var _handleClickOnSharesCell = babelHelpers.asyncToGenerator( /*#__PURE__*/_regeneratorRuntime$1().mark(function _callee2(sharePromptCode, event) {
	        ...
	        return _regeneratorRuntime$1().wrap(function _callee2$(_context2) {
	          while (1) switch (_context2.prev = _context2.next) {
	            ...
	            case 5:
	              ...
	              _context2.next = 13;
	              return main_core.ajax.runAction('ai.prompt.getShareForPrompt', {
	                data: formData
	              });
	            case 13:
	              res = _context2.sent;
	            ...
	            case 18:
	              ...
	              _context2.next = 23;
	              return showNotification(main_core.Loc.getMessage('PROMPT_LIBRARY_GRID_NOTIFICATION_SHOW_PROMPT_USERS_ERROR'));
	            case 23:
	              _classStaticPrivateFieldSpecGet(this, Controller, _allSharesListPopup).hide();
	            case 24:
	              _context2.prev = 24;
	        ...
	        }, _callee2, this, [[6, 18, 24, 27]]);
	      }));
	      function handleClickOnSharesCell(_x2, _x3) {
	        return _handleClickOnSharesCell.apply(this, arguments);
	      }
	      return handleClickOnSharesCell;
	    }()
	  }, {
	    key: "handleClickOnCategoriesCell",
	    value: function handleClickOnCategoriesCell(e, promptCode, excludedCategoryCode) {
	      e.preventDefault();
	      e.stopImmediatePropagation();
	      var target = e.target;
	      if (_classStaticPrivateFieldSpecGet(Controller, Controller, _categoriesListPopup)) {
	        _classStaticPrivateFieldSpecGet(Controller, Controller, _categoriesListPopup).hide();
	        return;
	      }
	      _classStaticPrivateFieldSpecSet(Controller, Controller, _categoriesListPopup, new PopupWithLoader({
	        bindElement: target,
	        listRenderer: new PopupCategoriesRenderer(),
	        events: {
	          onPopupDestroy: function onPopupDestroy() {
	            _classStaticPrivateFieldSpecSet(Controller, Controller, _categoriesListPopup, null);
	          }
	        }
	      }));
	      _classStaticPrivateFieldSpecGet(Controller, Controller, _categoriesListPopup).setLoading(true);
	      _classStaticPrivateFieldSpecGet(Controller, Controller, _categoriesListPopup).show();
	      Controller.fetchPromptCategories(promptCode).then(function (list) {
	        var excludedCategoryListItemIndex = list.findIndex(function (item) {
	          return item.code === excludedCategoryCode;
	        });
	        list.splice(excludedCategoryListItemIndex, 1);
	        _classStaticPrivateFieldSpecSet(Controller, Controller, _categoriesWithTranslate, list);
	        _classStaticPrivateFieldSpecGet(Controller, Controller, _categoriesListPopup).setLoading(false);
	        _classStaticPrivateFieldSpecGet(Controller, Controller, _categoriesListPopup).setList(_classStaticPrivateFieldSpecGet(Controller, Controller, _categoriesWithTranslate));
	      })["catch"](function (err) {
	        console.error(err);
	        _classStaticPrivateFieldSpecGet(Controller, Controller, _categoriesListPopup).setLoading(false);
	        _classStaticPrivateFieldSpecGet(Controller, Controller, _categoriesListPopup).setList([]);
	      });
	      _classStaticPrivateFieldSpecGet(Controller, Controller, _categoriesListPopup).show();
	    }
	  }, {
	    key: "handleClickOnPromptName",
	    value: function () {
	      var _handleClickOnPromptName = babelHelpers.asyncToGenerator( /*#__PURE__*/_regeneratorRuntime$1().mark(function _callee3(event, promptCode) {
	      ...
	      function handleClickOnPromptName(_x4, _x5) {
	        return _handleClickOnPromptName.apply(this, arguments);
	      }
	      return handleClickOnPromptName;
	    }()
	  }, {
	    key: "editPrompt",
	    value: function () {
	      var _editPrompt = babelHelpers.asyncToGenerator( /*#__PURE__*/_regeneratorRuntime$1().mark(function _callee4(promptCode) {
	        var formData, fetchPromptByCodePromise, loadPromptMasterExtensionPromise, results, res, PromptMasterPopup, PromptMasterPopupEvents, prompt, options, popup;
	        return _regeneratorRuntime$1().wrap(function _callee4$(_context4) {
	          while (1) switch (_context4.prev = _context4.next) {
	            case 0:
	              ...
	              fetchPromptByCodePromise = main_core.ajax.runAction('ai.prompt.getPromptByCodeForUpdate', {
	                method: 'POST',
	                data: formData
	              });
	              loadPromptMasterExtensionPromise = main_core.Runtime.loadExtension('ai.prompt-master');
	              _context4.prev = 6;
	              _context4.next = 9;
	              return Promise.all([fetchPromptByCodePromise, loadPromptMasterExtensionPromise]);
	            case 9:
	              results = _context4.sent;
	              res = results[0];
	              PromptMasterPopup = results[1].PromptMasterPopup;
	              PromptMasterPopupEvents = results[1].PromptMasterPopupEvents;
	              ...
	              popup = new PromptMasterPopup(_objectSpread$1(_objectSpread$1({}, options), {}, {
	                popupEvents: {
	                  onPopupDestroy: function onPopupDestroy() {
	                    popup.unsubscribe(PromptMasterPopupEvents.SAVE_SUCCESS, _classStaticPrivateFieldSpecGet(Controller, Controller, _promptSuccessSavingEventHandler));
	                  }
	                },
	                analyticFields: {
	                  c_section: 'list'
	              ...
	              _classStaticPrivateFieldSpecSet(Controller, Controller, _promptSuccessSavingEventHandler, _classStaticPrivateMethodGet(Controller, Controller, _handlePromptSuccessSaving).bind(Controller));
	              popup.subscribe(PromptMasterPopupEvents.SAVE_SUCCESS, _classStaticPrivateFieldSpecGet(Controller, Controller, _promptSuccessSavingEventHandler));
	              popup.show();
	              _context4.next = 25;
	              break;
	            case 21:
	        ...
	        }, _callee4, this, [[6, 21, 25, 29]]);
	      }));
	      function editPrompt(_x6) {
	        return _editPrompt.apply(this, arguments);
	      }
	      return editPrompt;
	    }()
	  }, {
	    key: "handleClickOnCreatePromptButton",
	    value: function () {
	      var _handleClickOnCreatePromptButton = babelHelpers.asyncToGenerator( /*#__PURE__*/_regeneratorRuntime$1().mark(function _callee5(button) {
	        var _yield$Runtime$loadEx, PromptMasterPopup, PromptMasterPopupEvents, popup;
	        return _regeneratorRuntime$1().wrap(function _callee5$(_context5) {
	          while (1) switch (_context5.prev = _context5.next) {
	            case 0:
	              ...
	              _context5.next = 4;
	              return main_core.Runtime.loadExtension('ai.prompt-master');
	            case 4:
	              _yield$Runtime$loadEx = _context5.sent;
	              PromptMasterPopup = _yield$Runtime$loadEx.PromptMasterPopup;
	              PromptMasterPopupEvents = _yield$Runtime$loadEx.PromptMasterPopupEvents;
	              popup = new PromptMasterPopup({
	                popupEvents: {
	                  onPopupDestroy: function onPopupDestroy() {
	                    popup.unsubscribe(PromptMasterPopupEvents.SAVE_SUCCESS, _classStaticPrivateFieldSpecGet(Controller, Controller, _promptSuccessSavingEventHandler));
	                  }
	      ...
	      function handleClickOnCreatePromptButton(_x7) {
	        return _handleClickOnCreatePromptButton.apply(this, arguments);
	      }
	      return handleClickOnCreatePromptButton;
	    }()
	  }, {
	    key: "handleClickOnPromptIsFavouriteLabel",
	    value: function handleClickOnPromptIsFavouriteLabel(event, promptCode, favourite, promptName) {
	      event.preventDefault();
	      event.stopImmediatePropagation();
	      _classStaticPrivateMethodGet(this, Controller, _sendRowAction).call(this, 'toggle-favourite', {
	        ...
	        var message = favourite === 'true' ? wrapTextToHtmlWithWordBreak(main_core.Loc.getMessage('PROMPT_LIBRARY_GRID_NOTIFICATION_FAVOURITE_ADD', {
	          '#NAME#': "<b>".concat(main_core.Text.encode(promptName), "</b>")
	    ...
	    key: "togglePromptFavourite",
	    value: function togglePromptFavourite(promptCode, favourite, promptName) {
	      _classStaticPrivateMethodGet(this, Controller, _sendRowAction).call(this, 'toggle-favourite', {
	        promptCode: promptCode,
	        favourite: favourite,
	        page: _classStaticPrivateMethodGet(this, Controller, _getCurrentPage).call(this)
	    ...
	    value: function applyMultipleAction() {
	      ...
	      _classStaticPrivateMethodGet(this, Controller, _sendRowAction).call(this, actionWithoutQuotes, {
	        selectedSharePromptsCodes: _classStaticPrivateFieldSpecGet(this, Controller, _grid).getRows().getSelectedIds(),
	        page: _classStaticPrivateMethodGet(this, Controller, _getCurrentPage).call(this)
	      }, function () {
	        showNotification(message);
	      });
	...
	function _handlePromptSuccessSaving(event) {
	  _classStaticPrivateMethodGet(this, Controller, _sendRowAction).call(this, 'edit-prompt', {
	    page: _classStaticPrivateMethodGet(this, Controller, _getCurrentPage).call(this)
	  }, function () {
	    showNotification(main_core.Loc.getMessage('PROMPT_LIBRARY_GRID_NOTIFICATION_PROMPT_SAVE_SUCCESS', {
	      '#NAME#': "<b>".concat(main_core.Text.encode(event.getData().promptTitle), "</b>")
	    }));
	  });
	}
	...
	function _showSimpleTour3() {
	  _showSimpleTour3 = babelHelpers.asyncToGenerator( /*#__PURE__*/_regeneratorRuntime$1().mark(function _callee6() {
	...
	var _categoriesWithTranslate = {
	  writable: true,
	  value: []
	};
	var _promptSuccessSavingEventHandler = {
	  writable: true,
	  value: null
	};
...
}((this.BX.AI.SharePrompt.Library = this.BX.AI.SharePrompt.Library || {}),BX.Event,BX.UI,BX.Main,BX,BX,BX.UI.Analytics));
