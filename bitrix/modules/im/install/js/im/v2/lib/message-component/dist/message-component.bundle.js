...
(function (exports,im_v2_lib_utils,im_v2_application_core,im_v2_const,im_v2_lib_smileManager,imopenlines_v2_lib_openlines) {
	...
	class MessageComponentManager {
	  ...
	  getName() {
	    ...
	    if (babelHelpers.classPrivateFieldLooseBase(this, _hasSticker)[_hasSticker]()) {
	...
	function _hasSticker2() {
	  return babelHelpers.classPrivateFieldLooseBase(this, _store)[_store].getters['stickers/messages/isSticker'](babelHelpers.classPrivateFieldLooseBase(this, _message)[_message].id);
	}
