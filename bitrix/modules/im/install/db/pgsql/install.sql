...
CREATE UNIQUE INDEX ux_b_im_sharing_link_code ON b_im_sharing_link (CODE);
CREATE INDEX ix_b_im_sharing_link_entity_id_entity_type ON b_im_sharing_link (ENTITY_ID, ENTITY_TYPE);
...
CREATE INDEX ix_b_im_sticker_pack_id ON b_im_sticker (pack_id);
...
CREATE INDEX ix_b_im_sticker_pack_author_id ON b_im_sticker_pack (author_id);
...
CREATE UNIQUE INDEX ux_b_im_sticker_user_pack_user_id_pack_id ON b_im_sticker_user_pack (user_id, pack_id);
CREATE INDEX ix_b_im_sticker_user_pack_pack_id ON b_im_sticker_user_pack (pack_id);
