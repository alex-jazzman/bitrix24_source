/**
 * @module im/messenger/controller/recent/service/server-load/task
 */
jn.define('im/messenger/controller/recent/service/server-load/task', (require, exports, module) => {
