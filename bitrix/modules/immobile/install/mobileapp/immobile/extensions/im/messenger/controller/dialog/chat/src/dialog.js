...
jn.define('im/messenger/controller/dialog/chat/dialog', (require, exports, module) => {
	...
	class Dialog
	{
		...
		closeDialogHandler({ dialogId })
		{
			...
			{
				this.sendAnalyticsTurnOffReasoning();
				this.view.back();
		...
		async redrawMessage({ payload } = {})
		{
			...
			await this.messageRenderer.render(this.normalizeVideoNotePlayingState(filteredValidateQuoteMessages));
		}
