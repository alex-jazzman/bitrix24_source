<?php
$MESS["CRM_CDA_DESC"] = "Створити довільний смарт-процес";
$MESS["CRM_CDA_DESC_1"] = "Створити елемент CRM";
$MESS["CRM_CDA_DESC_2"] = "Створює новий елемент CRM і заповнює в ньому потрібні поля.";
$MESS["CRM_CDA_NAME"] = "Створити смарт-процес";
