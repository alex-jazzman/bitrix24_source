...
$MESS['CRMBPGQR_DESCR_DESCR_1'] = 'Создаёт персонализированные QR-коды под любые маркетинговые задачи, например, для удобства регистрации на мероприятие. Вспомогательный робот';
