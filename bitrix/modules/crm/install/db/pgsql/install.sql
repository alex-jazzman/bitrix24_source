...
CREATE TABLE b_crm_deal (
  ...
  STAGE_SEMANTIC_ID varchar(3) NOT NULL DEFAULT 'P',
  IS_NEW char(1),
...
CREATE INDEX ix_b_crm_deal_begindate_stage_semantic_id ON b_crm_deal (begindate, stage_semantic_id);
...
CREATE INDEX ix_b_crm_role_group_code ON b_crm_role (group_code);
...
CREATE INDEX ix_b_crm_act_created ON b_crm_act (created);
...
CREATE INDEX ix_b_crm_quote_date_create ON b_crm_quote (date_create);
...
CREATE INDEX ix_b_crm_deal_stage_history_created_time ON b_crm_deal_stage_history (created_time);
...
CREATE INDEX ix_b_crm_deal_stage_history_with_supposed_owner_id_created_time ON b_crm_deal_stage_history_with_supposed (owner_id, created_time);
...
CREATE INDEX ix_b_crm_lead_status_history_with_supposed_owner_id_created_tim ON b_crm_lead_status_history_with_supposed (owner_id, created_time);
...
CREATE INDEX ix_b_crm_dynamic_type_created_time ON b_crm_dynamic_type (created_time);
...
CREATE TABLE IF NOT EXISTS b_crm_entity_stage_history (
  ID int8 GENERATED BY DEFAULT AS IDENTITY NOT NULL,
  TYPE_ID int NOT NULL,
  OWNER_TYPE_ID int NOT NULL,
  OWNER_ID int NOT NULL,
...
CREATE INDEX ix_b_crm_entity_stage_history_owner_type_id_owner_id ON b_crm_entity_stage_history (owner_type_id, owner_id);
CREATE INDEX ix_b_crm_entity_stage_history_owner_type_id_created_time ON b_crm_entity_stage_history (owner_type_id, created_time);
CREATE INDEX ix_b_crm_entity_stage_history_created_time ON b_crm_entity_stage_history (created_time);

CREATE TABLE IF NOT EXISTS b_crm_entity_stage_history_with_supposed (
  ID int8 GENERATED BY DEFAULT AS IDENTITY NOT NULL,
  OWNER_TYPE_ID int NOT NULL,
  OWNER_ID int NOT NULL,
  CREATED_TIME timestamp,
...
CREATE INDEX ix_b_crm_entity_stage_history_with_supposed_owner_type_id_owner ON b_crm_entity_stage_history_with_supposed (owner_type_id, owner_id, created_time);
...
CREATE INDEX ix_b_crm_item_badge_created_date ON b_crm_item_badge (created_date);
...
CREATE INDEX ix_b_crm_ai_quality_assessment_created_at ON b_crm_ai_quality_assessment (created_at);
...
CREATE TABLE IF NOT EXISTS b_crm_repeat_sale_segment (
  ...
  ASSIGNMENT_TYPE_ID smallint NOT NULL DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS b_crm_repeat_sale_ai_screening (
  ID int GENERATED BY DEFAULT AS IDENTITY NOT NULL,
  OWNER_TYPE_ID int NOT NULL,
  OWNER_ID int NOT NULL,
  ...
  PARAMS text,
  RESULT_ENTITY_TYPE_ID int,
  RESULT_ENTITY_ID int,
  CREATED_AT timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  UPDATED_AT timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (ID)
);
CREATE UNIQUE INDEX ux_b_crm_repeat_sale_ai_screening_owner_id_owner_type_id_segmen ON b_crm_repeat_sale_ai_screening (owner_id, owner_type_id, segment_id);
...
CREATE TABLE b_crm_last_communication (
  ID int GENERATED BY DEFAULT AS IDENTITY NOT NULL,
  ENTITY_TYPE_ID int NOT NULL,
  ENTITY_ID int NOT NULL,
  LAST_COMMUNICATION_TIME timestamp NOT NULL,
  TYPE varchar(64) NOT NULL,
  ACTIVITY_ID int,
  PRIMARY KEY (ID)
);
CREATE UNIQUE INDEX ux_b_crm_last_communication_entity_type_id_entity_id_type ON b_crm_last_communication (entity_type_id, entity_id, type);
CREATE INDEX ix_b_crm_last_communication_activity_id ON b_crm_last_communication (activity_id);

CREATE TABLE b_crm_dynamic_recurring (
  ID int GENERATED BY DEFAULT AS IDENTITY NOT NULL,
  ENTITY_TYPE_ID int NOT NULL,
  ITEM_ID int NOT NULL,
  BASED_ID int,
...
CREATE INDEX ix_b_crm_dynamic_recurring_entity_type_id_item_id ON b_crm_dynamic_recurring (entity_type_id, item_id);
CREATE INDEX ix_b_crm_dynamic_recurring_based_id ON b_crm_dynamic_recurring (based_id);
CREATE INDEX ix_b_crm_dynamic_recurring_next_execution ON b_crm_dynamic_recurring (next_execution);
CREATE INDEX ix_b_crm_dynamic_recurring_last_execution ON b_crm_dynamic_recurring (last_execution);
CREATE INDEX ix_b_crm_dynamic_recurring_limit_date ON b_crm_dynamic_recurring (limit_date);
CREATE INDEX ix_b_crm_dynamic_recurring_start_date ON b_crm_dynamic_recurring (start_date);

CREATE TABLE b_crm_documentgenerator_template_custom_field (
  ID int GENERATED BY DEFAULT AS IDENTITY NOT NULL,
  TEMPLATE_ID int NOT NULL,
...
CREATE INDEX ix_b_crm_documentgenerator_template_custom_field_field_uid ON b_crm_documentgenerator_template_custom_field (field_uid);
CREATE UNIQUE INDEX ux_b_crm_documentgenerator_template_custom_field_template_id_fi ON b_crm_documentgenerator_template_custom_field (template_id, field_uid);

CREATE TABLE IF NOT EXISTS b_crm_dynamic_recurring_document (
  ID int GENERATED BY DEFAULT AS IDENTITY NOT NULL,
  ENTITY_TYPE_ID int NOT NULL,
  ENTITY_ID int NOT NULL,
...
CREATE UNIQUE INDEX ux_b_crm_dynamic_recurring_document_document_id ON b_crm_dynamic_recurring_document (document_id);

CREATE TABLE IF NOT EXISTS b_crm_entity_perms_notification (
  ID int GENERATED BY DEFAULT AS IDENTITY NOT NULL,
  AUTOMATED_SOLUTION_ID int NOT NULL DEFAULT 0,
  ENTITY_TYPE_ID int NOT NULL,
  USER_ID int NOT NULL,
  PERM_TYPE varchar(20) NOT NULL,
  PRIMARY KEY (ID)
);
CREATE INDEX ix_b_crm_entity_perms_notification_automated_solution_id_user_i ON b_crm_entity_perms_notification (automated_solution_id, user_id, perm_type);

CREATE TABLE IF NOT EXISTS b_crm_dp_mhdc (
  DATASET_ID varchar(32) NOT NULL,
  DATASET_TS timestamp NOT NULL,
  RN int8 NOT NULL,
  MATCH_HASH varchar(32) NOT NULL,
  QTY int8 NOT NULL,
  PRIMARY KEY (DATASET_ID, DATASET_TS, RN)
);
CREATE INDEX ix_b_crm_dp_mhdc_dataset_ts ON b_crm_dp_mhdc (dataset_ts);

CREATE TABLE IF NOT EXISTS b_crm_act_mail_body_bind (
  ID int GENERATED BY DEFAULT AS IDENTITY NOT NULL,
...
CREATE INDEX ix_b_crm_act_mail_body_bind_body_id ON b_crm_act_mail_body_bind (body_id);
CREATE INDEX ix_b_crm_act_mail_body_bind_owner_id_owner_type_id ON b_crm_act_mail_body_bind (owner_id, owner_type_id);
