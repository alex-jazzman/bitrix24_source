...
(
	...
	OPPORTUNITY DECIMAL(26,8) DEFAULT NULL,
	IS_MANUAL_OPPORTUNITY CHAR(1) DEFAULT 'N',
	TAX_VALUE DECIMAL(26,8) DEFAULT NULL,
	CURRENCY_ID VARCHAR (50) DEFAULT NULL,
	OPPORTUNITY_ACCOUNT DECIMAL(26,8) DEFAULT NULL,
	TAX_VALUE_ACCOUNT DECIMAL(26,8) DEFAULT NULL,
	ACCOUNT_CURRENCY_ID VARCHAR (50) DEFAULT NULL,
	...
	EXCH_RATE DECIMAL(26,8) DEFAULT 1,
	...
	INDEX IX_DEAL_36 (BEGINDATE, STAGE_SEMANTIC_ID),
...
(
	...
	PRIMARY KEY (ID),
	INDEX ix_b_crm_role_group_code(GROUP_CODE)
);
...
(
	...
	PRICE DECIMAL(26,8) NOT NULL DEFAULT 0,
	ORIGINATOR_ID VARCHAR(255) NULL,
	ORIGIN_ID VARCHAR(255) NULL,
	PRIMARY KEY(ID)
);
...
(
	...
	PRICE_ACCOUNT DECIMAL(26,8) NOT NULL DEFAULT 0,
	PRICE_EXCLUSIVE DECIMAL(26,8) NULL,
	PRICE_NETTO DECIMAL(26,8) NULL,
	PRICE_BRUTTO DECIMAL(26,8) NULL,
	QUANTITY DECIMAL(18,4) NOT NULL,
	DISCOUNT_TYPE_ID TINYINT(1) UNSIGNED NULL,
	DISCOUNT_RATE DECIMAL(18,4) NULL,
	DISCOUNT_SUM DECIMAL(26,8) NULL,
...
CREATE TABLE IF NOT EXISTS b_crm_deal_stage_history(
	...
	INDEX IX_B_CRM_DEAL_SHX_17(CREATED_TIME)
);
...
CREATE TABLE IF NOT EXISTS b_crm_deal_stage_history_with_supposed (
	...
	INDEX IX_B_CRM_HISTORY_WITH_SUPPOSED_4 (OWNER_ID, CREATED_TIME)
);
...
CREATE TABLE IF NOT EXISTS b_crm_lead_status_history_with_supposed(
	...
	INDEX IX_B_CRM_LEAD_STATUS_HISTORY_WITH_SUPPOSED_4 (OWNER_ID, CREATED_TIME)
);
...
CREATE TABLE IF NOT EXISTS `b_crm_dynamic_type` (
  ...
  INDEX IX_B_CRM_TYPE_CREATED_TIME(CREATED_TIME),
...
CREATE TABLE IF NOT EXISTS b_crm_entity_stage_history(
	...
	IS_LOST CHAR(1) NULL,
	PRIMARY KEY(ID),
	INDEX ix_b_crm_entity_stage_history_owner_type_id_owner_id(OWNER_TYPE_ID, OWNER_ID),
	INDEX IX_B_CRM_ENTITY_STAGE_HISTORY_1(OWNER_TYPE_ID, CREATED_TIME),
	INDEX IX_B_CRM_ENTITY_STAGE_HISTORY_2(CREATED_TIME)
);
...
CREATE TABLE IF NOT EXISTS b_crm_entity_stage_history_with_supposed (
	...
	SPENT_TIME INT NULL,
	PRIMARY KEY (ID),
	INDEX ix_b_crm_entity_stage_history_with_supposed_2(OWNER_TYPE_ID, OWNER_ID, CREATED_TIME)
);
...
CREATE TABLE IF NOT EXISTS b_crm_item_badge(
	...
	INDEX IX_B_CRM_ITEM_BADGE_3 (CREATED_DATE)
);
...
(
	...
	INDEX IX_CRM_AI_QA_CREATED_AT(CREATED_AT)
);
...
CREATE TABLE IF NOT EXISTS b_crm_automated_solution (
	...
	TITLE VARCHAR(255) NOT NULL,
	CODE VARCHAR(255) NOT NULL,
	SOURCE_ID TINYINT NOT NULL DEFAULT 0,
	SORT INT NOT NULL,
	CREATED_TIME DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
	UPDATED_TIME  DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS b_crm_repeat_sale_segment (
	...
	ASSIGNMENT_TYPE_ID TINYINT NOT NULL DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS b_crm_repeat_sale_ai_screening (
	...
	UPDATED_AT DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
	PRIMARY KEY (ID),
	UNIQUE KEY IX_B_CRM_REPEAT_SALE_AI_SCREENING_OI_OTI_SI(OWNER_ID, OWNER_TYPE_ID, SEGMENT_ID)
);
...
(
	...
	`ACTIVITY_ID` INT,
	PRIMARY KEY (ID),
	UNIQUE ux_b_crm_last_communication_entity_type_id_entity_id_type (`ENTITY_TYPE_ID`, `ENTITY_ID`, `TYPE`),
	INDEX ix_b_crm_last_communication_activity_id (`ACTIVITY_ID`)
);
...
CREATE TABLE b_crm_dynamic_recurring (
	...
	UPDATED_BY_ID INT NOT NULL DEFAULT 0,
	PRIMARY KEY (ID),
	KEY IX_B_CRM_DYNAMIC_RECURRING_ETI_II (ENTITY_TYPE_ID, ITEM_ID),
	KEY IX_B_CRM_DYNAMIC_RECURRING_BI (BASED_ID),
	KEY IX_B_CRM_DYNAMIC_RECURRING_NE (NEXT_EXECUTION),
	KEY IX_B_CRM_DYNAMIC_RECURRING_LE (LAST_EXECUTION),
	KEY IX_B_CRM_DYNAMIC_RECURRING_LD (LIMIT_DATE),
	KEY IX_B_CRM_DYNAMIC_RECURRING_SD (START_DATE)
);
...
(
	...
	UPDATED_AT DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
	PRIMARY KEY (ID),
	KEY IX_B_CRM_DG_TPL_CF_FIELD_UID (FIELD_UID),
	UNIQUE KEY IX_B_CRM_DG_TPL_CF_TEMPLATE_FIELD (TEMPLATE_ID, FIELD_UID)
);
...
CREATE TABLE IF NOT EXISTS b_crm_dynamic_recurring_document (
	...
	PRIMARY KEY(ID),
	UNIQUE KEY IX_B_CRM_DYNAMIC_RECURRING_DOCUMENT_DI (DOCUMENT_ID)
);
...
CREATE TABLE IF NOT EXISTS b_crm_entity_perms_notification (
	...
	PERM_TYPE VARCHAR(20) NOT NULL,
	PRIMARY KEY (ID),
	KEY IX_B_CRM_ENTITY_PERMS_NOTIFICATION_ASI_UD_PT (AUTOMATED_SOLUTION_ID, USER_ID, PERM_TYPE)
);

CREATE TABLE IF NOT EXISTS b_crm_dp_mhdc (
	DATASET_ID VARCHAR(32) NOT NULL,
	DATASET_TS DATETIME NOT NULL,
	RN INT(1) UNSIGNED NOT NULL,
	MATCH_HASH VARCHAR(32) NOT NULL,
	QTY INT(1) UNSIGNED NOT NULL,
	PRIMARY KEY (DATASET_ID, DATASET_TS, RN),
	KEY IX_B_CRM_DP_MHDC_DATASET_TS (DATASET_TS)
);
...
CREATE TABLE IF NOT EXISTS b_crm_act_mail_body_bind (
	...
	OWNER_ID INT NOT NULL,
	PRIMARY KEY (ID),
	KEY IX_B_CRM_ACT_MAIL_BODY_BIND_1 (BODY_ID),
	KEY IX_B_CRM_ACT_MAIL_BODY_BIND_2 (OWNER_ID, OWNER_TYPE_ID)
);
