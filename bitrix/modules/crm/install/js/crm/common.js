...
BX.Crm.Page =
{
	sliders:
	{
		...
		leadAutomation: { condition: new RegExp("/crm/lead/automation/[0-9]+/", "i"), stopParameters: ['id', 'grid_action', 'page'], options: { customLeftBoundary: 0 }},
		leadElementAutomation: { condition: new RegExp("/crm/lead/automation/[0-9]+/", "i"), stopParameters: ['grid_action', 'page']},
		...
		dealAutomation: { condition: new RegExp("/crm/deal/automation/[0-9]+/", "i"), stopParameters: ['id', 'grid_action', 'page'], options: { customLeftBoundary: 0 } },
		dealElementAutomation: { condition: new RegExp("/crm/deal/automation/[0-9]+/", "i"), stopParameters: ['grid_action', 'page']},
		...
		orderAutomation: { condition: new RegExp("/shop/orders/automation/[0-9]+/", "i"), stopParameters: ['id', 'grid_action', 'page'], options: { customLeftBoundary: 0 } },
