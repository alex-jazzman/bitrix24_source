...
(function (exports,main_core,ui_sidepanel_layout) {
	...
	var Captcha = /*#__PURE__*/function () {
	  babelHelpers.createClass(Captcha, null, [{
	    key: "open",
	    value: function open() {
	      var type = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : GOOGLE_CAPTCHA_SERVICE;
	      var resolver = null;
	      var promise = new Promise(function (resolve) {
	        resolver = resolve;
	      });
	      var instance = new Captcha(type);
