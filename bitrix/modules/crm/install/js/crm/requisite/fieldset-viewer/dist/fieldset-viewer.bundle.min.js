this.BX=this.BX||{};this.BX.Crm=this.BX.Crm||{};(function(e,t,i,s,n,r,o){"use strict";let a=e=>e,l,d,c,u,h,E,v,g;class I extends i.EventEmitter{constructor(e={}){super();this.cache=new t.Cache.MemoryCache;this.setEventNamespace("BX.Crm.Requisite.FieldsetViewer");this.subscribeFromOptions((e==null?void 0:e.events)||{});this.setOptions(e);t.Event.bind(e.bindElement,"click",this.onBindElementClick.bind(this))}setData(e){this.cache.set("data",e)}getData(){return this.cache.get("data",{})}load(){return new Promise((e=>{const{entityTypeId:t,entityId:i}=this.getOptions();BX.ajax.runAction("crm.api.fieldset.load",{json:{entityTypeId:t,entityId:i}}).then((t=>{e(t.data)}))}))}setOptions(e){this.cache.set("options",{...e})}getOptions(){return this.cache.get("options")}getPopup(){return this.cache.remember("popup",(()=>{const e=this.getOptions();return new s.Popup({bindElement:e.bindElement,autoHide:false,width:570,height:478,className:"crm-requisite-fieldset-viewer",noAllPaddings:true,...t.Type.isPlainObject(e==null?void 0:e.popupOptions)?e==null?void 0:e.popupOptions:{},events:{onClose:()=>{this.emit("onClose",{changed:this.getIsChanged()});this.setIsChanged(false)}}})}))}setIsChanged(e){this.cache.set("isChanged",t.Text.toBoolean(e))}getIsChanged(){return this.cache.get("isChanged",false)}getLoader(){return this.cache.remember("loader",(()=>new n.Loader))}show(){const e=this.getPopup();t.Dom.clean(e.getContentContainer());void this.getLoader().show(e.getContentContainer());this.load().then((t=>{this.setData({...t});e.setContent(this.createPopupContent(t))}));e.show()}hide(){this.getPopup().close()}onBindElementClick(e){e.preventDefault();this.show()}createPopupContent(e){return t.Tag.render(l||(l=a`
