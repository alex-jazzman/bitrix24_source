...
(function (exports,main_core,ui_buttons,ui_sidepanel,ui_sidepanel_layout,crm_integration_ui_settings) {
	...
	var _openedLayout = /*#__PURE__*/new WeakMap();
	var Slider = /*#__PURE__*/function () {
	  babelHelpers.createClass(Slider, [{
	    key: "openedLayout",
	    get: function get() {
	      return babelHelpers.classPrivateFieldGet(this, _openedLayout);
	    }
	  }]);
	  function Slider(options) {
	    ...
	    _classPrivateFieldInitSpec(this, _openedLayout, {
	      writable: true,
	      value: null
	    });
	  ...
	  babelHelpers.createClass(Slider, [{
	    ...
	    key: "open",
	    value: function () {
	      var _open = babelHelpers.asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
	        return _regeneratorRuntime().wrap(function _callee$(_context) {
	          while (1) switch (_context.prev = _context.next) {
	            case 0:
	              _context.t0 = babelHelpers;
	              _context.t1 = this;
	              _context.t2 = _openedLayout;
	              _context.next = 5;
	              return this.makeLayout();
	            case 5:
	              _context.t3 = _context.sent;
	              _context.t0.classPrivateFieldSet.call(_context.t0, _context.t1, _context.t2, _context.t3);
	              _context.t4 = ui_sidepanel.SidePanel.Instance;
	              _context.t5 = this.url;
	              _context.next = 11;
	              return this.getSliderOptions(babelHelpers.classPrivateFieldGet(this, _openedLayout));
	            case 11:
	              _context.t6 = _context.sent;
	              this.isOpen = _context.t4.open.call(_context.t4, _context.t5, _context.t6);
	              return _context.abrupt("return", this.isOpen);
	            case 14:
	            case "end":
	    ...
	    value: function close() {
	      ...
	      babelHelpers.classPrivateFieldSet(this, _openedLayout, null);
	    ...
	    key: "makeLayout",
	    value: function () {
	      var _makeLayout = babelHelpers.asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
	        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
	          while (1) switch (_context2.prev = _context2.next) {
	            case 0:
	              return _context2.abrupt("return", ui_sidepanel_layout.Layout.createLayout({
	                ...
	                extensions: ['crm.ai.slider'].concat(babelHelpers.toConsumableArray(this.extensions))
	              }));
	            case 1:
	            case "end":
	      ...
	      function makeLayout() {
	        return _makeLayout.apply(this, arguments);
	      }
	      return makeLayout;
	    }()
	  }, {
	    ...
	    value: function () {
	      var _getSliderOptions = babelHelpers.asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(layout) {
	      ...
	      function getSliderOptions(_x) {
	        return _getSliderOptions.apply(this, arguments);
	      }
	    ...
	    key: "footerDisplay",
	    value: function footerDisplay(show) {
	      var _babelHelpers$classPr;
	      if (!babelHelpers.classPrivateFieldGet(this, _openedLayout)) {
	        return;
	      }
	      if (babelHelpers.classPrivateFieldGet(this, _openedLayout).getFooterContainer()) {
	        main_core.Dom.style(babelHelpers.classPrivateFieldGet(this, _openedLayout).getFooterContainer(), 'display', show ? 'block' : 'none');
	      }
	      var footerAnchor = (_babelHelpers$classPr = babelHelpers.classPrivateFieldGet(this, _openedLayout).getContainer()) === null || _babelHelpers$classPr === void 0 ? void 0 : _babelHelpers$classPr.getElementsByClassName('ui-sidepanel-layout-footer-anchor')[0];
	      if (footerAnchor) {
