...
if(typeof BX.Crm.EntityEditorSection === "undefined")
{
	...
	BX.Crm.EntityEditorSection.prototype.createFieldConfigurator = function(params)
	{
		...
		params.enableTooltipConfigurator = (
			!BX.Type.isUndefined(BX.UI.EntityEditorUfConfigurators.TooltipConfigurator)
			&& this._editor._settings?.mainCanHandleUfTooltips
		);
