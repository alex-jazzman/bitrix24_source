...
$MESS["CRM_TYPE_DETAIL_CATEGORIES_CARD_DESCRIPTION"] = "You can create multiple pipelines for this Smart Process Automation (like with deal pipelines) and move items across various pipelines using the sales tunnels. Each pipeline has individual stages, detail views and access permissions.";
$MESS["CRM_TYPE_DETAIL_CATEGORIES_CARD_TITLE"] = "Sales pipelines and tunnels";
