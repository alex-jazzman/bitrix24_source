...
{
	$relationCode = (int)$arParams['PARENT_ENTITY_TYPE_ID'] . '-' . (int)$arParams['PARENT_ENTITY_ID'] . '-' . \CCrmOwnerType::Company;
	...
	$toolbar->addButton($linkButton, \Bitrix\UI\Toolbar\ButtonLocation::AFTER_TITLE);
