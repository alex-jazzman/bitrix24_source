...
$MESS["HUMANRESOURCES_HCMLINK_CONNECTOR_PAGE_PARAGRAPH_3"] = "Сіз әр компания үшін дайын шаблондар жасай аласыз және оларды 1С деректерімен толтыра аласыз";
$MESS["HUMANRESOURCES_HCMLINK_CONNECTOR_PAGE_PARAGRAPH_4"] = "Есеп айырысу парақтары мен демалыс қалдықтарын 1С-пен автоматты түрде синхрондау. Қызметкерлер қажетті ақпаратты тікелей Битрикс24-тен көре алады";
$MESS["HUMANRESOURCES_HCMLINK_CONNECTOR_PAGE_SLIDER_CLOSE"] = "Жабу";
$MESS["HUMANRESOURCES_HCMLINK_CONNECTOR_PAGE_TITLE"] = "КЭДО + 1С Коннекторы";
